...
public class EhGroups extends org.jooq.impl.TableImpl<com.everhomes.server.schema.tables.records.EhGroupsRecord> {
	...
	private static final long serialVersionUID = -1230004044;
	...
	/**
	 * The column <code>ehcore.eh_groups.community_id</code>. the id of community where the creator located when the group is created
	 */
	public final org.jooq.TableField<com.everhomes.server.schema.tables.records.EhGroupsRecord, java.lang.Long> COMMUNITY_ID = createField("community_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "the id of community where the creator located when the group is created");
