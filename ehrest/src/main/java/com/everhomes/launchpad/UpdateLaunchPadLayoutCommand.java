 ...
 * <li>status: 服务市场风格状态，参考{@link com.everhomes.launchpad.LaunchPadLayoutStatus}</li>
 * </ul>
 */
public class UpdateLaunchPadLayoutCommand {
    @NotNull
    private Long     id;
    ...
    public UpdateLaunchPadLayoutCommand() {
    }
