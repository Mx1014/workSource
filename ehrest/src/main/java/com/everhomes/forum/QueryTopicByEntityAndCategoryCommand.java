 ...
 * <li>entityTag: 查询者的实体标签，与帖子里的creatorTag和targetTag匹配，参考{@link com.everhomes.forum.PostEntityTag}</li>
 * <li>entityId: 查询者实体使用的ID，可能为小区ID、也可能是机构ID</li>
 * <li>targetTag: 要查询的实体标签，与帖子里的creatorTag和targetTag匹配，参考{@link com.everhomes.forum.PostEntityTag}</li>
