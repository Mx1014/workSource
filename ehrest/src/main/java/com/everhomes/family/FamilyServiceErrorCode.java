...
public class FamilyServiceErrorCode {
    ...
    static final int ERROR_USER_REVOKE_SELF = 10004; //不能剔除自己
    static final int ERROR_USER_REJECT_SELF = 10005; //不能拒绝自己
    static final int ERROR_USER_FAMILY_EXIST = 10006; //用户已经加入该家庭。
