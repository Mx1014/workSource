...
public class ArchivesExcelLocaleString {
    ...
    public static String T_FILENAME= "人事档案批量导入模板";
    ...
    public static String T_CONTACT_TOKEN = "手机";

    public static String T_CHECK_IN_TIME = "入职日期";

    public static String T_EMPLOYEE_TYPE ="员工类型";

    public static String T_DEPARTMENT = "部门";
}
