...
//    long COMPANY_ACLINK_MOBILE = 4102041024L;
    ...
    //------- START 楼宇资产管理权限 --------
    long PM_PROPERTY_MANAGEMENT_CREATE_APARTMENT = 38101L;//新增房源权限
    long PM_PROPERTY_MANAGEMENT_UPDATE_APARTMENT = 38102L;//修改房源权限
    long PM_PROPERTY_MANAGEMENT_DELETE_APARTMENT = 38103L;//删除房源权限
    long PM_PROPERTY_MANAGEMENT_LIST_RESERVATIONS = 38104L;//查看所有的预定记录
    long PM_PROPERTY_MANAGEMENT_CREATE_RESERVATION = 38105L;//创建预定记录
    long PM_PROPERTY_MANAGEMENT_UPDATE_RESERVATION = 38106L;//更新预定记录
    long PM_PROPERTY_MANAGEMENT_DELETE_RESERVATION = 38107L;//删除预定记录
    long PM_PROPERTY_MANAGEMENT_CANCEL_RESERVATION = 38108L;//取消预定记录
    long PM_PROPERTY_MANAGEMENT_DELETE_BUILDING = 38109L;//删除楼宇
    long PM_PROPERTY_MANAGEMENT_CREATE_BUILDING = 38110L;//创建楼宇
    long PM_PROPERTY_MANAGEMENT_UPDATE_BUILDING = 38111L;//更新楼宇
    long PM_PROPERTY_MANAGEMENT_IMPORT_BUILDING = 38112L;//导入楼宇
    long PM_PROPERTY_MANAGEMENT_EXPORT_BUILDING = 38113L;//导出楼宇
    long PM_PROPERTY_MANAGEMENT_UPDATE_COMMUNITY = 38114L;//更新园区信息
    long PM_PROPERTY_MANAGEMENT_CHANGE_BUILDING_ORDER = 38115L;//楼宇排序
    long PM_PROPERTY_MANAGEMENT_CREATE_SPLIT_ARRANGEMENT = 38116L;//拆分房源
    long PM_PROPERTY_MANAGEMENT_CREATE_MERGE_ARRANGEMENT = 38117L;//合并房源
    long PM_PROPERTY_MANAGEMENT_LIST_AUTHORIZE_PRICES = 38118L;//查看房源授权价记录
    long PM_PROPERTY_MANAGEMENT_SET_AUTHORIZE_PRICE = 38119L;//新增授权价
    long PM_PROPERTY_MANAGEMENT_UPDATE_AUTHORIZE_PRICES = 38120L;//修改授权价
    long PM_PROPERTY_MANAGEMENT_DELETE_AUTHORIZE_PRICES = 38121L;//删除授权价
    long PM_PROPERTY_MANAGEMENT_GET_APARTMENT_DETAIL = 38122L;//查看房源相关信息
    long PM_PROPERTY_MANAGEMENT_IMPORT_AUTHORIZE_PRICES = 38123L;//批量导入授权价
	long PM_PROPERTY_MANAGEMENT_UPLOAD_APARTMENT_ATTACHMENT = 38124L;//上传附件
	long PM_PROPERTY_MANAGEMENT_DELETE_APARTMENT_ATTACHMENT = 38125L;//删除附件
	long PM_PROPERTY_MANAGEMENT_EXPORT_APARTMENTS_IN_COMMUNITY = 38126L;//按房源导出
	long PM_PROPERTY_MANAGEMENT_IMPORT_ADDRESS = 38127L;//按楼宇导入房源
	long PM_PROPERTY_MANAGEMENT_EXPORT_ADDRESS = 38128L;//按楼宇导出房源
	long PM_PROPERTY_MANAGEMENT_APARTMENT_MANAGEMENT = 38129L;//房源管理
