...
public interface UserNotificationTemplateCode {
    ...
    static final int USER_PAYMENT_NOTICE_TEMPLATE_ONE = 4;
    static final int USER_PAYMENT_NOTICE_TEMPLATE_TWO = 5;
    static final int USER_PAYMENT_NOTICE_TEMPLATE_THREE = 6;
}
