 ...
 *   <li>targetType:0-无具体目标、1-帖子内容、2-地址、3-圈子、4-园区快讯 参考{@link FeedbackTargetType}</li>
 ...
 *   <li>contentCategory:内容类别。 参考{@link FeedbackContentCategoryType}</li>
 *   <li>contentCategoryText: contentCategory对应的内容</li>
 *   <li>statusText: 处理状态  0-未处理,</li>
