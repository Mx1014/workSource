 ...
 * </ul>
 */
public class ListPersonalExpressOrderResponse {
	...
	public ListPersonalExpressOrderResponse() {

	}

	public ListPersonalExpressOrderResponse(Long nextPageAnchor, List<ExpressOrderDTO> expressOrderDTOs) {
		super();
