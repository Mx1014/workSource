 ...
 * 
 * <ul>
 * <li>WAITING_FOR_PAY: 1，待支付</li>
 * <li>PAID: 2，已支付</li>
 * <li>PRINTED: 3，已出单</li>
 * <li>CANCELLED: 4，已取消</li>
 * <li>FINISHED: 5，已完成</li>
 * <li>PROCESSING: 6，处理中</li>
 * </ul>
 */
public enum ExpressOrderStatus {
	WAITING_FOR_PAY((byte)1, "待支付"), PAID((byte)2,"已支付"), PRINTED((byte)3,"已出单"), CANCELLED((byte)4,"已取消"),FINISHED((byte)5,"已完成"),PROCESSING((byte)6,"处理中");
