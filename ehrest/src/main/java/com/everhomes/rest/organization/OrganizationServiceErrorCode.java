...
public interface OrganizationServiceErrorCode {
    ...
    int ERROR_SCHOOLNAME_ISNULL =700009;
    int ERROR_DEGREE_ISNULL = 700010;
    int ERROR_MAJOR_ISNULL = 700011;
    int ERROR_STARTTIME_ISNULL = 700012;
    int ERROR_ENDTIME_ISNULL =700013;
    int ERROR_ENTERPRISENAME_ISNULL = 700014;
    int ERROR_POSITION_ISNULL = 700015;
    int ERROR_JOBTYPE_ISNULL =700016;
    int ERROR_INSURANCENAME_ISNULL = 700017;
    int ERROR_INSURANCEENTERPRISE_ISNULL = 700018;
    int ERROR_INSURANCENUMBER_ISNULL = 700019;
    int ERROR_CONTRACTNUMBER_ISNULL = 700020;
