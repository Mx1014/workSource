 ...
 * <li>requestRechargeType: 申请月卡，智能模式 开通月卡时 缴费类型， 1: 整月，2:实际天数   {@link ParkingCardExpiredRechargeType}</li>
 * <li>cardRequestTipFlag: 是否启用申请提示信息 {@link ParkingLotConfig}</li>
 * <li>cardAgreementFlag: 是否启用卡协议 {@link ParkingLotConfig}</li>
 * <li>maxRequestNumFlag: 是否启用最大申请数 {@link ParkingLotConfig}</li>
 * <li>maxIssueNumFlag: 是否启用最大发放数 {@link ParkingLotConfig}</li>
 * <li>cardRequestTip: app月卡申请页面提示文案</li>
 * <li>cardAgreement: 停车月卡协议</li>
 * <li>maxRequestNum: 最大申请数量</li>
 * <li>maxIssueNum: 可发放的月卡总数</li>
 * <li>flowId: 工作流模式id</li>
 * <li>cardAgreementUrl: 卡协议url</li>
 * <li>cardTypeTipFlag: app月卡申请 是否支持月卡类型选择页面提示文案 {@link ParkingLotConfig}</li>
 * <li>cardTypeTip: app月卡申请 月卡类型选择页面提示文案</li>
 * <li>requestTypes: requestTypes {@link com.everhomes.rest.parking.ParkingCardRequestTypeDTO}</li>
 * </ul>
 */
