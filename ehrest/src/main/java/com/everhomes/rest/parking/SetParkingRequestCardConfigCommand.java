 ...
 * <li>flowId: flowId</li>
 * <li>requestMonthCount: 申请月数</li>
 * <li>requestRechargeType: 充值类型 {@link ParkingCardExpiredRechargeType}</li>
 * <li>cardRequestTip: 申请提示信息</li>
 * <li>cardAgreement: 卡协议</li>
 * <li>maxIssueNum: 最大发放数</li>
 * <li>maxRequestNum: 最大申请数</li>
 ...
 * <li>cardTypeTipFlag: 是否启用卡类型提示信息 {@link ParkingLotConfig}</li>
 * <li>cardTypeTip: 卡类型提示信息</li>
 * </ul>
 */
