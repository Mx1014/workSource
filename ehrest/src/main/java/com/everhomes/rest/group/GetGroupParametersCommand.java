...
public class GetGroupParametersCommand {
	...
	public GetGroupParametersCommand() {

	}

	public GetGroupParametersCommand(Byte createFlag, Byte verifyFlag, Byte memberPostFlag, Byte memberCommentFlag, Byte adminBroadcastFlag, Integer broadcastCount) {
		super();
