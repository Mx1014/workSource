...
public class GetBroadcastByTokenResponse {
	...
	public GetBroadcastByTokenResponse(String broadcastToken, String ownerType, Long ownerId, String title, String contentType, String content, String contentAbstract) {
		super();
