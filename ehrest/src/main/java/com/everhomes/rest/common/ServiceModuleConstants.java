...
public interface ServiceModuleConstants {
    ...
    long SERVICE_ALLIANCE_MODULE = 40500L;

    long RENTAL_MODULE = 40400L;
    ...
    long ASSET_MODULE_FORENT = 20500;//对公转账
    ...
    long ENTERPRISE_MOMENT_MODULE = 274000; // 同事圈模块
}
