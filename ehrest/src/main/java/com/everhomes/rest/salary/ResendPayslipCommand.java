 ...
 * <li>payslipId: 工资条Id重回工资条下所有人 可选</li>
 * <li>payslipDetailId: 工资条详情id 只重发某一个人的某条工资条详情 可选</li>
 * </ul>
 */
public class ResendPayslipCommand {
	...
	public ResendPayslipCommand(Long organizationId, Long ownerId, Long payslipId, Long payslipDetailId) {
		super();
