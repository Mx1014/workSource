...
public class UpdateSalaryGroupCommand {
	...
	public UpdateSalaryGroupCommand(Long salaryGroupId, Byte type, Long categoryId, String categoryName, String name, Byte editableFlag, Byte sumFlag, Byte numberType, String defaultValue, Byte needCheck) {
		super();
