 ...
 * </ul>
 */
public class ListPayslipsDetailCommand {
	...
	public ListPayslipsDetailCommand() {

	}

	public ListPayslipsDetailCommand(Long organizationId, Long ownerId, Long payslipDetailId) {
		super();
