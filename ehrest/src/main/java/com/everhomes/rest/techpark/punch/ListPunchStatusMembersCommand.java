 ...
 * <li>punchStatusStatisticsItemType: 考勤状态统计类型，参考{@link com.everhomes.rest.techpark.punch.PunchStatusStatisticsItemType}，必填</li>
 * <li>pageOffset: 页码，第一页不填或者1</li>
 * <li>pageSize: 每页返回记录数，（每页40条记录），必填</li>
 * </ul>
 */
public class ListPunchStatusMembersCommand {
