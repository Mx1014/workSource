 ...
 * <li>currentTimeRuleName: 当前排班名称</li>
 ...
 * </ul>
 */
public class GetUserPunchRuleInfoResponse {
	private Long id;
	...
	private String currentTimeRuleName;
	...
	public String getCurrentTimeRuleName() {
		return currentTimeRuleName;
	}

	public void setCurrentTimeRuleName(String currentTimeRuleName) {
		this.currentTimeRuleName = currentTimeRuleName;
	}
}
