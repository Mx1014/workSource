 ...
 * <li>siteDay：一天的单元格，参考{@link com.everhomes.rest.rentalv2.RentalSiteDayRulesDTO}</li>
...
public class FindRentalSiteDayStatusCommandResponse {
    ...
    private RentalSiteDayRulesDTO siteDay;
    ...
    public RentalSiteDayRulesDTO getSiteDay() {
        return siteDay;
    }

    public void setSiteDay(RentalSiteDayRulesDTO siteDay) {
