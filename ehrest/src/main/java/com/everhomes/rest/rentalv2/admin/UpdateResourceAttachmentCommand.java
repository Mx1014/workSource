 ...
 * <li>attachment: 附件列表 {@link com.everhomes.rest.rentalv2.admin.AttachmentConfigDTO}</li>
 * </ul>
 */
public class UpdateResourceAttachmentCommand {
	...
	private AttachmentConfigDTO attachment;
	@Override
	...
	public AttachmentConfigDTO getAttachment() {
		return attachment;
	}

	public void setAttachment(AttachmentConfigDTO attachment) {
