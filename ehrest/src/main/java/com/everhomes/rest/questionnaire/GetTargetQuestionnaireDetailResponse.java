 ...
 * </ul>
 */
public class GetTargetQuestionnaireDetailResponse {

	private QuestionnaireDTO questionnaire;

	public GetTargetQuestionnaireDetailResponse() {

	}

	public GetTargetQuestionnaireDetailResponse(QuestionnaireDTO questionnaire) {
		super();
