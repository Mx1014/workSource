...
public class DebugExcelUtil {
    ...
    public static void exportExcel(org.apache.poi.ss.usermodel.Workbook workbook, int sheetNum, String sheetName, String intro, List<DynamicField> fields, List<List<String>> data
    ) throws Exception {
        // 生成一个表格
