...
//        dao.insert(link); 
        EhLinksRecord record = ConvertHelper.convert(link, EhLinksRecord.class);
        InsertQuery<EhLinksRecord> query = context.insertQuery(Tables.EH_LINKS);
        query.setRecord(record);
        query.setReturning(Tables.EH_LINKS.ID);
        query.execute();
        
        link.setId(query.getReturnedRecord().getId());
