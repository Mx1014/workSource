...
public class ServiceModuleAppProviderImpl implements ServiceModuleAppProvider {
	...
	public List<ServiceModuleApp> listServiceModuleApp(Integer namespaceId, Long versionId, Long moduleId, String keywords, List<Long> developerIds, String appType, Byte mobileFlag, Byte pcFlag, Byte independentConfigFlag, Byte supportThirdFlag) {
		...
		return getReadOnlyContext().select(
				...
				Tables.EH_SERVICE_MODULE_APP_PROFILE.APP_CATEGORY,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.VERSION,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.DESCRIPTION,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.MOBILE_FLAG,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.MOBILE_URI,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.PC_FLAG,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.PC_URI,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.APP_ENTRY_INFO,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.INDEPENDENT_CONFIG_FLAG,
				Tables.EH_SERVICE_MODULE_APP_PROFILE.CONFIG_APP_IDS,
