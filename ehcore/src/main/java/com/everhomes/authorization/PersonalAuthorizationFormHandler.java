...
public class PersonalAuthorizationFormHandler implements GeneralFormModuleHandler {
    ...
    public PostGeneralFormDTO postGeneralForm(PostGeneralFormCommand cmd) {
        ...
        if (null == request) {
            //查询初始默认数据
            PersonalAuthorizationFormHandler handler = PlatformContext.getComponent(
