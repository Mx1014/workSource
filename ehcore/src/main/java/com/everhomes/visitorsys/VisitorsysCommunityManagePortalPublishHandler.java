 ...
 * 园区访客管理模块
 */
@Component(PortalPublishHandler.PORTAL_PUBLISH_OBJECT_PREFIX + VisitorsysConstant.COMMUNITY_MANAGER_MODULE_ID)
public class VisitorsysCommunityManagePortalPublishHandler implements PortalPublishHandler{
    @Autowired
