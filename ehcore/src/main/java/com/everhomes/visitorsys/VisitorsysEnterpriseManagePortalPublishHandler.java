 ...
 * 企业访客管理模块
 */
@Component(PortalPublishHandler.PORTAL_PUBLISH_OBJECT_PREFIX + VisitorsysConstant.ENTERPRISE_MANAGER_MODULE_ID)
public class VisitorsysEnterpriseManagePortalPublishHandler implements PortalPublishHandler{
    @Autowired
