...
@Component(CustomRequestHandler.CUSTOM_REQUEST_OBJ_RESOLVER_PREFIX + CustomRequestConstants.SERVER_REQUEST_CUSTOM)
public class ServerCustomRequestHandler implements CustomRequestHandler {
...
//			}
	...
	public List<RequestFieldDTO> toFieldDTOList(Object requestObject) {
		ServiceAllianceServerRequest field = (ServiceAllianceServerRequest)requestObject;
