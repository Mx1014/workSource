...
private static final Logger LOGGER=LoggerFactory.getLogger(ApartmentCustomRequestHandler.class);
	...
	public Long addCustomRequest(AddRequestCommand cmd) {
		...
		Long id = yellowPageProvider.createApartmentRequests(request);
...
//			}
		...
		List<ServiceAllianceNotifyTargets> targets = yellowPageProvider.listNotifyTargets(ownerType, ownerId, ContactType.MOBILE.getCode(), 
