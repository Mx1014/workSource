...
public class BannerTargetAppHandler implements BannerTargetHandler {
    ...
    public RouterInfo getRouterInfo(String targetData) {
        ...
        if(serviceModuleApp != null){
            routerInfo = serviceModuleAppService.convertRouterInfo(serviceModuleApp.getModuleId(), serviceModuleApp.getOriginId(), serviceModuleApp.getName(), serviceModuleApp.getInstanceConfig(), null);
