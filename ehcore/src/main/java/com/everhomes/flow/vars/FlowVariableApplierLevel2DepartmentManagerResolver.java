...
@Component(FlowVariableUserResolver.APPLIER_DEPARTMENT_MANAGER_LEVEL_2)
public class FlowVariableApplierLevel2DepartmentManagerResolver implements FlowVariableUserResolver {

    private static final Logger LOGGER = LoggerFactory.getLogger(FlowVariableApplierLevel2DepartmentManagerResolver.class);
    ...
    public List<Long> variableUserResolve(FlowCaseState ctx, Map<String, Long> processedEntities,
        ...
        if (organizationId != null) {
            ...
            List<OrganizationManagerDTO> managerDTOS = organizationService.getManagerByTargetIdAndOrgId(
                    organizationId, flowCase.getApplyUserId(), 2);
