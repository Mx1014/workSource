...
@Component(FlowVariableUserResolver.APPLIER_DEPARTMENT_MANAGER_LEVEL_1)
public class FlowVariableApplierLevel1DepartmentManagerResolver implements FlowVariableUserResolver {

    private static final Logger LOGGER = LoggerFactory.getLogger(FlowVariableApplierLevel1DepartmentManagerResolver.class);
    ...
    public List<Long> variableUserResolve(FlowCaseState ctx, Map<String, Long> processedEntities,
        ...
        if (organizationId != null) {
            ...
            List<OrganizationManagerDTO> managerDTOS = organizationService.getManagerByTargetIdAndOrgId(
                    organizationId, flowCase.getApplyUserId(), 1);
