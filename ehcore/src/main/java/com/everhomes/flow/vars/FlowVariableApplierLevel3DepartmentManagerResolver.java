...
@Component(FlowVariableUserResolver.APPLIER_DEPARTMENT_MANAGER_LEVEL_3)
public class FlowVariableApplierLevel3DepartmentManagerResolver implements FlowVariableUserResolver {

    private static final Logger LOGGER = LoggerFactory.getLogger(FlowVariableApplierLevel3DepartmentManagerResolver.class);
    ...
    public List<Long> variableUserResolve(FlowCaseState ctx, Map<String, Long> processedEntities,
        ...
        if (organizationId != null) {
            ...
            List<OrganizationManagerDTO> managerDTOS = organizationService.getManagerByTargetIdAndOrgId(
                    organizationId, flowCase.getApplyUserId(), 3);
