...
//        params.put("remark", new Item("点击查看详情", "#008000"));
        ...
        TemplateMessageServiceImpl test = new TemplateMessageServiceImpl();
     ...
     * @param routerUrl 路由
     */
    public void sendTemplateMessage(String userOpenId, String templateId, String topColor, HashMap<String, Item> params, String routerUrl){
        ...
        if(params != null){
            for (Map.Entry<String, Item> entry: params.entrySet()){
