...
//        List<ParkingCardType> cardTypes1 = listCardType(null).getCardTypes();
        ...
        cardRate.setPrice(new BigDecimal(monthlyrent).multiply(new BigDecimal(1)).setScale(2));
        cardRate.setRateName(1 + "个月");
