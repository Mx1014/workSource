 ...
 * 银星智界，银星工业区停车场
 */
@Component(ParkingVendorHandler.PARKING_VENDOR_PREFIX + "YINXINGZHIJIE_XIAOMAO")
public class XiaomaoYinxingzhijieParkingVendorHandler extends DefaultParkingVendorHandler{

    private static final Logger LOGGER = LoggerFactory.getLogger(XiaomaoYinxingzhijieParkingVendorHandler.class);
...
//            dto.setMonthCount(rate.getMonthCount());
    ...
    private void populaterate(List<YinxingzhijieXiaomaoCardType> types, ParkingRechargeRateDTO dto, ParkingRechargeRate r) {
        ...
        dto.setVendorName(ParkingLotVendor.YINXINGZHIJIE_XIAOMAO.getCode());
    }
    ...
    private String post(String context,TreeMap<String,String> params){
        String url = configProvider.getValue("parking.yinxingzhijiexiaomao.url", "");
        String parkId = configProvider.getValue("parking.yinxingzhijiexiaomao.parkId", "");
        String accessKeyId = configProvider.getValue("parking.yinxingzhijiexiaomao.accessKeyId", "");
        String accessKeyValue = configProvider.getValue("parking.yinxingzhijiexiaomao.accessKeyValue", "");
