...
public class ParkingOrderEmbeddedV1Handler implements OrderEmbeddedHandler{

    private static final Logger LOGGER = LoggerFactory.getLogger(ParkingOrderEmbeddedV1Handler.class);
