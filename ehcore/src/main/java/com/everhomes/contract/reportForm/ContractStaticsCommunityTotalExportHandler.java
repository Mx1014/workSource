...
@Component
public class ContractStaticsCommunityTotalExportHandler implements FileDownloadTaskHandler {
	...
	public void execute(Map<String, Object> params) {
		...
		OutputStream outputStream = contractService.exportOutputStreamContractStaticsCommunityTotal(cmd, taskId);
