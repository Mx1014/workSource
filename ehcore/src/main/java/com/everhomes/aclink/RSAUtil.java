...
public class RSAUtil {
    ...
    public static byte[] decryptByPrivateKey(byte[] encryptedData,
        ...
        byte[] keyBytes = decodeBase64(privateKey);
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
        //RSAPrivateKeySpec pkcs8KeySpec = new RSAPrivateKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
    ...
    public static KeyPair generateBCKey(int size) throws NoSuchAlgorithmException, NoSuchProviderException, NoSuchPaddingException {
    ...
    public static byte[] encryptByRawPublicKey(byte[] data, String publicKey) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException, IllegalBlockSizeException, BadPaddingException, NoSuchProviderException {
        //TODO use bc
    ...
    public static String decryptBCByPrivateKey(String data, String key) throws Exception {
        Security.addProvider(new BouncyCastleProvider());
        ...
        byte[] cipherData = cipher.doFinal(byData);
...
//
//        byte[] rlt = new byte[l];
//        for(int i = n; i < cipherData.length && i < (l+n) ; i++) {
//            rlt[i-n] = cipherData[i];
//        }

        //return encodeBase64(cipherData);
        return new String(cipherData, "UTF-8").substring(1);
    }
