...
@Component
public class AssetStatisticBuildingExportHandler  implements FileDownloadTaskHandler {
    ...
    public void execute(Map<String, Object> params) {
        ...
        String ListBillStatisticByBuildingCmdStr =  String.valueOf(params.get("ListBillStatisticByBuildingCmd"));
        ListBillStatisticByBuildingCmd cmd = (ListBillStatisticByBuildingCmd) 
        		StringHelper.fromJsonString(ListBillStatisticByBuildingCmdStr, ListBillStatisticByBuildingCmd.class);
    	OutputStream outputStream = assetStatisticService.exportOutputStreamBillStatisticByBuilding(cmd, taskId);
