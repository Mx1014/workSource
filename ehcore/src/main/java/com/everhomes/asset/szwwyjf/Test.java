...
public class Test {
	...
	public static void main(String[] args) {
		...
		String cusName = "深圳市前海瑞和投资基金管理有限公司";
		...
		//通过WebServices接口查询数据
		Test test = new Test();
		List<ShowBillForClientV2DTO> response = test.showBillForClientV2(jsonObject.toString());
		
		ContractDetailDTO contractDetailDTO = test.findContractForApp("CTDS-ZLHT-YF-2016-000024");
		System.out.println(contractDetailDTO);
	}
	...
	public Boolean login() {
		...
		try {
			...
			String EASLogin_address = "http://202.104.147.199:6888/ormrpc/services/EASLogin";
			loginLocator.setEASLoginEndpointAddress(EASLogin_address);
			EASLoginProxy loginProxy = loginLocator.getEASLogin();
			String username = "mybay";
			String password = "mybay";
			String slnName = "eas";
			String dcName = "shic01";
			String language = "l2";
			String dbType = "2";
	...
	public List<ShowBillForClientV2DTO> showBillForClientV2(String request) {
		...
		if(login()) {
			try {
				...
				String WSWSSyncMyBayFacade_address = "http://202.104.147.199:6888/ormrpc/services/WSWSSyncMyBayFacade";
