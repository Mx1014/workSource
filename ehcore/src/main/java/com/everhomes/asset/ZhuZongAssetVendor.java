...
public class ZhuZongAssetVendor implements AssetVendorHandler{
	...
	public static void main(String[] args) {
		...
		try {
			String response = HttpUtils.post("http://139.129.204.232:8007/LsInterfaceServer/phoneServer/QueryHouseByPhoneNumber", params, 60, true);
			System.out.println(response);
		} catch (IOException e) {
			LOGGER.error("ZhuZongAssetVendor : " + e);
		}
	}
