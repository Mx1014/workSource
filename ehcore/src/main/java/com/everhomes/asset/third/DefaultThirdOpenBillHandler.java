 ...
 * @date 2018年11月13日 上午11:09:42
 */
@Component(ThirdOpenBillHandler.THIRDOPENBILL_PREFIX + "DEFAULT")
public class DefaultThirdOpenBillHandler implements ThirdOpenBillHandler{
	
	public static final String DEFAULT_THIRD_OPEN_BILL_PREFIX = "DefaultThirdOpenBill-";
	
	private static final Logger LOGGER = LoggerFactory.getLogger(DefaultThirdOpenBillHandler.class);
