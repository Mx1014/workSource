...
//				GeneralFormFieldType.BUSINESS_TRIP.getCode());
//		PostApprovalFormBussinessTripValue valDTO= JSON.parseObject(val.getFieldStr3(), PostApprovalFormBussinessTripValue.class);
//
