 ...
 */
@Component
public class BizOrderPayComplatePointEventProcessor extends GeneralPointEventProcessor implements IPointEventProcessor {
    ...
    protected boolean doLimit(LocalEvent localEvent, PointRule rule, PointSystem pointSystem) {
        ...
        BizPointRuleLimitData limitData = (BizPointRuleLimitData) StringHelper.fromJsonString(rule.getLimitData(), BizPointRuleLimitData.class);
