...
//            }
    ...
    public ListTaskCategoriesResponse listTaskCategories(ListTaskCategoriesCommand cmd) {
        ...
        if(cmd.getParentId() != null && cmd.getParentId() == 0){
            List<PmTaskCategory> categories = pmTaskProvider.listTaskCategories(cmd.getNamespaceId(),null,null,cmd.getAppId(),cmd.getParentId(),null,null,Integer.MAX_VALUE);
