...
@Primary
@Component
public class MySequenceProviderImpl implements SequenceProvider {
    private static final Logger LOGGER = LoggerFactory.getLogger(MySequenceProviderImpl.class);
    @Autowired
