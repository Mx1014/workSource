...
public class GogsProviderImplTest {
    ...
    public void listCommits() {
        ...
        List<GogsCommit> commits = gogs.listCommits(repoName, path, param, new TypeToken<List<GogsCommit>>() {
        }.getType());
    ...
    public void deleteFile() {
        ...
        param.setTreePath(path);
        gogs.commitFile(repoName, path, param);
        List<GogsCommit> data = gogs.listCommits(repoName, path, param, new TypeToken<List<GogsCommit>>(){}.getType());
        assertNotNull(data);
