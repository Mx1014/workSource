...
public class ApprovalTest2 extends BaseLoginAuthTestCase {
	...
	public void testDeleteApprovalCategory() {
		...
		Result<Record> result = dbProvider.getDslContext().select().from(Tables.EH_APPROVAL_CATEGORIES)
				.where(Tables.EH_APPROVAL_CATEGORIES.STATUS.eq(CommonStatus.ACTIVE.getCode())).fetch();
	...
	public void testDeleteApprovalFlow() {
		...
		Record record = dbProvider.getDslContext().select().from(Tables.EH_APPROVAL_FLOWS).where(Tables.EH_APPROVAL_FLOWS.ID.eq(4L))
				.fetchOne();
		assertNotNull(record);
	...
	public void testDeleteApprovalRule() {
		...
		Record record = dbProvider.getDslContext().select().from(Tables.EH_APPROVAL_RULES).where(Tables.EH_APPROVAL_RULES.ID.eq(11L))
				.fetchOne();
		assertNotNull(record);
		...
		Result<Record> result = dbProvider.getDslContext().select().from(Tables.EH_APPROVAL_RULE_FLOW_MAP)
				.where(Tables.EH_APPROVAL_RULE_FLOW_MAP.RULE_ID.eq(11L)).fetch();
		assertNotNull(record);
	...
	private void approveApprovalRequest(String url) {
		List<EhApprovalRequests> dataList = dbProvider.getDslContext().select().from(Tables.EH_APPROVAL_REQUESTS).fetch()
				.map(r -> ConvertHelper.convert(r, EhApprovalRequests.class));
	...
	public void testGetApprovalBasicInfoOfRequest() {
		...
		List<EhApprovalRequests> dataList = dbProvider.getDslContext().select().from(Tables.EH_APPROVAL_REQUESTS)
				.orderBy(Tables.EH_APPROVAL_REQUESTS.ID.asc()).fetch().map(r -> ConvertHelper.convert(r, EhApprovalRequests.class));
		...
		GetApprovalBasicInfoOfRequestRestResponse response = httpClientService.restPost(url, cmd,
				GetApprovalBasicInfoOfRequestRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testListApprovalLogAndFlowOfRequest() {
		...
		ListApprovalLogAndFlowOfRequestRestResponse response = httpClientService.restPost(url, cmd,
				ListApprovalLogAndFlowOfRequestRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testListApprovalLogOfRequest() {
		...
		ListApprovalLogOfRequestRestResponse response = httpClientService.restPost(url, cmd,
				ListApprovalLogOfRequestRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testListApprovalFlowOfRequest() {
		...
		ListApprovalFlowOfRequestRestResponse response = httpClientService.restPost(url, cmd,
				ListApprovalFlowOfRequestRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testGetApprovalBasicInfoOfRequestByScene() {
		...
		ApprovalGetApprovalBasicInfoOfRequestBySceneRestResponse response = httpClientService.restPost(url, cmd,
				ApprovalGetApprovalBasicInfoOfRequestBySceneRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testListApprovalLogAndFlowOfRequestByScene() {
		...
		ApprovalListApprovalLogAndFlowOfRequestBySceneRestResponse response = httpClientService.restPost(url, cmd,
				ApprovalListApprovalLogAndFlowOfRequestBySceneRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testListApprovalLogOfRequestByScene() {
		...
		ApprovalListApprovalLogOfRequestBySceneRestResponse response = httpClientService.restPost(url, cmd,
				ApprovalListApprovalLogOfRequestBySceneRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testListApprovalFlowOfRequestByScene() {
		...
		ApprovalListApprovalFlowOfRequestBySceneRestResponse response = httpClientService.restPost(url, cmd,
				ApprovalListApprovalFlowOfRequestBySceneRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
	...
	public void testListApprovalCategoryByScene() {
		...
		ApprovalListApprovalCategoryBySceneRestResponse response = httpClientService.restPost(url, cmd,
				ApprovalListApprovalCategoryBySceneRestResponse.class);
		assertNotNull(response);
		assertTrue("response= " + StringHelper.toJsonString(response), httpClientService.isReponseSuccess(response));
...
//	@Test
	public void testTargetApprovalRule() {
		...
		url = ApprovalTest2.GET_TARGET_APPROVAL_RULE_URL;
		...
		url = ApprovalTest2.DELETE_TARGET_APPROVAL_RULE_URL;
