 ...
 */
public class DeleteOrganizationAdministratorsTest extends BaseLoginAuthTestCase {
    ...
    @Test
    public void testDeleteOrganizationAdministrators(){
        ...
        context.select().from(EH_ACL_ROLE_ASSIGNMENTS)
                ...
                .and(EH_ACL_ROLE_ASSIGNMENTS.TARGET_ID.eq(10003L))
        ...
        context.select().from(EH_ACLS)
                ...
                .and(EH_ACLS.ROLE_ID.eq(10003L))
                .and(EH_ACLS.PRIVILEGE_ID.eq(15L))
                .fetch().map((r) -> {
