...
import static com.everhomes.server.schema.Tables.EH_USER_LAUNCH_PAD_ITEMS;
...
public class DeleteLaunchPadItemBySceneTest extends BaseLoginAuthTestCase {
    @Before
    public void setUp() {
        super.setUp();
    }
...
//        DeleteLaunchPadItemBySceneCommand cmd = new DeleteLaunchPadItemBySceneCommand();
        
        String commandRelativeUri = "/ui/launchpad/deleteLaunchPadItemByScene";
        DeleteLaunchPadItemBySceneCommand cmd = new DeleteLaunchPadItemBySceneCommand();
        cmd.setId(1L);
        ...
        context.select().from(EH_USER_LAUNCH_PAD_ITEMS) 
            ...
            .and(EH_USER_LAUNCH_PAD_ITEMS.ITEM_ID.eq(1L))
            .fetch().map((r) -> {
        ...
        assertEquals(ItemDisplayFlag.HIDE.getCode(), flag);
...
//        DeleteLaunchPadItemBySceneCommand cmd = new DeleteLaunchPadItemBySceneCommand();
        ...
        context.select().from(EH_USER_LAUNCH_PAD_ITEMS) 
            ...
            .and(EH_USER_LAUNCH_PAD_ITEMS.USER_ID.eq(10001L))
            .and(EH_USER_LAUNCH_PAD_ITEMS.ITEM_ID.eq(39L))
            .fetch().map((r) -> {
            	resultItem.add(ConvertHelper.convert(r, EhUserLaunchPadItems.class));
                return null;
            });
...
//        DeleteLaunchPadItemBySceneCommand cmd = new DeleteLaunchPadItemBySceneCommand();
        ...
        context.select().from(EH_USER_LAUNCH_PAD_ITEMS) 
            ...
            .and(EH_USER_LAUNCH_PAD_ITEMS.ITEM_ID.eq(36L))
            .fetch().map((r) -> {
            	resultItem.add(ConvertHelper.convert(r, EhUserLaunchPadItems.class));
                return null;
            });
...
//        DeleteLaunchPadItemBySceneCommand cmd = new DeleteLaunchPadItemBySceneCommand();
        ...
        context.select().from(EH_USER_LAUNCH_PAD_ITEMS) 
            ...
            .and(EH_USER_LAUNCH_PAD_ITEMS.ITEM_ID.eq(43L))
            .fetch().map((r) -> {
            	resultItem.add(ConvertHelper.convert(r, EhUserLaunchPadItems.class));
                return null;
            });
