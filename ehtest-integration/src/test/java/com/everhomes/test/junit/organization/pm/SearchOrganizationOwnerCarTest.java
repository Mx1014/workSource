...
public class SearchOrganizationOwnerCarTest extends BaseLoginAuthTestCase {
    ...
    public void testSearchOrganizationOwnerByDifferentCommunity() {
        ...
        assertTrue("The search response list size should be 2.", resp.getResponse().getCars().size() == 2);
    }
    ...
    private void bulkData(){
        ...
        String json = "{ \"create\" : { \"_index\" : \"everhomesv31x\", \"_type\" : \"organizationOwnerCar\", \"_id\" : \"1\" }}\\n\n" +
                ...
                "{ \"create\" : { \"_index\" : \"everhomesv31x\", \"_type\" : \"organizationOwnerCar\", \"_id\" : \"2\" }}\\n\n" +
                ...
                "{ \"create\" : { \"_index\" : \"everhomesv31x\", \"_type\" : \"organizationOwnerCar\", \"_id\" : \"3\" }}\\n\n" +
