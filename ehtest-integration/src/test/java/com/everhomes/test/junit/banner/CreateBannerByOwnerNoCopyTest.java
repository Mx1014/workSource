...
public class CreateBannerByOwnerNoCopyTest extends BaseLoginAuthTestCase {
    @Before
    public void setUp() {
        super.setUp();
    }
    ...
    /**
     * 无需复制时测试创建banner时的复制动作
     */
    @Test
    public void testCreateBannerByOwner_testNoCopy() {
    	Integer namespaceId = 2;
    	String userIdentifier = "12000000001";
    	String plainTexPassword = "123456";
    ...
    protected void initCustomData() {
		String userInfoFilePath = "data/json/create-banner-by-owner-create-customized-test-data.txt";
