...
public class UpdateBannerByOwnerTest extends BaseLoginAuthTestCase {
    ...
    @Test
    public void updateBannerWithMultiScenes() {
        ...
        Integer order = 1;
        Byte status = BannerStatus.CLOSE.getCode();
        ...
        String commandRelativeUri = "/admin/banner/updateBanner";
        ...
        assertEquals(name, banners.get(0).getName());
        assertEquals(status, banners.get(0).getStatus());
        assertEquals(order, banners.get(0).getOrder());
        assertEquals(actionData, banners.get(0).getActionData());
        assertEquals(scopeId, banners.get(0).getScopeId());
    }
