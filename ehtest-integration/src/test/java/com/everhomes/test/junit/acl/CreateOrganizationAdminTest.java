...
public class CreateOrganizationAdminTest extends BaseLoginAuthTestCase {
    ...
    @Test
    public void tesCreateOrganizationAdmin() {
        Integer namespaceId = 0;
        String userIdentifier = "12000000001";
        String plainTexPassword = "123456";
        logon(namespaceId, userIdentifier, plainTexPassword);
        
        String commandRelativeUri = "/acl/createOrganizationAdmin";
