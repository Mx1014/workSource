...
VALUES (@module_id, '缴费管理', @module_parent_id, @path, '1', '2', '2', '0', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '0', '0', '0', 'community_control');
...
VALUES (@menu_id, '缴费管理', @menu_parent_id, @data_type, '1', @ment_path, '22', @module_id, '3', 'system', 'module');
