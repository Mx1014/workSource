...
ALTER TABLE `eh_activity_roster` ADD COLUMN `refound_order_no` BIGINT(20) NULL;
ALTER TABLE `eh_activity_roster` ADD COLUMN `vendor_type` TINYINT(4) NULL COMMENT '10001: alipay, 10002: wechatpay';
