...
update eh_parking_card_requests set card_type_id = '普通月卡';
update eh_parking_card_requests r JOIN eh_parking_card_types c on r.parking_lot_id = c.parking_lot_id set r.card_type_id = c.card_type_id;

UPDATE eh_web_menus set `name` = '缴费管理', sort_num= 473 where id = 40810;
UPDATE eh_web_menus set sort_num= 471 where id = 40830;
