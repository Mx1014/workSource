...
INSERT INTO `eh_version_urls` (`id`, `realm_id`, `target_version`, `download_url`, `info_url`, `namespace_id`) VALUES ((@version_urls_id := @version_urls_id + 1), '34', '3.8.0', '${homeurl}/web/download/apk/UFinePark-3.7.0.2016071202-release.apk', '${homeurl}/web/download/apk/andriod-UFinePark-3-7-0.html', '0');
INSERT INTO `eh_version_urls` (`id`, `realm_id`, `target_version`, `download_url`, `info_url`, `namespace_id`) VALUES ((@version_urls_id := @version_urls_id + 1), '35', '3.8.0', '', 'iOS-UFinePark-3-8-0.html', '0');
