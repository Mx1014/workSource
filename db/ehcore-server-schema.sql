...
CREATE TABLE `eh_activities` (
  ...
  `stick_flag` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '是否置顶，0-否，1-是',
  PRIMARY KEY (`id`),
...
CREATE TABLE `eh_address_attachments` (
  ...
  `address_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'refer to the id of eh_addresses',
...
CREATE TABLE `eh_contract_charging_changes` (
  ...
  `change_type` TINYINT(4) DEFAULT NULL COMMENT '1: 调租; 2: 免租',
  `change_method` TINYINT(4) DEFAULT NULL COMMENT '1: 按金额递增; 2: 按金额递减; 3: 按比例递增; 4: 按比例递减',
  `change_period` INT(11) DEFAULT NULL,
  `period_unit` TINYINT(4) DEFAULT NULL COMMENT '1: 天; 2: 月; 3: 年',
  `change_range` DECIMAL(10,2) DEFAULT NULL,
  `change_start_time` DATETIME DEFAULT NULL,
  `change_expired_time` DATETIME DEFAULT NULL,
...
CREATE TABLE `eh_contracts` (
  ...
  `settled` VARCHAR(128) DEFAULT NULL,
...
CREATE TABLE `eh_customer_apply_projects` (
  ...
  `status` TINYINT DEFAULT '2' COMMENT '0: inactive; 1: in progress; 2: completed',
  `create_uid` BIGINT NOT NULL DEFAULT 0,
  `create_time` DATETIME,
  `operator_uid` BIGINT,
  `update_time` DATETIME,
...
CREATE TABLE `eh_customer_tracking_plans` (
  ...
  `status` TINYINT(4) DEFAULT '2' COMMENT '0: inactive; 1: waiting for approval; 2: active',
  `creator_uid` BIGINT(20) DEFAULT NULL COMMENT '创建人uid',
...
CREATE TABLE `eh_customer_trackings` (
  ...
  `customer_name` VARCHAR(128) DEFAULT NULL COMMENT '客户名称',
  `contact_name` VARCHAR(64) DEFAULT NULL COMMENT '联系人',
  `tracking_type` BIGINT(20) DEFAULT NULL COMMENT '跟进类型',
  `tracking_uid` BIGINT(20) DEFAULT NULL COMMENT '跟进人uid ',
  `intention_grade` INT(11) DEFAULT NULL COMMENT '意向等级',
  `tracking_time` DATETIME DEFAULT NULL COMMENT '跟进时间',
  `content` TEXT COMMENT '跟进内容',
  `content_img_uri` VARCHAR(2048) DEFAULT NULL COMMENT '跟进内容图片uri',
  `status` TINYINT(4) DEFAULT '2' COMMENT '0: inactive; 1: waiting for approval; 2: active',
  `creator_uid` BIGINT(20) DEFAULT NULL COMMENT '创建人uid',
  `create_time` DATETIME DEFAULT NULL COMMENT '创建时间',
  `update_uid` BIGINT(20) DEFAULT NULL COMMENT '修改人uid',
...
CREATE TABLE `eh_enterprise_customers` (
  ...
  `contact_duty` VARCHAR(64) DEFAULT NULL,
  ...
  `operator_uid` BIGINT(20) DEFAULT NULL,
  `update_time` DATETIME DEFAULT NULL,
  `tracking_uid` BIGINT(20) DEFAULT '-1' COMMENT '跟进人uid',
  `tracking_name` VARCHAR(32) DEFAULT NULL COMMENT '跟进人姓名',
  `property_area` DOUBLE DEFAULT NULL COMMENT '资产面积',
  `property_unit_price` DOUBLE DEFAULT NULL COMMENT '资产单价',
  `property_type` BIGINT(20) DEFAULT NULL COMMENT '资产类型',
  `longitude` DOUBLE DEFAULT NULL COMMENT '经度',
  `latitude` DOUBLE DEFAULT NULL COMMENT '纬度',
  `geohash` VARCHAR(32) DEFAULT NULL,
  `last_tracking_time` DATETIME DEFAULT NULL COMMENT '最后一次跟进时间',
  `contact_position` VARCHAR(64) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_flow_branches` (
  ...
  `namespace_id` INT(11) NOT NULL DEFAULT '0',
  `flow_main_id` BIGINT(20) NOT NULL,
  `flow_version` INT(11) NOT NULL,
  `original_node_id` BIGINT(20) NOT NULL COMMENT '分发开始节点id',
  `original_node_level` INT(11) NOT NULL COMMENT '分发开始节点level',
  `convergence_node_id` BIGINT(20) NOT NULL COMMENT '最终收敛节点id',
  `convergence_node_level` INT(11) NOT NULL COMMENT '最终收敛节点level',
...
CREATE TABLE `eh_flow_buttons` (
  ...
  `button_name` VARCHAR(64) DEFAULT NULL,
  `description` VARCHAR(1024) DEFAULT NULL,
  `flow_step_type` VARCHAR(64) DEFAULT NULL COMMENT 'no_step, start_step, approve_step, reject_step, transfer_step, comment_step, end_step, notify_step',
  `flow_user_type` VARCHAR(64) DEFAULT NULL COMMENT 'applier, processor',
  `goto_level` INT(11) NOT NULL DEFAULT '0',
  `goto_node_id` BIGINT(20) NOT NULL DEFAULT '0',
  `need_subject` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '0: not need subject for this step, 1: need subject for this step',
  `need_processor` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '0: not need processor, 1: need only one processor',
  `remind_count` INT(11) NOT NULL DEFAULT '0',
  `create_time` DATETIME NOT NULL COMMENT 'record create time',
  `status` TINYINT(4) NOT NULL COMMENT '0: invalid, 1: disabled, 2: enabled',
  ...
  `subject_required_flag` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '0: false, 1: true, subject required flag',
  `param` VARCHAR(64) DEFAULT NULL COMMENT 'the params from other module',
  `default_order` INT(11) NOT NULL DEFAULT '0' COMMENT 'default order',
  `evaluate_step` VARCHAR(64) DEFAULT NULL COMMENT 'default order',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_flow_cases` (
  ...
  `owner_type` VARCHAR(64) NOT NULL,
  `module_id` BIGINT(20) NOT NULL COMMENT 'the module id',
  `module_type` VARCHAR(64) NOT NULL,
  `project_id` BIGINT(20) NOT NULL DEFAULT '0',
  `project_type` VARCHAR(64) DEFAULT NULL,
  `module_name` VARCHAR(64) DEFAULT NULL,
  `applier_name` VARCHAR(64) DEFAULT NULL,
  `applier_phone` VARCHAR(64) DEFAULT NULL,
  `flow_main_id` BIGINT(20) NOT NULL,
  `flow_version` INT(11) NOT NULL,
  `apply_user_id` BIGINT(20) NOT NULL,
  `process_user_id` BIGINT(20) NOT NULL DEFAULT '0',
  `refer_id` BIGINT(20) NOT NULL DEFAULT '0',
  `refer_type` VARCHAR(64) NOT NULL,
  `current_node_id` BIGINT(20) NOT NULL DEFAULT '0',
  `status` TINYINT(4) NOT NULL DEFAULT '0' COMMENT 'invalid, initial, process, end',
  `reject_count` INT(11) NOT NULL DEFAULT '0',
  `reject_node_id` BIGINT(20) NOT NULL DEFAULT '0',
  `step_count` BIGINT(20) NOT NULL DEFAULT '0',
  `last_step_time` DATETIME(3) DEFAULT NULL COMMENT 'state change time',
  `create_time` DATETIME NOT NULL COMMENT 'record create time',
  `case_type` VARCHAR(64) DEFAULT NULL COMMENT 'inner, outer etc',
  `content` TEXT,
  ...
  `integral_tag4` BIGINT(20) NOT NULL DEFAULT '0',
  `integral_tag5` BIGINT(20) NOT NULL DEFAULT '0',
  `organization_id` BIGINT(20) DEFAULT NULL COMMENT 'the same as eh_flows organization_id',
  `applier_organization_id` BIGINT(20) DEFAULT NULL COMMENT 'applier current organization_id',
  `current_lane_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'ref eh_flow_lanes',
  `parent_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'parentId, ref eh_flow_cases',
  `start_node_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT '开始节点id',
  `end_node_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT '结束节点id',
  `start_link_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT '开始linkId',
  `end_link_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT '结束linkId',
  `evaluate_status` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '评价状态，一般指结束后还可以评价的情况',
  `service_type` VARCHAR(64) DEFAULT NULL COMMENT 'service type',
  `string_tag6` VARCHAR(128) DEFAULT NULL,
  `string_tag7` VARCHAR(128) DEFAULT NULL,
  `string_tag8` VARCHAR(128) DEFAULT NULL,
  `string_tag9` VARCHAR(128) DEFAULT NULL,
  `string_tag10` VARCHAR(128) DEFAULT NULL,
  `string_tag11` VARCHAR(128) DEFAULT NULL,
  `string_tag12` VARCHAR(128) DEFAULT NULL,
  `string_tag13` VARCHAR(128) DEFAULT NULL,
  `integral_tag6` BIGINT(20) DEFAULT NULL,
  `integral_tag7` BIGINT(20) DEFAULT NULL,
  `integral_tag8` BIGINT(20) DEFAULT NULL,
  `integral_tag9` BIGINT(20) DEFAULT NULL,
  `integral_tag10` BIGINT(20) DEFAULT NULL,
  `integral_tag11` BIGINT(20) DEFAULT NULL,
  `integral_tag12` BIGINT(20) DEFAULT NULL,
  `integral_tag13` BIGINT(20) DEFAULT NULL,
...
CREATE TABLE `eh_flow_condition_expressions` (
  ...
  `flow_main_id` BIGINT(20) NOT NULL,
  `flow_version` INT(11) NOT NULL,
  `flow_condition_id` BIGINT(20) NOT NULL COMMENT 'ref eh_flow_conditions',
...
CREATE TABLE `eh_flow_conditions` (
  ...
  `flow_main_id` BIGINT(20) NOT NULL,
  `flow_version` INT(11) NOT NULL,
  `condition_level` INT(11) NOT NULL DEFAULT '0',
  `flow_node_id` BIGINT(20) NOT NULL,
  `flow_node_level` INT(11) DEFAULT NULL,
  `flow_link_id` BIGINT(20) DEFAULT NULL,
  `flow_link_level` INT(11) DEFAULT NULL,
  `next_node_id` BIGINT(20) NOT NULL DEFAULT '0',
  `next_node_level` INT(11) NOT NULL DEFAULT '0',
  `status` TINYINT(4) NOT NULL COMMENT '0: invalid, 1: valid',
  `creator_uid` BIGINT(20) DEFAULT NULL,
  `create_time` DATETIME(3) DEFAULT NULL,
  `update_uid` BIGINT(20) DEFAULT NULL,
...
CREATE TABLE `eh_flow_lanes` (
  ...
  `flow_main_id` BIGINT(20) NOT NULL,
  `flow_version` INT(11) NOT NULL,
  `display_name` VARCHAR(128) DEFAULT NULL COMMENT 'lane name',
  `display_name_absort` VARCHAR(128) DEFAULT NULL COMMENT 'when flowCase absort display this',
  `flow_node_level` INT(11) DEFAULT NULL COMMENT 'flow_node_level',
  `identifier_node_level` INT(11) DEFAULT NULL COMMENT '标识这个用泳道里的那个节点里的申请人按钮',
  `identifier_node_id` BIGINT(20) DEFAULT NULL COMMENT '标识这个用泳道里的那个节点里的申请人按钮',
  `lane_level` INT(11) DEFAULT NULL COMMENT 'lane level',
  `status` TINYINT(4) NOT NULL COMMENT '0: invalid, 1: valid',
  `creator_uid` BIGINT(20) DEFAULT NULL,
  `create_time` DATETIME(3) DEFAULT NULL,
  `update_uid` BIGINT(20) DEFAULT NULL,
...
CREATE TABLE `eh_flow_links` (
  ...
  `link_level` INT(11) NOT NULL,
  `from_node_id` BIGINT(20) NOT NULL,
  `from_node_level` INT(11) NOT NULL,
  `to_node_id` BIGINT(20) NOT NULL,
  `to_node_level` INT(11) NOT NULL,
  `status` TINYINT(4) NOT NULL COMMENT '0: invalid, 1: valid',
  `creator_uid` BIGINT(20) DEFAULT NULL,
  `create_time` DATETIME(3) DEFAULT NULL,
  `update_uid` BIGINT(20) DEFAULT NULL,
...
CREATE TABLE `eh_flow_nodes` (
  ...
  `auto_step_minute` INT(11) NOT NULL DEFAULT '0' COMMENT 'after hour, step next',
  `auto_step_type` VARCHAR(64) DEFAULT NULL COMMENT 'ApproveStep, RejectStep, EndStep',
  `allow_applier_update` TINYINT(4) NOT NULL DEFAULT '0' COMMENT 'allow applier update content',
  `allow_timeout_action` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '1: allow timeout action',
  `create_time` DATETIME NOT NULL COMMENT 'record create time',
  `params` VARCHAR(64) DEFAULT NULL COMMENT 'the params from other module',
  `status` TINYINT(4) NOT NULL DEFAULT '0' COMMENT 'invalid, valid',
  ...
  `flow_lane_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'ref eh_flow_lanes',
  `flow_lane_level` INT(11) NOT NULL DEFAULT '0' COMMENT 'ref eh_flow_lanes',
  `need_all_processor_complete` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '节点会签开关',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_flow_predefined_params` (
  ...
  `name` VARCHAR(64) DEFAULT NULL COMMENT 'param name',
  `text` TEXT,
  `status` TINYINT(4) NOT NULL COMMENT '0: invalid, 1: valid',
  `creator_uid` BIGINT(20) DEFAULT NULL,
  `create_time` DATETIME(3) DEFAULT NULL,
...
CREATE TABLE `eh_flows` (
  ...
  `project_id` BIGINT(20) NOT NULL DEFAULT '0',
  `project_type` VARCHAR(64) DEFAULT NULL,
  `flow_main_id` BIGINT(20) NOT NULL DEFAULT '0' COMMENT 'the real flow id for all copy, the first flow_main_id=0',
  `flow_version` INT(11) NOT NULL DEFAULT '0' COMMENT 'current flow version',
  `flow_name` VARCHAR(64) NOT NULL COMMENT 'the name of flow',
  `status` TINYINT(4) NOT NULL COMMENT 'invalid, config, running, pending, stop',
  ...
  `create_time` DATETIME NOT NULL COMMENT 'record create time',
  `start_node` BIGINT(20) NOT NULL DEFAULT '0',
  `end_node` BIGINT(20) NOT NULL DEFAULT '0',
  `last_node` BIGINT(20) NOT NULL DEFAULT '0',
  `string_tag1` VARCHAR(128) DEFAULT NULL,
  `string_tag2` VARCHAR(128) DEFAULT NULL,
  `string_tag3` VARCHAR(128) DEFAULT NULL,
  `string_tag4` VARCHAR(128) DEFAULT NULL,
  ...
  `integral_tag4` BIGINT(20) NOT NULL DEFAULT '0',
  `integral_tag5` BIGINT(20) NOT NULL DEFAULT '0',
  `need_evaluate` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '0: no evaluate, 1: need evaluate',
  `evaluate_start` BIGINT(20) NOT NULL DEFAULT '0',
  `evaluate_end` BIGINT(20) NOT NULL DEFAULT '0',
  `evaluate_step` VARCHAR(64) DEFAULT NULL COMMENT 'NoStep, ApproveStep',
  `description` VARCHAR(128) DEFAULT NULL COMMENT 'flow description',
  `allow_flow_case_end_evaluate` TINYINT(4) NOT NULL DEFAULT '0' COMMENT 'allow_flow_case_end_evaluate',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_forum_posts` (
  ...
  `clone_flag` TINYINT COMMENT 'clone_flag post 0-real post, 1-clone post',
  `real_post_id` BIGINT(20) DEFAULT NULL COMMENT 'if this is clone post, then it should have a real post id',
  `stick_flag` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '是否置顶，0-否，1-是',
  PRIMARY KEY (`id`),
  UNIQUE KEY `u_eh_uuid` (`uuid`),
...
CREATE TABLE `eh_incubator_applies` (
  ...
  `re_apply_id` BIGINT COMMENT '重新申请的Id',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_payment_variables` (
  ...
  `charging_items_id` BIGINT NOT NULL,
  `name` VARCHAR(10),
  `creator_uid` BIGINT,
  `create_time` DATETIME,
  `operator_uid` BIGINT,
