...
CREATE TABLE `eh_activities` (
  ...
  `official_flag` tinyint(4) DEFAULT '0' COMMENT 'whether it is an official activity, 0 not, 1 yes',
  `video_url` varchar(128) DEFAULT NULL COMMENT 'url of video support',
  `is_video_support` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'is video support',
  `max_quantity` int(11) DEFAULT NULL COMMENT 'max person quantity',
  `content_type` varchar(128) DEFAULT NULL COMMENT 'content type, text/rich_text',
  `version` varchar(128) DEFAULT NULL COMMENT 'version',
  `category_id` bigint(20) NOT NULL DEFAULT '0' COMMENT 'activity category id',
  `forum_id` bigint(20) NOT NULL DEFAULT '0' COMMENT 'activity post forum that it belongs',
  `creator_tag` varchar(128) DEFAULT NULL COMMENT 'activity post creator tag',
  `target_tag` varchar(128) DEFAULT NULL COMMENT 'activity post target tag',
  ...
  `achievement` text,
  `achievement_type` varchar(32) DEFAULT NULL COMMENT 'richtext, link',
  `achievement_richtext_url` varchar(512) DEFAULT NULL COMMENT 'richtext page',
  `update_time` datetime DEFAULT NULL,
  `content_category_id` bigint(20) NOT NULL DEFAULT '0' COMMENT 'content category id',
  `signup_end_time` datetime DEFAULT NULL,
  `all_day_flag` tinyint(4) DEFAULT '0' COMMENT 'whether it is an all day activity, 0 not, 1 yes',
  PRIMARY KEY (`id`),
...
CREATE TABLE `eh_equipment_inspection_equipments` (
  ...
  `equipment_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: equipment, 1: equipment group',
  `custom_number` varchar(128) DEFAULT NULL,
  ...
  `latitude` double DEFAULT NULL,
  `geohash` varchar(64) DEFAULT NULL,
  `equipment_model` varchar(1024) DEFAULT NULL,
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: inactive, 1: incomplete(不完整), 2: in use(使用中), 3: in maintenance(维修中), 4: discarded(报废), 5: disabled(停用), 6: standby(备用)',
  ...
  `remarks` text,
  `sequence_no` varchar(128) DEFAULT NULL,
  `version_no` varchar(128) DEFAULT NULL,
  `manager` varchar(128) DEFAULT NULL,
  `qr_code_token` text,
  `qr_code_flag` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: inactive, 1: active',
  ...
  `namespace_id` int(11) DEFAULT NULL,
  `picture_flag` tinyint(4) DEFAULT '1' COMMENT 'whether need to take a picture while report equipment task, 0 not, 1 yes',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
  `id` BIGINT NOT NULL COMMENT 'id',
  `owner_type` VARCHAR(32) NOT NULL DEFAULT '' COMMENT 'the type of who own the equipment, enterprise, etc',
  ...
  `picture_flag` tinyint(4) DEFAULT '1' NULL COMMENT 'whether need to take a picture while report equipment task, 0 not, 1 yes', 
  `namespace_id` INTEGER,
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
