...
CREATE TABLE `eh_aclink_cameras` (
  `id` BIGINT NOT NULL,
  `namespace_id` BIGINT NOT NULL DEFAULT 0 COMMENT '域空间id',
  `name` VARCHAR(32),
  `door_access_id` BIGINT,
  ...
  `owner_type` TINYINT NOT NULL DEFAULT 0 COMMENT '所属组织类型',
  `owner_id` BIGINT NOT NULL DEFAULT 0 COMMENT '所属组织id',
...
DROP TABLE IF EXISTS `eh_aclink_device`;


CREATE TABLE `eh_aclink_device` (
  `id` BIGINT NOT NULL DEFAULT 0,
  `name` VARCHAR(128) COMMENT '设备类型名称',
  `type` TINYINT COMMENT '设备类型 0：自有设备 1：第三方设备',
  `description` VARCHAR(1024) COMMENT '设备特性',
  `support_bt` TINYINT COMMENT '蓝牙开门 0：不支持 1：支持',
  `support_qr` TINYINT COMMENT '二维码开门 0：不支持 1：支持',
  `support_face` TINYINT COMMENT '人脸识别开门 0：不支持 1：支持',
  `support_tempauth` TINYINT COMMENT '临时授权 0：不支持 1：支持',
  `firmware` VARCHAR(128) COMMENT '固件名称',
  `firmware_id` BIGINT,
  `update` TINYINT COMMENT '默认升级 0：不支持 1：支持',
...
DROP TABLE IF EXISTS `eh_aclink_firmware_new`;
...
CREATE TABLE `eh_aclink_firmware_new` (
  ...
  `number` INTEGER COMMENT '固件编号',
  `description` VARCHAR(1024),
  `bluetooth_name` VARCHAR(128) COMMENT '蓝牙名称',
  `bluetooth_id` BIGINT,
  `wifi_name` VARCHAR(128) COMMENT 'wifi名称',
  `wifi_id` BIGINT,
  `create_time` DATETIME COMMENT '创建时间',
  `status` TINYINT COMMENT '状态 0：失效 1：有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='门禁固件新表';

DROP TABLE IF EXISTS `eh_aclink_firmware_package`;


CREATE TABLE `eh_aclink_firmware_package` (
  `id` BIGINT NOT NULL DEFAULT 0,
  `name` VARCHAR(128) COMMENT '程序名称',
  `type` TINYINT COMMENT '程序类型 0：蓝牙 1：wifi',
  `size` INTEGER,
  `download_url` VARCHAR(1024) COMMENT '存储地址',
  `create_time` DATETIME COMMENT '创建时间',
  `status` TINYINT COMMENT '状态 0：失效 1：有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='门禁固件程序表';

DROP TABLE IF EXISTS `eh_aclink_form_titles`;


CREATE TABLE `eh_aclink_form_titles` (
  `id` BIGINT NOT NULL,
  `namespace_id` INTEGER NOT NULL,
  `owner_id` BIGINT COMMENT '所属对象id',
  `owner_type` TINYINT COMMENT '所属对象类型 0园区 1公司 2家庭 3门禁',
  `path` VARCHAR(1024) COMMENT '记录更新人userId',
  `name` VARCHAR(64) COMMENT '表单项名称',
  `item_type` TINYINT COMMENT '表单项类型, 0 表单中间结点 1 文本 2 单选 3 多选',
...
DROP TABLE IF EXISTS `eh_aclink_form_values`;


CREATE TABLE `eh_aclink_form_values` (
  `id` BIGINT NOT NULL,
  `namespace_id` INTEGER NOT NULL,
  `title_id` BIGINT NOT NULL COMMENT '对应表单标题的id',
  `value` VARCHAR(1024) COMMENT '表单项的值',
  `type` TINYINT COMMENT '值类型, 0 初始值(select,checkbox等) 1 默认值 2 输入值',
  `status` TINYINT NOT NULL DEFAULT 1 COMMENT '0已删除1有效',
  `owner_id` BIGINT NOT NULL COMMENT '记录所属对象Id',
  `owner_type` TINYINT NOT NULL COMMENT '记录所属对象类型 0园区 1公司 2家庭 3门禁 4用户 5授权记录',
  `creator_uid` BIGINT NOT NULL COMMENT '记录创建人userId',
  `create_time` DATETIME NOT NULL COMMENT '记录创建时间',
  `operator_uid` BIGINT COMMENT '记录更新人userId',
  `operate_time` DATETIME COMMENT '记录更新时间',
...
DROP TABLE IF EXISTS `eh_aclink_group`;


CREATE TABLE `eh_aclink_group` (
  `id` BIGINT NOT NULL,
  `namespace_id` INTEGER NOT NULL,
  `name` VARCHAR(1024) COMMENT '门禁组名称',
  `status` TINYINT NOT NULL DEFAULT 1 COMMENT '0已删除1有效',
  `owner_id` BIGINT NOT NULL COMMENT '记录所属对象Id',
  `owner_type` TINYINT NOT NULL COMMENT '记录所属对象类型 0园区 1公司',
  `creator_uid` BIGINT NOT NULL COMMENT '记录创建人userId',
  `create_time` DATETIME NOT NULL COMMENT '记录创建时间',
  `operator_uid` BIGINT COMMENT '记录更新人userId',
  `operate_time` DATETIME COMMENT '记录更新时间',
...
DROP TABLE IF EXISTS `eh_aclink_group_doors`;
...
CREATE TABLE `eh_aclink_group_doors` (
  ...
  `owner_type` TINYINT COMMENT '门禁组所属机构类型 0园区 1公司',
  `group_id` BIGINT COMMENT '门禁组id',
  `door_id` BIGINT COMMENT '门禁组所属门禁id',
  `status` TINYINT NOT NULL DEFAULT 1 COMMENT '状态 0删除 1有效',
  `creator_uid` BIGINT COMMENT '创建者id',
  `create_time` DATETIME COMMENT '创建时间',
  `operator_uid` BIGINT COMMENT '修改者id',
  `operator_time` DATETIME COMMENT '修改时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_aclink_ipads` (
  ...
  `operator_uid` BIGINT COMMENT '记录更新人userId',
  `operate_time` DATETIME COMMENT '记录更新时间',
  `logo_uri` VARCHAR(2048) COMMENT 'logo uri',
...
DROP TABLE IF EXISTS `eh_aclink_management`;
...
DROP TABLE IF EXISTS `eh_address_events`;


CREATE TABLE `eh_address_events` (
  `id` BIGINT NOT NULL,
  `namespace_id` INTEGER NOT NULL,
  `address_id` BIGINT NOT NULL COMMENT '房源id',
  `operator_uid` BIGINT COMMENT '操作人id',
  `operate_time` DATETIME ON UPDATE CURRENT_TIMESTAMP COMMENT '操作时间',
  `operate_type` TINYINT COMMENT '操作类型（1：增加，2：删，3：修改）',
  `content` TEXT COMMENT '日志内容',
  `status` TINYINT COMMENT '状态（0：无效，1：待确认，2：生效）',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_addresses` (
  ...
  KEY `i_eh_addr_building_id` (`building_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_alliance_config_state`;
...
CREATE TABLE `eh_alliance_config_state` (
  ...
  `project_id` BIGINT NOT NULL COMMENT 'community为项目id， organaization为公司id',
  `status` TINYINT NOT NULL DEFAULT 0 COMMENT '0-取默认配置 1-取自定义配置。当owner_type为organization时，该值必定为1。',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `create_uid` BIGINT NOT NULL DEFAULT 0 COMMENT 'user_id of creater',
  PRIMARY KEY (`id`),
  UNIQUE KEY `u_eh_prefix` (`type`,`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='储存应用不同项目下的配置情况。';
...
DROP TABLE IF EXISTS `eh_alliance_faq_service_customers`;
...
CREATE TABLE `eh_alliance_faq_service_customers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='faq的客服';

DROP TABLE IF EXISTS `eh_alliance_faq_types`;
...
CREATE TABLE `eh_alliance_faq_types` (
  ...
  `status` TINYINT NOT NULL DEFAULT 0 COMMENT '0-已被删除 2-正常',
  `default_order` BIGINT NOT NULL DEFAULT 0 COMMENT '默认排序 数字小的在上面',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_uid` BIGINT NOT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='问题分类表';

DROP TABLE IF EXISTS `eh_alliance_faqs`;
...
CREATE TABLE `eh_alliance_faqs` (
  ...
  `owner_type` VARCHAR(20) NOT NULL,
  `owner_id` BIGINT NOT NULL,
  `type` BIGINT NOT NULL COMMENT '服务联盟类型',
  ...
  `solve_times` INTEGER NOT NULL DEFAULT 0 COMMENT '解决次数',
  `un_solve_times` INTEGER NOT NULL DEFAULT 0 COMMENT '未解决次数',
  `top_flag` TINYINT NOT NULL DEFAULT 0 COMMENT '0-非热门 1-热门',
  `default_order` BIGINT NOT NULL DEFAULT 0 COMMENT '默认排序 数字小的在上面',
  `top_order` BIGINT NOT NULL DEFAULT 0 COMMENT '热门排序 数字小的在上面',
  `status` TINYINT NOT NULL DEFAULT 0 COMMENT '0-已被删除 2-正常',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_uid` BIGINT NOT NULL COMMENT '创建人',
  PRIMARY KEY (`id`),
  KEY `i_eh_top_order` (`top_order`),
  KEY `i_eh_default_order` (`default_order`),
  KEY `i_eh_type_id_type` (`owner_type`,`owner_id`,`type`)
...
DROP TABLE IF EXISTS `eh_alliance_operate_services`;
...
CREATE TABLE `eh_alliance_operate_services` (
  ...
  `default_order` BIGINT NOT NULL DEFAULT 0 COMMENT '排序，数字小的在上面',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_uid` BIGINT NOT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='运营模块展示服务';

DROP TABLE IF EXISTS `eh_alliance_service_category_match`;
...
CREATE TABLE `eh_alliance_service_category_match` (
  ...
  `create_uid` BIGINT NOT NULL DEFAULT 0 COMMENT 'user_id of creater',
  PRIMARY KEY (`id`),
  UNIQUE KEY `u_eh_service_category` (`service_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='服务与服务类型的匹配表，生成/删除项目配置后需要新增/删除服务与服务类型的匹配关系。这样客户端才能获取到以前对应的服务。';
...
CREATE TABLE `eh_alliance_tag` (
  ...
  `owner_type` VARCHAR(15) NOT NULL DEFAULT 'organization',
  `owner_id` BIGINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_app_categories`;
...
CREATE TABLE `eh_app_categories` (
  ...
  `name` VARCHAR(255),
  `parent_id` BIGINT NOT NULL DEFAULT 0,
  `location_type` TINYINT COMMENT '参考枚举ServiceModuleLocationType',
  `app_type` TINYINT COMMENT '一级分类，0-oa，1-community，2-service。参考ServiceModuleAppType',
  `default_order` BIGINT DEFAULT 0,
  `leaf_flag` TINYINT COMMENT 'is leaf category, 0-no, 1-yes',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `eh_app_community_configs`;


CREATE TABLE `eh_app_community_configs` (
  `id` BIGINT NOT NULL,
  `app_origin_id` BIGINT COMMENT 'app_origin_id',
  `community_id` BIGINT,
  `visibility_flag` TINYINT,
  `display_name` VARCHAR(255),
  `creator_uid` BIGINT,
  `create_time` DATETIME ON UPDATE CURRENT_TIMESTAMP,
  `operator_uid` BIGINT,
  `operator_time` DATETIME ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `eh_app_urls` (
  ...
  `description` TEXT,
  `theme_color` VARCHAR(64) COMMENT '主题色',
...
DROP TABLE IF EXISTS `eh_asset_dooraccess_logs`;
...
CREATE TABLE `eh_asset_dooraccess_logs` (
  ...
  `owner_id` BIGINT NOT NULL DEFAULT 0 COMMENT '普通公司,企业的id,用户id',
  `owner_type` VARCHAR(64) NOT NULL,
  `org_id` BIGINT,
  `status` TINYINT COMMENT '0:无效状态，2：激活状态',
  `dooraccess_status` TINYINT COMMENT '该项目下门禁的状态 0:关闭门禁，1是开启门禁 ',
...
DROP TABLE IF EXISTS `eh_asset_dooraccess_params`;


CREATE TABLE `eh_asset_dooraccess_params` (
  `id` BIGINT NOT NULL,
  `namespace_id` INTEGER,
  `owner_id` BIGINT NOT NULL DEFAULT 0 COMMENT 'owner_id',
  `owner_type` VARCHAR(64) NOT NULL,
  `org_id` BIGINT,
  `status` TINYINT COMMENT '0:无效状态，2：激活状态',
...
CREATE TABLE `eh_asset_module_app_mappings` (
  ...
  `goods_serve_type` VARCHAR(1024) COMMENT '商品-服务类别',
  `goods_namespace` VARCHAR(1024) COMMENT '商品-域空间',
  `goods_tag1` VARCHAR(1024) COMMENT '商品-服务提供方标识1',
  `goods_tag2` VARCHAR(1024) COMMENT '商品-服务提供方标识2',
  `goods_tag3` VARCHAR(1024) COMMENT '商品-服务提供方标识3',
  `goods_tag4` VARCHAR(1024) COMMENT '商品-服务提供方标识4',
  `goods_tag5` VARCHAR(1024) COMMENT '商品-服务提供方标识5',
  `goods_serve_apply_name` VARCHAR(1024) COMMENT '商品-服务提供方名称',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COMMENT='relation mappings among applications';
...
DROP TABLE IF EXISTS `eh_banner_categories`;
...
CREATE TABLE `eh_communities`(
  ...
  `free_area` DOUBLE COMMENT '可招租面积',
  `default_community_flag` TINYINT COMMENT 'is the default community in his namespace, 0-no, 1-yes',
  `app_self_config_flag` TINYINT,
  `background_img_uri` VARCHAR(500) DEFAULT '' COMMENT '小区或园区项目的图片链接',
  PRIMARY KEY (`id`),
  UNIQUE KEY `u_eh_uuid` (`uuid`),
...
DROP TABLE IF EXISTS `eh_community_bizs`;
...
CREATE TABLE `eh_community_bizs` (
  ...
  `status` TINYINT DEFAULT 2 COMMENT '0-delete，1-disable，2-enable',
  PRIMARY KEY (`id`),
  KEY `community_id` (`community_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_communityandbuilding_relationes` (
  `id` BIGINT NOT NULL COMMENT '主键id',
  `building_id` BIGINT COMMENT '楼栋id',
  `community_id` BIGINT COMMENT '所在项目id',
  `address_id` BIGINT COMMENT '地址id',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` DATETIME COMMENT '修改时间',
  `workplace_id` BIGINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_contract_categories` (
  ...
  `print_switch_status` TINYINT NOT NULL DEFAULT 0 COMMENT '合同套打(0 关闭，任何合同状态都能打印 1 打开 只有审批通过，正常合同、即将到期合同才能进行此操作)打开关',
  `editor_switch_status` TINYINT NOT NULL DEFAULT 0 COMMENT '合同文档编辑开关',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_contract_charging_items` (
  ...
  `delete_time` DATETIME,
  `bill_group_id` BIGINT COMMENT '账单组ID',
  `one_time_bill_status` TINYINT COMMENT '是否是一次性产生费用，1：是，0：否',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `eh_contract_documents`;
...
CREATE TABLE `eh_contract_documents` (
  ...
  `category_id` BIGINT NOT NULL COMMENT '合同多入口id',
  `contract_id` BIGINT NOT NULL COMMENT '合同文档关联的合同id',
  `contract_template_id` BIGINT COMMENT '关联的合同模板id',
  `parent_id` BIGINT DEFAULT 0 COMMENT '上一版合同文档的id',
  `name` VARCHAR(255) COMMENT '合同文档名称',
  `contract_number` VARCHAR(128) COMMENT '合同编号',
  `content_type` VARCHAR(32) COMMENT '文本存储方式（gogs）',
  `content` VARCHAR(128) COMMENT '文本内容（在gogs存储时，存的是文本的commit id）',
  `version` INTEGER DEFAULT 0 COMMENT '合同文档的版本号',
  `status` TINYINT COMMENT '合同文档的状态-0: inactive, 1: confirming, 2: active',
  `creator_uid` BIGINT NOT NULL COMMENT '创建人',
...
DROP TABLE IF EXISTS `eh_contract_statistic_communities`;
...
CREATE TABLE `eh_contract_statistic_communities` (
  ...
  `namespace_id` INTEGER,
  `community_id` BIGINT,
  `date_str` VARCHAR(12) COMMENT '统计月份（格式为xxxx-xx）',
  `date_type` TINYINT DEFAULT 2 COMMENT '统计时间类型： 1-统计月份（格式为xxxx-xx）, 2-统计年份（格式为xxxx）',
  `rent_amount` DECIMAL(12,2) DEFAULT '0.00' COMMENT '每个园区的合同总额',
  `rental_area` DECIMAL(12,2) DEFAULT '0.00' COMMENT '每个园区的合同租赁总面积',
  `contract_count` INTEGER DEFAULT 0 COMMENT '一个园区在租合同总份数',
  `customer_count` INTEGER DEFAULT 0 COMMENT '新签客户总数',
  `org_contract_count` INTEGER DEFAULT 0 COMMENT '企业合同总数',
  `org_contract_amount` DECIMAL(12,2) DEFAULT '0.00' COMMENT '企业合同总额',
  `user_contract_count` INTEGER DEFAULT 0 COMMENT '个人合同总数',
  `user_contract_amount` DECIMAL(12,2) DEFAULT '0.00' COMMENT '个人合同总额',
  `new_contract_count` INTEGER DEFAULT 0 COMMENT '新签合同总数',
  ...
  `denunciation_contract_count` INTEGER DEFAULT 0 COMMENT '退约合同总数',
  ...
  `change_contract_count` INTEGER DEFAULT 0 COMMENT '变更合同总数',
  ...
  `renew_contract_count` INTEGER DEFAULT 0 COMMENT '续约合同总数',
...
DROP TABLE IF EXISTS `eh_contract_task_operate_logs`;
...
CREATE TABLE `eh_contract_task_operate_logs` (
  ...
  `operate_type` TINYINT COMMENT '1 合同初始化, ２　合同免批,3　合同复制',
  `processed_number` INTEGER COMMENT '已处理记录数',
  `total_number` INTEGER COMMENT '总记录数',
  `status` TINYINT COMMENT '0:无效状态，2：激活状态',
  `start_time` DATETIME,
...
CREATE TABLE `eh_contract_templates` (
  ...
  `update_time` DATETIME COMMENT '更新时间',
  `init_params` VARCHAR(1024) COMMENT '合同模板初始化参数（计价条款、关联资产等的数目），前端会解析这个json',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_contracts` (
  ...
  `document_id` BIGINT COMMENT '当前生效的合同文档id',
  `apartment_delivery_time` DATETIME ON UPDATE CURRENT_TIMESTAMP COMMENT '房屋交付日期',
  `down_payment_rent_time` DATETIME ON UPDATE CURRENT_TIMESTAMP COMMENT '首期租金开始日期',
  `monthly_margin` INTEGER DEFAULT 0 COMMENT '保证金月数',
  `margin_amount` DECIMAL(12,2) DEFAULT '0.00' COMMENT '保证金金额',
  `monthly_service_charge` DECIMAL(12,2) DEFAULT '0.00' COMMENT '月服务费金额',
  `pre_amount` DECIMAL(12,2) DEFAULT '0.00' COMMENT '预付金额',
  `contracting_place` VARCHAR(64) COMMENT '签约地点',
  `string_tag1` VARCHAR(64) COMMENT '预留字段1',
  `string_tag2` VARCHAR(64) COMMENT '预留字段2',
  `string_tag3` VARCHAR(64) COMMENT '预留字段3',
  `string_tag4` VARCHAR(64) COMMENT '预留字段4',
  `string_tag5` VARCHAR(64) COMMENT '预留字段5',
  `string_tag6` VARCHAR(64) COMMENT '预留字段6',
  `string_tag7` VARCHAR(64) COMMENT '预留字段7',
  `string_tag8` VARCHAR(64) COMMENT '预留字段8',
  `string_tag9` VARCHAR(64) COMMENT '预留字段9',
  `string_tag10` VARCHAR(64) COMMENT '预留字段10',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_customer_level_change_records`;
...
DROP TABLE IF EXISTS `eh_customer_statistics_daily`;
...
CREATE TABLE `eh_customer_statistics_daily` (
  ...
  `new_customer_num` INTEGER COMMENT '新增客户增量',
  `registered_customer_num` INTEGER COMMENT '成交客户增量',
  `loss_customer_num` INTEGER COMMENT '流失客户增量',
  `history_customer_num` INTEGER COMMENT '历史客户增量',
  `delete_customer_num` INTEGER COMMENT '删除客户增量',
  `tracking_num` INTEGER COMMENT '跟进次数增量',
  `customer_count` INTEGER COMMENT '园区内的总客户数',
  `create_date` DATETIME COMMENT '创建日期',
  `create_uid` BIGINT COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='客户统计表，每日';

DROP TABLE IF EXISTS `eh_customer_statistics_daily_total`;
...
CREATE TABLE `eh_customer_statistics_daily_total` (
  ...
  `community_num` INTEGER COMMENT '管理公司下的园区数量',
  `new_customer_num` INTEGER COMMENT '新增客户增量',
  `registered_customer_num` INTEGER COMMENT '成交客户增量',
  `loss_customer_num` INTEGER COMMENT '流失客户增量',
  `history_customer_num` INTEGER COMMENT '历史客户增量',
...
DROP TABLE IF EXISTS `eh_customer_statistics_monthly`;
...
DROP TABLE IF EXISTS `eh_customer_statistics_monthly_total`;
...
DROP TABLE IF EXISTS `eh_customer_statistics_total`;
...
CREATE TABLE `eh_customer_statistics_total` (
  ...
  `community_num` INTEGER COMMENT '管理公司下的园区数量',
  `new_customer_num` INTEGER COMMENT '新增客户 数',
  `registered_customer_num` INTEGER COMMENT '成交客户总数',
  `loss_customer_num` INTEGER COMMENT '流失客户总数',
  `history_customer_num` INTEGER COMMENT '历史客户总数',
  `delete_customer_num` INTEGER COMMENT '删除客户总数',
  `tracking_num` INTEGER COMMENT '跟进总次数',
  `customer_count` INTEGER COMMENT '园区内的总客户数',
  `create_date` DATETIME COMMENT '创建日期',
  `create_uid` BIGINT COMMENT '创建人',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_door_access` (
  `id` BIGINT NOT NULL COMMENT 'id of the record',
  `firmware_version` VARCHAR(64) COMMENT '门禁固件版本',
  `namespace_id` INTEGER NOT NULL DEFAULT 0,
  `uuid` VARCHAR(64) NOT NULL,
  `door_type` TINYINT NOT NULL COMMENT '0: Zuolin aclink with wifi, 1: Zuolink aclink without wifi',
  `hardware_id` VARCHAR(64) NOT NULL COMMENT 'mac address of aclink',
  ...
  `enable_amount` TINYINT DEFAULT 0 COMMENT '门禁是否支持授权按次开门，1是0否',
  `local_server_id` BIGINT COMMENT '服务器id',
  `has_qr` TINYINT NOT NULL DEFAULT 1 COMMENT '门禁二维码能力0无1有',
  `max_duration` INTEGER DEFAULT 7 COMMENT '有效时间最大值(天)',
  `max_count` INTEGER COMMENT '按次授权最大次数',
  `defualt_invalid_duration` INTEGER COMMENT '按次授权默认有效期(天)',
  `enable_duration` TINYINT DEFAULT 1 COMMENT '门禁是否支持授权按有效期开门，1是0否',
  `firmware_id` BIGINT COMMENT '门禁设备固件版本id',
  `firmware_name` VARCHAR(128) COMMENT '门禁设备固件名',
  `device_id` BIGINT COMMENT '门禁设备类型id',
  `device_name` VARCHAR(128) COMMENT '门禁设备固件名',
...
CREATE TABLE `eh_door_auth` (
  ...
  `door_id` BIGINT NOT NULL,
  `user_id` BIGINT NOT NULL,
  `group_type` TINYINT DEFAULT 0 COMMENT '门禁集合的类型 0 单个门禁 1 新门禁组(门禁3.0) ',
  `licensee_type` TINYINT DEFAULT 0 COMMENT '被授权对象的类型 0用户 1组织架构节点 2项目(公司) 3楼栋(公司) 4楼层(公司) 5项目(家庭) 6楼栋(家庭) 7楼层(家庭)',
...
CREATE TABLE `eh_enterprise_customers` (
  ...
  `legal_address` VARCHAR(512) COMMENT '法定地址',
  `legal_address_zip` VARCHAR(32) COMMENT '法定地址邮编',
  `postal_address` VARCHAR(512) COMMENT '通讯地址',
  `postal_address_zip` VARCHAR(32) COMMENT '通讯地址邮编',
  `taxpayer_identification_code` VARCHAR(32) COMMENT '纳税人识别号',
  `identify_card_number` VARCHAR(32) COMMENT '身份证号码',
  `opening_bank` VARCHAR(64) COMMENT '开户行',
  `opening_name` VARCHAR(64) COMMENT '开户名',
  `opening_account` VARCHAR(32) COMMENT '开户行账号',
  `string_tag17` VARCHAR(32) COMMENT '预留字段17',
  `string_tag18` VARCHAR(32) COMMENT '预留字段18',
  `string_tag19` VARCHAR(32) COMMENT '预留字段19',
  `string_tag20` VARCHAR(32) COMMENT '预留字段20',
  `string_tag21` VARCHAR(32) COMMENT '预留字段21',
  `corp_legal_person_duty` VARCHAR(32) COMMENT '法人代表职务',
  `corp_legal_person_token` VARCHAR(32) COMMENT '法人联系电话',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_enterprise_payment_auth_employee_limit_change_logs`;
...
CREATE TABLE `eh_enterprise_payment_auth_employee_limit_change_logs` (
  ...
  `user_id` BIGINT COMMENT '被授权用户ID',
  ...
  `operate_time` DATETIME COMMENT '操作时间',
  PRIMARY KEY (`id`),
  KEY `i_eh_organization_detail_id` (`namespace_id`,`organization_id`,`detail_id`,`operate_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='企业支付员工授权额度变更记录表';

DROP TABLE IF EXISTS `eh_enterprise_payment_auth_employee_limit_details`;
...
CREATE TABLE `eh_enterprise_payment_auth_employee_limit_details` (
  ...
  `historical_total_pay_amount` DECIMAL(20,2) NOT NULL DEFAULT '0.00' COMMENT '历史累计支付金额',
...
DROP TABLE IF EXISTS `eh_enterprise_payment_auth_employee_limits`;
...
DROP TABLE IF EXISTS `eh_enterprise_payment_auth_employee_pay_histories`;
...
CREATE TABLE `eh_enterprise_payment_auth_employee_pay_histories` (
  ...
  `used_amount` DECIMAL(20,2) NOT NULL DEFAULT '0.00' COMMENT '当月使用额度',
  ...
  `operate_time` DATETIME COMMENT '记录更新时间',
  PRIMARY KEY (`id`),
  KEY `i_eh_organization_detail_month` (`namespace_id`,`organization_id`,`detail_id`,`pay_month`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='企业支付员工全场景每月支付汇总表';

DROP TABLE IF EXISTS `eh_enterprise_payment_auth_employee_pay_scene_histories`;
...
CREATE TABLE `eh_enterprise_payment_auth_employee_pay_scene_histories` (
  ...
  `payment_scene_app_id` BIGINT NOT NULL COMMENT '支付应用场景ID',
  `pay_month` char(6) NOT NULL COMMENT '历史月份，格式:yyyyMM',
  `used_amount` DECIMAL(20,2) NOT NULL DEFAULT '0.00' COMMENT '已使用额度',
  `pay_count` INTEGER NOT NULL DEFAULT 0 COMMENT '当月累计支付笔数',
  `creator_uid` BIGINT NOT NULL COMMENT '记录创建人userId',
  `create_time` DATETIME NOT NULL COMMENT '记录创建时间',
  `operator_uid` BIGINT COMMENT '记录更新人userId',
...
DROP TABLE IF EXISTS `eh_enterprise_payment_auth_frozen_requests`;
...
CREATE TABLE `eh_enterprise_payment_auth_frozen_requests` (
  ...
  PRIMARY KEY (`id`),
  KEY `i_eh_order_id` (`merchant_order_id`),
  KEY `i_eh_create_time` (`create_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='企业支付授权-支付余额冻结表';

DROP TABLE IF EXISTS `eh_enterprise_payment_auth_operate_logs`;
...
CREATE TABLE `eh_enterprise_payment_auth_operate_logs` (
  ...
  `operate_time` DATETIME COMMENT '操作时间',
  PRIMARY KEY (`id`),
  KEY `i_eh_namespace_organization_id` (`namespace_id`,`organization_id`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='企业支付授权管理员授权操作日志';

DROP TABLE IF EXISTS `eh_enterprise_payment_auth_pay_logs`;
...
CREATE TABLE `eh_enterprise_payment_auth_pay_logs` (
  ...
  `create_time` DATETIME NOT NULL COMMENT '记录创建时间',
  PRIMARY KEY (`id`),
  KEY `i_eh_organization_detail` (`namespace_id`,`organization_id`,`detail_id`,`pay_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='企业支付员工支付记录表';

DROP TABLE IF EXISTS `eh_enterprise_payment_auth_scene_limits`;
...
CREATE TABLE `eh_enterprise_payment_auth_scene_limits` (
  ...
  `payment_scene_app_id` BIGINT NOT NULL COMMENT '支付应用场景ID',
  `limit_amount` DECIMAL(20,2) COMMENT '每月额度，null值表示不限额',
  `historical_total_pay_amount` DECIMAL(20,2) NOT NULL DEFAULT '0.00' COMMENT '历史累计支付金额，放在这个表避免每次查询的计算损耗',
...
DROP TABLE IF EXISTS `eh_enterprise_payment_auth_scene_pay_histories`;
...
CREATE TABLE `eh_enterprise_payment_auth_scene_pay_histories` (
  ...
  `operate_time` DATETIME COMMENT '记录更新时间',
  PRIMARY KEY (`id`),
  KEY `i_eh_organization_payment_scene_month` (`namespace_id`,`organization_id`,`payment_scene_app_id`,`pay_month`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='企业支付应用场景各个月份支付汇总表';

DROP TABLE IF EXISTS `eh_enterprise_payment_auths`;
...
CREATE TABLE `eh_equipment_inspection_review_date` (
  ...
  `target_id` BIGINT NOT NULL DEFAULT 0 COMMENT 'organization id',
...
CREATE TABLE `eh_flow_cases` (
  ...
  `origin_app_id` BIGINT NOT NULL DEFAULT 0 COMMENT '应用 id',
  PRIMARY KEY (`id`),
  KEY `i_eh_ns_org_module_id` (`namespace_id`,`organization_id`,`module_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_flow_nodes` (
  ...
  `form_relation_type` TINYINT NOT NULL DEFAULT 0 COMMENT '1: 关联自定义表单, 2: 关联eh_flows关联的表单',
  `form_relation_data` TEXT COMMENT '表单关联数据，json格式',
  PRIMARY KEY (`id`),
  KEY `i_eh_flow_main_id_flow_ver` (`flow_main_id`,`flow_version`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_flow_statistics_handle_log`;


CREATE TABLE `eh_flow_statistics_handle_log` (
  `id` bigint(32) NOT NULL COMMENT '主键',
  `log_id` bigint(32) COMMENT 'log主键',
  `namespace_id` INTEGER COMMENT '域空间ＩＤ',
  `flow_main_id` bigint(32),
  `flow_version` INTEGER COMMENT '版本号',
  `flow_node_id` bigint(32) COMMENT '节点ＩＤ',
  `flow_node_name` VARCHAR(64) COMMENT '节点名',
  `flow_lanes_id` bigint(32) COMMENT '泳道ＩＤ',
  `flow_lanes_name` VARCHAR(64) COMMENT '泳道名',
  `start_time` DATETIME COMMENT '起始时间',
  `end_time` DATETIME COMMENT '结束时间',
  `cycle` bigint(32) COMMENT '周期时长（单位为秒 s）',
  `create_time` DATETIME COMMENT '记录创建时间',
  `flow_lanes_cycle` bigint(32) DEFAULT 0 COMMENT '泳道周期时长（单位为秒 s）',
  `flow_case_id` BIGINT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_flows` (
  ...
  `form_relation_data` TEXT COMMENT '表单关联数据，json格式',
  PRIMARY KEY (`id`),
  KEY `i_eh_flow_main_id_flow_version` (`flow_main_id`,`flow_version`),
  KEY `i_eh_ns_org_module_id` (`namespace_id`,`organization_id`,`module_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_general_approval_vals` (
  ...
  `flow_case_id` BIGINT DEFAULT 0,
  `flow_node_id` BIGINT COMMENT '表单绑定的工作流节点ID',
  `request_id` BIGINT,
  `approval_id` BIGINT,
  `form_origin_id` BIGINT,
  `form_version` BIGINT,
  ...
  `create_time` DATETIME COMMENT 'record create time',
  `creator_uid` BIGINT COMMENT '创建人uid',
  `operator_uid` BIGINT COMMENT '操作人Uid',
  `operate_time` DATETIME COMMENT '编辑时间',
  PRIMARY KEY (`id`),
  KEY `i_eh_flow_case_id` (`flow_case_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_general_form_fields_config`;
...
CREATE TABLE `eh_general_form_fields_config` (
  ...
  `config_origin_id` BIGINT NOT NULL DEFAULT 0 COMMENT 'The id of the original form fields config',
  `config_version` BIGINT NOT NULL DEFAULT 0,
  `config_type` VARCHAR(64) NOT NULL COMMENT '表单节点配置类型',
  `form_fields` TEXT COMMENT 'json 存放表单字段',
  `status` TINYINT NOT NULL COMMENT '0: invalid, 1: config, 2: running',
  `create_time` datetime(3) NOT NULL COMMENT 'record create time',
  `creator_uid` BIGINT NOT NULL DEFAULT 0,
  `update_time` datetime(3) COMMENT 'record update time',
  `updater_uid` BIGINT NOT NULL DEFAULT 0,
...
DROP TABLE IF EXISTS `eh_launch_pad_configs`;
...
CREATE TABLE `eh_launch_pad_configs` (
  ...
  `owner_id` BIGINT NOT NULL,
  `navigator_all_icon_uri` VARCHAR(255),
  `create_time` DATETIME,
  `update_time` DATETIME,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `eh_launch_pad_indexs`;
...
DROP TABLE IF EXISTS `eh_meeting_invitation_templates`;
...
DROP TABLE IF EXISTS `eh_meeting_templates`;
...
CREATE TABLE `eh_office_cubicle_attachments` (
  ...
  `creator_uid` BIGINT,
  `create_time` DATETIME,
  `type` TINYINT COMMENT '1,空间，2短租工位，3开放式工位',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_office_cubicle_charge_users`;
...
CREATE TABLE `eh_office_cubicle_cities` (
  ...
  `operator_uid` BIGINT,
  `operate_time` DATETIME,
  `org_id` BIGINT COMMENT '所属管理公司Id',
  `owner_type` VARCHAR(128) COMMENT '项目类型',
  `owner_id` BIGINT COMMENT '项目Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `eh_office_cubicle_configs`;
...
CREATE TABLE `eh_office_cubicle_orders` (
  ...
  `category_id` BIGINT,
  `employee_number` VARCHAR(64) COMMENT '雇员数量',
  `financing_flag` TINYINT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `eh_office_cubicle_payee_accounts`;
...
DROP TABLE IF EXISTS `eh_office_cubicle_refund_rule`;
...
DROP TABLE IF EXISTS `eh_office_cubicle_refund_tips`;
...
DROP TABLE IF EXISTS `eh_office_cubicle_rent_orders`;
...
DROP TABLE IF EXISTS `eh_office_cubicle_room`;
...
CREATE TABLE `eh_office_cubicle_spaces` (
  ...
  `owner_type` VARCHAR(128),
  `owner_id` BIGINT,
  `open_flag` TINYINT COMMENT '是否开启空间，1是，0否',
  `short_rent_nums` VARCHAR(32) COMMENT '短租工位数量',
  `long_rent_price` DECIMAL(10,2) COMMENT '长租工位价格',
  `refund_strategy` TINYINT,
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `eh_office_cubicle_station`;
...
DROP TABLE IF EXISTS `eh_office_cubicle_station_rent`;
...
DROP TABLE IF EXISTS `eh_organization_apps`;


CREATE TABLE `eh_organization_apps` (
  `id` BIGINT NOT NULL,
  `app_origin_id` BIGINT,
  `org_id` BIGINT,
  `visibility_flag` TINYINT,
  `display_name` VARCHAR(255),
  `status` TINYINT,
  ...
  `operator_time` DATETIME,
  PRIMARY KEY (`id`),
  KEY `org_app_orgid` (`org_id`),
  KEY `org_app_appid` (`app_origin_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_organization_details` (
  ...
  `member_range` VARCHAR(25) COMMENT '人员规模',
  `pm_flag` TINYINT COMMENT '是否是管理公司 1-是，0-否',
  `service_support_flag` TINYINT COMMENT '是否是服务商 1-是，0-否',
  PRIMARY KEY (`id`),
...
CREATE TABLE `eh_organization_member_details` (
  ...
  `target_id` BIGINT NOT NULL,
  `account` VARCHAR(32) COMMENT 'the unique symbol of the member',
...
DROP TABLE IF EXISTS `eh_organization_workplaces`;


CREATE TABLE `eh_organization_workplaces` (
  `id` BIGINT NOT NULL COMMENT '主键id',
  `organization_id` BIGINT COMMENT '组织id',
  `workplace_name` VARCHAR(50) COMMENT '办公点名称',
  `community_id` BIGINT COMMENT '所在项目id',
  `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` DATETIME COMMENT '修改时间',
  `province_id` BIGINT COMMENT '省份id',
  ...
  `whole_address_name` VARCHAR(128) COMMENT '地址详细名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_organizations` (
  ...
  `work_platform_flag` TINYINT COMMENT 'open work platform flag, 0-no, 1-yes',
  `pm_flag` TINYINT COMMENT '是否是管理公司 1-是，0-否',
  `service_support_flag` TINYINT COMMENT '是否是服务商 1-是，0-否',
  PRIMARY KEY (`id`),
...
CREATE TABLE `eh_parking_lots` (
  ...
  `default_data` TEXT COMMENT '自定义上传资料',
  `default_plate` VARCHAR(16) COMMENT '默认车牌',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_payment_bill_groups` (
  ...
  `is_default` TINYINT DEFAULT 0 COMMENT '标识是否是默认账单组的字段：1：默认；0：非默认',
  `billing_cycle_expression` VARCHAR(100) COMMENT '账单周期表达式',
  `bills_day_expression` VARCHAR(100) COMMENT '出账单日表达式',
  `due_day_expression` VARCHAR(100) COMMENT '最晚还款日表达式',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_payment_bill_items` (
  ...
  `consume_user_id` BIGINT COMMENT '记账人ID',
  `consume_user_name` VARCHAR(128) COMMENT '记账人名称',
  ...
  `is_readonly` TINYINT DEFAULT 0 COMMENT '只读状态：0：非只读；1：只读',
  `merchant_order_id` VARCHAR(128) COMMENT '统一账单加入的：统一订单定义的唯一标识',
  `goods_serve_type` VARCHAR(1024) COMMENT '商品-服务类别',
  `goods_namespace` VARCHAR(1024) COMMENT '商品-域空间',
  `goods_tag1` VARCHAR(1024) COMMENT '商品-服务提供方标识1',
  `goods_tag2` VARCHAR(1024) COMMENT '商品-服务提供方标识2',
  ...
  `goods_tag5` VARCHAR(1024) COMMENT '商品-服务提供方标识5',
  `goods_serve_apply_name` VARCHAR(1024) COMMENT '商品-服务提供方名称',
  `goods_tag` VARCHAR(1024) COMMENT '商品标识，如：活动ID、商品ID',
  `goods_name` VARCHAR(1024) COMMENT '商品名称',
  `goods_description` VARCHAR(1024) COMMENT '商品说明',
  `goods_counts` INTEGER COMMENT '商品数量',
  `goods_price` DECIMAL(10,2) COMMENT '商品单价',
  `goods_totalPrice` DECIMAL(10,2) COMMENT '商品总金额',
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `eh_payment_bill_statistic_building`;
...
DROP TABLE IF EXISTS `eh_payment_bill_statistic_community`;
...
CREATE TABLE `eh_payment_bills` (
  ...
  `is_readonly` TINYINT DEFAULT 0 COMMENT '只读状态：0：非只读；1：只读',
  `merchant_order_id` VARCHAR(128) COMMENT '统一账单加入的：统一订单定义的唯一标识',
  `third_paid` TINYINT COMMENT '不支持同一笔账单即在左邻支付一半，又在EAS支付一半，不允许两边分别支付，0：没有任何支付，1：已在EAS支付',
  `third_sign` TINYINT COMMENT '一个特殊error标记给左邻系统，左邻系统以此标记判断该条数据下一次同步不再传输（0：不传输）',
  `confirm_flag` TINYINT COMMENT '支付状态是否已确认字段，1：已确认；0：待确认',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_payment_exemption_items` (
  ...
  `operator_uid` BIGINT,
  `update_time` DATETIME,
  `merchant_order_id` BIGINT COMMENT '账单明细ID',
  `delete_flag` TINYINT NOT NULL DEFAULT 1 COMMENT '删除状态：0：已删除；1：正常使用',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_pm_task_archibus_user_mapping` (
  ...
  `owner_type` VARCHAR(64),
  `owner_id` BIGINT NOT NULL DEFAULT 0,
  `archibus_uid` VARCHAR(64) COMMENT '国贸用户Id',
  `user_id` BIGINT DEFAULT 0 COMMENT '用户Id',
  `identifier_token` VARCHAR(128) COMMENT '用户手机号',
  `create_time` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `creator_uid` BIGINT,
...
DROP TABLE IF EXISTS `eh_pm_task_categories`;
...
CREATE TABLE `eh_portal_item_groups` (
  ...
  `creator_uid` BIGINT NOT NULL,
  `description` VARCHAR(1024),
  `title_flag` TINYINT COMMENT '0-none,1-left,2-center，reference  TitleFlag.java',
  `title` VARCHAR(255),
  `title_uri` VARCHAR(1024),
  `title_style` INTEGER COMMENT 'title style, reference TitleStyle.java',
  `sub_title` VARCHAR(255),
  `title_size` TINYINT COMMENT '0-small, 1-medium, 2-large    TitleSize.java',
  `title_more_flag` TINYINT COMMENT '0-no, 1-yes. reference trueOrFalseFlag.java',
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `eh_property_statistic_building`;
...
CREATE TABLE `eh_property_statistic_building` (
  ...
  `total_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的房源总数',
  `free_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的待租房源数',
  `rent_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的已出租房源数',
  `occupied_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的已占用房源数',
  `living_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的自用房源数',
  `saled_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的已售房源数',
  `signedup_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的待签约房源数',
  `waitingroom_apartment_count` INTEGER DEFAULT 0 COMMENT '楼宇内的待接房房源数',
...
DROP TABLE IF EXISTS `eh_property_statistic_community`;
...
CREATE TABLE `eh_property_statistic_community` (
  ...
  `community_name` VARCHAR(64),
  `date_str` VARCHAR(10) COMMENT '统计月份（格式为xxxx-xx）',
  `building_count` INTEGER DEFAULT 0 COMMENT '园区下的楼宇总数',
  `total_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的房源总数',
  `free_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的待租房源数',
  `rent_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的已出租房源数',
  `occupied_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的已占用房源数',
  `living_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的自用房源数',
  `saled_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的已售房源数',
  `signedup_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的待签约房源数',
  `waitingroom_apartment_count` INTEGER DEFAULT 0 COMMENT '园区下的待接房房源数',
...
DROP TABLE IF EXISTS `eh_protocol_template_variables`;
...
DROP TABLE IF EXISTS `eh_protocol_templates`;
...
DROP TABLE IF EXISTS `eh_protocol_variables`;
...
DROP TABLE IF EXISTS `eh_protocols`;
...
CREATE TABLE `eh_punch_day_logs` (
  ...
  `absent_flag` TINYINT COMMENT '是否全天旷工，1：是 0：否',
  `normal_flag` TINYINT COMMENT '全天是否出勤正常，1：是 0：否',
  `go_out_punch_flag` TINYINT DEFAULT 0 COMMENT '是否外出打卡，1：是 0：否',
  `belate_count` INTEGER COMMENT '当天迟到次数',
  `leave_early_count` INTEGER COMMENT '早退次数',
  `forgot_punch_count_on_duty` INTEGER NOT NULL DEFAULT 0 COMMENT '上班缺卡次数',
  `forgot_punch_count_off_duty` INTEGER NOT NULL DEFAULT 0 COMMENT '下班缺卡次数',
...
DROP TABLE IF EXISTS `eh_punch_go_out_logs`;


CREATE TABLE `eh_punch_go_out_logs` (
  `id` BIGINT NOT NULL COMMENT 'id',
  `user_id` BIGINT COMMENT 'user''s id',
  `detail_id` BIGINT COMMENT 'eh_organization_member_details id',
  `organization_id` BIGINT COMMENT 'organization id',
  `namespace_id` INTEGER COMMENT 'NAMESPACE id',
  `longitude` DOUBLE,
  `latitude` DOUBLE,
  `location_info` VARCHAR(1024) COMMENT '打卡用到的地址定位',
  `wifi_info` VARCHAR(1024) COMMENT '打卡用到的WiFi信息(暂时无用)',
  `img_uri` VARCHAR(2048) COMMENT '打卡上传图片uri地址',
  `description` VARCHAR(1024) COMMENT '备注',
  `punch_date` DATE COMMENT 'user punch date',
...
CREATE TABLE `eh_punch_logs` (
  ...
  `device_change_flag` TINYINT DEFAULT 0 COMMENT '0- unchange 1-changed',
  `update_date` DATE,
  `create_type` TINYINT NOT NULL DEFAULT 0 COMMENT '创建类型 : 0-正常打卡创建 1-自动打卡创建 2-人脸识别打卡创建 4-其他第三方接口创建(通过第三方接口打卡没有带创建类型)',
  PRIMARY KEY (`id`),
  KEY `i_eh_user_id` (`user_id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_punch_statistics` (
  ...
  `outwork_count` DOUBLE COMMENT '公出天数',
  `rest_day_count` INTEGER COMMENT '应休息天数',
  `go_out_punch_day_count` INTEGER DEFAULT 0 COMMENT '当月外出打卡天数',
  `full_normal_flag` TINYINT COMMENT '当月是否全勤',
  `ask_for_leave_request_count` INTEGER COMMENT '当月请假申请次数',
  `go_out_request_count` INTEGER COMMENT '当月外出申请次数',
  `business_trip_request_count` INTEGER COMMENT '当月出差申请次数',
...
DROP TABLE IF EXISTS `eh_recommend_apps`;
...
CREATE TABLE `eh_rentalv2_default_rules` (
  ...
  `file_flag` TINYINT COMMENT '附件是否必传 0否 1是',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_rentalv2_orders` (
  ...
  `account_name` VARCHAR(255),
  `pay_channel` VARCHAR(128) COMMENT '支付类型 ',
  `vip_level` VARCHAR(255) COMMENT '会员等级 白金卡 金卡 银卡',
  `source` TINYINT COMMENT '0 用户发起 1后台录入',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_rentalv2_price_classification`;
...
CREATE TABLE `eh_rentalv2_price_classification` (
  ...
  `owner_id` BIGINT,
  `owner_type` VARCHAR(255),
  `user_price_type` TINYINT,
  `classification` VARCHAR(255),
  `workday_price` DECIMAL(10,2),
  `original_price` DECIMAL(10,2),
  `initiate_price` DECIMAL(10,2),
...
CREATE TABLE `eh_rentalv2_resource_types` (
  ...
  `cross_commu_flag` TINYINT COMMENT '是否支持跨项目',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_rentalv2_resources` (
  ...
  `address` VARCHAR(192) COMMENT '地址',
  `address_id` BIGINT,
  `people_spec` int(10) COMMENT '容纳人数',
  `spec` VARCHAR(255) COMMENT '规格',
  `own_company_name` VARCHAR(60),
  `contact_name` VARCHAR(40),
  `contact_phonenum` VARCHAR(20) COMMENT '咨询电话',
  ...
  `introduction` TEXT COMMENT '详情',
  `notice` TEXT,
  `charge_uid` VARCHAR(256) COMMENT '负责人id',
  `cover_uri` VARCHAR(1024) COMMENT '封面图uri',
  `auto_assign` TINYINT COMMENT '是否动态分配 1是 0否',
  `multi_unit` TINYINT COMMENT '是否允许预约多个场所 1是 0否',
  `resource_type_id` BIGINT COMMENT 'resource type id',
...
DROP TABLE IF EXISTS `eh_rentalv2_structure_template`;
...
DROP TABLE IF EXISTS `eh_rentalv2_structures`;
...
DROP TABLE IF EXISTS `eh_second_app_types`;
...
CREATE TABLE `eh_service_alliance_attachments` (
  ...
  `owner_type` VARCHAR(50) NOT NULL DEFAULT 'EhServiceAlliances',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_service_alliance_categories` (
  ...
  `entry_id` INTEGER,
  `skip_type` TINYINT NOT NULL DEFAULT 0 COMMENT '1-当该服务类型下只有一个服务时，点击服务类型直接进入服务。0-反之',
  `type` BIGINT NOT NULL DEFAULT 0 COMMENT '服务联盟类型',
  `enable_provider` TINYINT NOT NULL DEFAULT 0 COMMENT '0-关闭服务商功能 1-开启',
  `enable_comment` TINYINT NOT NULL DEFAULT 0 COMMENT '0-关闭评论功能 1-开启评论功能',
  `description` MEDIUMTEXT COMMENT '首页样式描述文字',
  PRIMARY KEY (`id`),
...
CREATE TABLE `eh_service_alliances` (
  ...
  `integral_tag1` BIGINT COMMENT '跳转类型 0-不跳转 2-表单/表单+工作流 3-跳转应用',
  `integral_tag2` BIGINT,
  `integral_tag3` BIGINT,
  `integral_tag4` BIGINT,
  `integral_tag5` BIGINT,
  ...
  `update_time` DATETIME COMMENT '更新时间',
  `update_uid` BIGINT COMMENT '更新用户id',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `i_eh_default_order` (`default_order`) USING BTREE,
  KEY `i_eh_type` (`type`) USING BTREE
...
DROP TABLE IF EXISTS `eh_service_module_app_authorizations`;
...
CREATE TABLE `eh_service_module_app_authorizations` (
  ...
  `namespace_id` INTEGER,
  `owner_id` BIGINT NOT NULL DEFAULT 0 COMMENT 'owner_id',
  `organization_id` BIGINT NOT NULL DEFAULT 0 COMMENT 'organization_id',
  `project_id` BIGINT NOT NULL DEFAULT 0 COMMENT 'community_id',
  ...
  KEY `owner_id_imdex` (`owner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `eh_service_module_app_entries`;
...
DROP TABLE IF EXISTS `eh_service_module_app_entry_profiles`;
...
DROP TABLE IF EXISTS `eh_service_module_app_profile`;
...
CREATE TABLE `eh_service_module_app_profile` (
  ...
  `description` VARCHAR(1024),
  `mobile_flag` TINYINT DEFAULT 0,
  `mobile_uris` VARCHAR(1024),
  `pc_flag` TINYINT DEFAULT 0,
  `pc_uris` VARCHAR(1024),
  `app_entry_infos` VARCHAR(2048),
  `independent_config_flag` TINYINT DEFAULT 0,
  `dependent_app_ids` VARCHAR(128),
  `support_third_flag` TINYINT DEFAULT 0,
  `develop_id` BIGINT COMMENT 'developer owner id',
  `icon_uri` VARCHAR(255),
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_service_module_apps` (
  ...
  `custom_path` VARCHAR(128) DEFAULT '',
  `access_control_type` TINYINT DEFAULT 1 COMMENT '0-all, 1-logon, 2-auth',
  `app_type` TINYINT COMMENT 'app type, 0-oaapp,1-communityapp,2-serviceapp',
  `system_app_flag` TINYINT COMMENT '0-no, 1-yes',
  `default_app_flag` TINYINT COMMENT 'installed when organiation was created, 0-no, 1-yes',
  `enable_enterprise_pay_flag` TINYINT COMMENT '企业支付标志，0-否，1-是',
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `eh_service_module_entries`;
...
CREATE TABLE `eh_service_module_entries` (
  ...
  `icon_uri` VARCHAR(255),
  PRIMARY KEY (`id`),
  KEY `module_entry_module_id` (`module_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_service_module_securities`;
...
CREATE TABLE `eh_service_modules` (
  ...
  `app_type` TINYINT COMMENT 'app type, 0-oaapp,1-communityapp,2-serviceapp',
  `client_handler_type` TINYINT DEFAULT 0 COMMENT '0-native, 1-outside url, 2-inside url, 3-offline package',
  `system_app_flag` TINYINT COMMENT '0-no, 1-yes',
  `icon_uri` VARCHAR(255),
  `host` VARCHAR(255),
  `enable_enterprise_pay_flag` TINYINT COMMENT '企业支付标志，0-否，1-是',
...
CREATE TABLE `eh_siyin_print_business_payee_accounts` (
  ...
  `payee_id` BIGINT COMMENT '支付帐号id',
  `payee_user_type` VARCHAR(128) NOT NULL COMMENT '帐号类型，1-个人帐号、2-企业帐号',
  `status` TINYINT NOT NULL DEFAULT 0 COMMENT '0: inactive, 2: active',
  `creator_uid` BIGINT,
  `create_time` DATETIME,
...
CREATE TABLE `eh_siyin_print_orders` (
  ...
  `general_order_id` VARCHAR(64) COMMENT '统一订单系统订单编号',
  `general_bill_id` VARCHAR(64) COMMENT '统一账单id',
  `is_invoiced` TINYINT DEFAULT 0 COMMENT '是否开具发票 0-未开发票 1-已发票',
  `printer_name` VARCHAR(128) COMMENT '打印机名称',
  `pay_mode` TINYINT COMMENT '支付方式',
  `user_notify_flag` TINYINT DEFAULT 0 COMMENT '0-未起定时器通知用户 1-已起定时器通知用户',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_siyin_print_printers` (
  ...
  `printer_name` VARCHAR(128) NOT NULL COMMENT 'printer name',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_siyin_print_records` (
  ...
  `operator_uid` BIGINT,
  `operate_time` DATETIME,
  `serial_number` VARCHAR(128) COMMENT 'reader_name',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `eh_smart_card_keys`;


CREATE TABLE `eh_smart_card_keys` (
  `id` BIGINT NOT NULL COMMENT 'id of the record',
  `namespace_id` INTEGER NOT NULL DEFAULT 0,
  `cardkey` VARCHAR(1024),
  `user_id` BIGINT NOT NULL DEFAULT 0,
  `name` VARCHAR(256),
...
DROP TABLE IF EXISTS `eh_tickets`;
...
DROP TABLE IF EXISTS `eh_user_app_flags`;


CREATE TABLE `eh_user_app_flags` (
  `id` BIGINT NOT NULL,
  `user_id` BIGINT NOT NULL,
  `location_type` TINYINT COMMENT '位置信息，参考枚举ServiceModuleLocationType',
  `location_target_id` BIGINT COMMENT '位置对应的对象Id，eg：广场是communityId，工作台企业办公是organizationId',
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `eh_user_apps`;
...
DROP TABLE IF EXISTS `eh_user_authentication_organizations`;
...
CREATE TABLE `eh_user_identifiers` (
  ...
  `update_version` BIGINT NOT NULL DEFAULT 0 COMMENT '版本号, 数据同步时候的版本号',
  PRIMARY KEY (`id`),
  ...
  KEY `i_eh_user_idf_token` (`identifier_token`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `eh_users` (
  ...
  `vip_level_text` VARCHAR(128) COMMENT '会员等级文本',
  `update_version` BIGINT NOT NULL DEFAULT 0 COMMENT '版本号, 数据同步时候的版本号',
  PRIMARY KEY (`id`),
  UNIQUE KEY `u_eh_uuid` (`uuid`),
...
DROP TABLE IF EXISTS `eh_var_field_scope_filters`;
...
DROP TABLE IF EXISTS `eh_vip_priority`;
...
CREATE TABLE `eh_vip_priority` (
  ...
  `priority` INTEGER COMMENT '优先级,数字越大，优先级越高',
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `eh_visitor_sys_hkws_user`;


CREATE TABLE `eh_visitor_sys_hkws_user` (
  `person_id` INTEGER NOT NULL COMMENT '人员ID',
  `person_no` VARCHAR(256) COMMENT '人员编号',
  `person_name` VARCHAR(256) COMMENT '姓名',
  `gender` TINYINT COMMENT '性别',
  `certificate_type` INTEGER COMMENT '证件类型',
  `certificate_no` VARCHAR(256) COMMENT '证件号码',
  `birthday` BIGINT COMMENT '出生日期',
  `person_pinyin` VARCHAR(256) COMMENT '姓名拼音',
  `phone_no` VARCHAR(256) COMMENT '联系电话',
  `address` VARCHAR(256) COMMENT '联系地址',
  `photo` VARCHAR(256) COMMENT '免冠照',
  `english_name` VARCHAR(256) COMMENT '英文名',
  `email` VARCHAR(256) COMMENT '邮箱',
  `entry_date` BIGINT COMMENT '入职日期',
  `leave_date` BIGINT COMMENT '离职日期',
  `education` VARCHAR(256) COMMENT '学历',
  `nation` VARCHAR(256) COMMENT '民族',
  `dept_uuid` VARCHAR(256) COMMENT '所属部门UUID',
  `dept_no` VARCHAR(256) COMMENT '所属部门编号',
  `dept_name` VARCHAR(256) COMMENT '所属部门名称',
  `dept_path` VARCHAR(256) COMMENT '所属部门路径',
  `status` TINYINT COMMENT '人员状态',
  `identity_uuid` VARCHAR(256) COMMENT '身份UUID',
  `identity_name` VARCHAR(256) COMMENT '身份名称',
...
CREATE TABLE `eh_visitor_sys_office_locations` (
  ...
  `operator_uid` BIGINT,
  `operate_time` DATETIME,
  `refer_type` VARCHAR(64) COMMENT '关联数据类型',
  `refer_id` BIGINT COMMENT '关联数据id',
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `eh_visitor_sys_third_mapping`;
...
CREATE TABLE `eh_visitor_sys_third_mapping` (
  ...
  `third_type` VARCHAR(128) COMMENT '关联类型',
  `third_value` VARCHAR(128) COMMENT '关联值',
  `creator_uid` BIGINT,
  `create_time` DATETIME,
  `operator_uid` BIGINT,
  `operate_time` DATETIME,
...
CREATE TABLE `eh_visitor_sys_visit_reason` (
  ...
  `operator_uid` BIGINT,
  `operate_time` DATETIME,
  `reason_type` TINYINT COMMENT '类型 0为住宅小区,1为商业小区',
  `visit_reason_code` TINYINT COMMENT '到访原因类型码',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_visitor_sys_visitors` (
  ...
  `community_type` TINYINT COMMENT '园区类型 0为住宅小区,1为商业小区',
  `community_id` BIGINT COMMENT '园区Id',
  PRIMARY KEY (`id`)
...
CREATE TABLE `eh_web_menus` (
  ...
  `scene_type` TINYINT NOT NULL DEFAULT 1 COMMENT '形态，1-管理端，2-客户端，参考枚举ServiceModuleSceneType',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `eh_welfare_coupons`;
...
CREATE TABLE `eh_welfare_coupons` (
  ...
  `service_supply_name` VARCHAR(4096) COMMENT '适用地点',
  `service_range` VARCHAR(4096) COMMENT '适用范围',
...
DROP TABLE IF EXISTS `eh_welfare_points`;
...
DROP TABLE IF EXISTS `eh_welfare_receivers`;
...
DROP TABLE IF EXISTS `eh_welfares`;
...
DROP TABLE IF EXISTS `eh_work_platform_apps`;
...
DROP TABLE IF EXISTS `eh_xfyun_match`;
...
CREATE TABLE `eh_xfyun_match` (
  ...
  `description` VARCHAR(128) COMMENT '中文描述',
  `module_id` BIGINT COMMENT '对应的模块id',
  `type` TINYINT NOT NULL DEFAULT 0 COMMENT '0-跳转到应用 1-自定义跳转',
  `default_router` VARCHAR(50) COMMENT 'type为1时，填写跳转路由',
  `client_handler_type` TINYINT COMMENT '0-原生 1-外部链接 2-内部链接 3-离线包',
  `access_control_type` TINYINT COMMENT '0-全部 1-登录可见 2-认证可见',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='讯飞语音跳转匹配表';
...
DROP TABLE IF EXISTS `eh_zhenzhihui_enterprise_info`;
...
DROP TABLE IF EXISTS `eh_zhenzhihui_user_info`;
