...
INSERT INTO `eh_locale_templates`(`scope`, `code`,`locale`, `description`, `text`, `namespace_id`) VALUES( 'sms.default', 7, 'zh_CN', '新发布一条任务短信消息', '28175', 0);
INSERT INTO `eh_locale_templates`(`scope`, `code`,`locale`, `description`, `text`, `namespace_id`) VALUES( 'sms.default', 7, 'zh_CN', '新发布一条任务短信消息', '28176', 1000000);
INSERT INTO `eh_locale_templates`(`scope`, `code`,`locale`, `description`, `text`, `namespace_id`) VALUES( 'sms.default', 7, 'zh_CN', '新发布一条任务短信消息', '28180', 999992);
