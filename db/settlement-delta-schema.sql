...
CREATE TABLE `eh_stat_transactions` (
  ...
  `fee_rate` DECIMAL(10,2) DEFAULT NULL COMMENT '交易费率',
  `fee_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总手续费',
...
CREATE TABLE `eh_stat_refunds` (
  ...
  `fee_rate` DECIMAL(10,2) DEFAULT NULL COMMENT '交易费率',
  `fee_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总手续费',
  `settlement_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总结算金额，交易总金额-交易总手续费',
...
CREATE TABLE `eh_stat_settlements` (
  ...
  `paid_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总金额',
  `fee_rate` DECIMAL(10,2) DEFAULT NULL COMMENT '交易费率',
  `fee_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总手续费',
  `settlement_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总结算金额，交易总金额-交易总手续费',
  `paid_count` bigint(20) DEFAULT 0 COMMENT '交易总笔数',
  `refund_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '退款总金额',
  `refund_fee_rate` DECIMAL(10,2) DEFAULT NULL COMMENT '退款费率',
  `refund_fee_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '退款总手续费',
  `refund_settlement_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '退款总结算金额，退款总金额-退款总手续费',
...
CREATE TABLE `eh_stat_service_settlement_results` (
  ...
  `resource_type` varchar(64) DEFAULT NULL COMMENT '交易来源类型 0电商 1停车充值 2资源预定 3物业缴费',
  `resource_id` bigint(20) DEFAULT 0 COMMENT '来源实体店ID',
  `alipay_paid_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '支付寶支付金額',
  `alipay_refund_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '支付寶退款金額',
  `wechat_paid_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '微信支付金額',
  `wechat_refund_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '微信退款金額',
  `payment_card_paid_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '一卡通交易金額',
  `payment_card_refund_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '一卡通退款金額',
  `total_paid_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总金额',
  `total_refund_amount` DECIMAL(10,2) DEFAULT NULL COMMENT '交易总金额',
  `update_date` datetime DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
