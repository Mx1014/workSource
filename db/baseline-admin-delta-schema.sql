...
ALTER TABLE `eh_acl_roles` ADD COLUMN `creator_uid` BIGINT COMMENT 'creator uid';
ALTER TABLE `eh_acl_roles` ADD COLUMN `create_time` DATETIME COMMENT 'record create time';
