...
#
ALTER TABLE `eh_organization_members` ADD COLUMN `employee_no` BIGINT NOT NULL DEFAULT 0 COMMENT '';
ALTER TABLE `eh_organization_members` ADD COLUMN `gender` TINYINT NOT NULL DEFAULT '0' COMMENT '0: undisclosured, 1: male, 2: female';
