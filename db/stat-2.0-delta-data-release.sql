...
-- 底部导航栏配置
--
INSERT INTO `eh_portal_navigation_bars` (`id`, `namespace_id`, `label`, `target_type`, `target_id`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`) VALUES (1, 1000000, '科技园', 'EhPortalLayouts', 0, NULL, NULL, 4, NULL, NULL, 0, 0, NULL);
INSERT INTO `eh_portal_navigation_bars` (`id`, `namespace_id`, `label`, `target_type`, `target_id`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`) VALUES (2, 1000000, '小站', 'EhPortalLayouts', 0, NULL, NULL, 4, NULL, NULL, 0, 0, NULL);
INSERT INTO `eh_portal_navigation_bars` (`id`, `namespace_id`, `label`, `target_type`, `target_id`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`) VALUES (3, 1000000, '论坛', 'EhPortalLayouts', 0, NULL, NULL, 4, NULL, NULL, 0, 0, NULL);
INSERT INTO `eh_portal_navigation_bars` (`id`, `namespace_id`, `label`, `target_type`, `target_id`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`) VALUES (4, 1000000, '我', 'EhPortalLayouts', 0, NULL, NULL, 4, NULL, NULL, 0, 0, NULL);
