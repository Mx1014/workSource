...
ALTER TABLE `eh_payment_contract_receiver` ADD COLUMN `inWork` TINYINT DEFAULT 0 COMMENT '0:工作完成；1：正在生成';
ALTER TABLE `eh_payment_contract_receiver` ADD COLUMN `recorder` TINYINT DEFAULT 1 COMMENT '0：合同状态记录者，不保存计价数据；1：不是合同状态记录者';
