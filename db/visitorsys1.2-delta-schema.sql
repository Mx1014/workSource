CREATE TABLE `eh_visitor_sys_door_access` (
  ...
  `default_auth_rule_type` tinyint(4) DEFAULT NULL COMMENT '授权规则种类，0 时长，1 次数',
  `default_max_duration` int DEFAULT 0 COMMENT '访客授权最长有效期',
  `default_max_count` int DEFAULT 0 COMMENT '访客授权最大次数',
