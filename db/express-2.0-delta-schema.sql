...
CREATE TABLE `eh_express_company_businesses` (
  ...
  `express_company_id` BIGINT COMMENT 'id of the express company id',
...
ALTER TABLE `eh_express_orders`	ADD COLUMN `package_type` VARCHAR(64) COMMENT '封装类型，参考 ExpressPackageType.class' AFTER `internal`;
