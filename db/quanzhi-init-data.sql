...
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`) VALUES ((@layout_id := @layout_id + 1),999980,'leaseLayout','{\"displayName\": \"\招商租赁\", \"groups\": [{\"defaultOrder\": 1, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"lease\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Navigator\"}], \"layoutName\": \"leaseLayout\", \"versionCode\": \"2017022340\", \"versionName\": \"3.3.0\"}',2017022340,0,2,UTC_TIMESTAMP(),'pm_admin',0,0,0);
...
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`) VALUES ((@layout_id := @layout_id + 1),999980,'leaseLayout','{\"displayName\": \"\招商租赁\", \"groups\": [{\"defaultOrder\": 1, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"lease\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Navigator\"}], \"layoutName\": \"leaseLayout\", \"versionCode\": \"2017022340\", \"versionName\": \"3.3.0\"}',2017022340,0,2,UTC_TIMESTAMP(),'park_tourist',0,0,0);
