...
INSERT INTO `eh_configurations` (`id`, `name`, `value`, `description`, `namespace_id`, `display_name`) 
	VALUES ((@eh_configurations := @eh_configurations + 1), 'app.agreements.url', 'http://core.zuolin.com/mobile/static/app_agreements/qz100_agreements.html', 'the relative path for kexin app agreements', '999980', NULL);
