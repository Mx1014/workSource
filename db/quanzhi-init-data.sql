...
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`) VALUES ((@layout_id := @layout_id + 1) ,999980,'ServiceMarketLayout','{\"displayName\": \"\服务市场\", \"groups\": [{\"defaultOrder\": 1, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"Default\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Banners\"}, {\"columnCount\": 4, \"defaultOrder\": 2, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"Gallery\"}, \"separatorFlag\": 1, \"separatorHeight\": 21, \"style\": \"Default\", \"widget\": \"Coupons\"}, {\"defaultOrder\": 3, \"groupName\": \"商家服务\", \"instanceConfig\": {\"itemGroup\": \"Bizs\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Navigator\"}, {\"defaultOrder\": 4, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"滚动广告\"}, \"separatorFlag\": 1, \"separatorHeight\": 21, \"style\": \"Default\", \"widget\": \"Bulletins\"}, {\"columnCount\": 4, \"defaultOrder\": 5, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"Coupons\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Coupons\"}], \"layoutName\": \"ServiceMarketLayout\", \"versionCode\": \"2017022340\", \"versionName\": \"4.3.0\"}',2017022340,0,2,UTC_TIMESTAMP(),'pm_admin',0,0,0);
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`) VALUES ((@layout_id := @layout_id + 1),999980,'leaseLayout','{"displayName": "招商租赁", "groups": [{"defaultOrder": 1, "groupName": "", "instanceConfig": {"itemGroup": "lease"}, "separatorFlag": 0, "separatorHeight": 0, "style": "Default", "widget": "Navigator"}], "layoutName": "leaseLayout", "versionCode": "2017022340", "versionName": "4.3.0"}',2017022340,0,2,UTC_TIMESTAMP(),'pm_admin',0,0,0);

INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`) VALUES ((@layout_id := @layout_id + 1) ,999980,'ServiceMarketLayout','{\"displayName\": \"\服务市场\", \"groups\": [{\"defaultOrder\": 1, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"Default\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Banners\"}, {\"columnCount\": 4, \"defaultOrder\": 2, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"Gallery\"}, \"separatorFlag\": 1, \"separatorHeight\": 21, \"style\": \"Default\", \"widget\": \"Coupons\"}, {\"defaultOrder\": 3, \"groupName\": \"商家服务\", \"instanceConfig\": {\"itemGroup\": \"Bizs\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Navigator\"}, {\"defaultOrder\": 4, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"滚动广告\"}, \"separatorFlag\": 1, \"separatorHeight\": 21, \"style\": \"Default\", \"widget\": \"Bulletins\"}, {\"columnCount\": 4, \"defaultOrder\": 5, \"groupName\": \"\", \"instanceConfig\": {\"itemGroup\": \"Coupons\"}, \"separatorFlag\": 0, \"separatorHeight\": 0, \"style\": \"Default\", \"widget\": \"Coupons\"}], \"layoutName\": \"ServiceMarketLayout\", \"versionCode\": \"2017022340\", \"versionName\": \"4.3.0\"}',2017022340,0,2,UTC_TIMESTAMP(),'park_tourist',0,0,0);
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`) VALUES ((@layout_id := @layout_id + 1),999980,'leaseLayout','{"displayName": "招商租赁", "groups": [{"defaultOrder": 1, "groupName": "", "instanceConfig": {"itemGroup": "lease"}, "separatorFlag": 0, "separatorHeight": 0, "style": "Default", "widget": "Navigator"}], "layoutName": "leaseLayout", "versionCode": "2017022340", "versionName": "4.3.0"}',2017022340,0,2,UTC_TIMESTAMP(),'park_tourist',0,0,0);
...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`) VALUES ((@item_id := @item_id + 1),999980,0,0,0,'/home','Coupons','','左邻小站','cs://1/image/aW1hZ2UvTVRvMk9EUmxZamxqTVdVMll6Y3pabUpqWldObFptWmpNalZpT1dNelpEVmhOUQ',4,1,14,CONCAT('{\"url\": \"', @eh_biz_serverURL, '/zl-ec/rest/service/front/logon?hideNavigationBar=1&sourceUrl=', @eh_core_serverURL,'%2Fnar%2Fbiz%2Fweb%2Fapp%2Fuser%2Findex.html%23%2Fstore%2Fdefault%3F_k%3Dzlbiz#sign_suffix\"}') ,0,0,1,1,'1',0,NULL,NULL,NULL,0,'pm_admin',0,NULL);
