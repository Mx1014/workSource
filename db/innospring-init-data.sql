...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`)
    VALUES (112308, 999986, 0, 0, 0, '/home/serviceAlliance', 'serviceAllianceBiz', '服务联盟grid', '创源服务', 'cs://1/image/aW1hZ2UvTVRwa05HVTBNMlF5T1dZd1pURXpOV1ExTVdNellURTJPR0kyWXpnMU9XSmlOQQ', 1, 1, 33, '{"type":60,"parentId":60,"displayType": "grid"}', 0, 0, 1, 1,'','0',NULL,NULL,NULL, '1', 'pm_admin', '0');    
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`) 
...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`)
    VALUES (112310, 999986, 0, 0, 0, '/home', 'Bizs', '服务联盟list', '增值服务', 'cs://1/image/aW1hZ2UvTVRvNU9XTmhOMkl6T1RNNU1ESTJNbVJqTURjM05qTTBaRFUxT1dFM1pXWXlNQQ', 1, 1, 33, '{"type":61,"parentId":61,"displayType": "list"}', 0, 0, 1, 1,'','0',NULL,NULL,NULL, '1', 'pm_admin', '0');    
...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`)
    VALUES (112327, 999986, 0, 0, 0, '/home/serviceAlliance', 'serviceAllianceBiz', '服务联盟grid', '创源服务', 'cs://1/image/aW1hZ2UvTVRwa05HVTBNMlF5T1dZd1pURXpOV1ExTVdNellURTJPR0kyWXpnMU9XSmlOQQ', 1, 1, 33, '{"type":60,"parentId":60,"displayType": "grid"}', 0, 0, 1, 1,'','0',NULL,NULL,NULL, '1', 'park_tourist', '0');    
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`)
    VALUES (112328, 999986, 0, 0, 0, '/home', 'Bizs', '服务联盟list', '增值服务', 'cs://1/image/aW1hZ2UvTVRvNU9XTmhOMkl6T1RNNU1ESTJNbVJqTURjM05qTTBaRFUxT1dFM1pXWXlNQQ', 1, 1, 33, '{"type":61,"parentId":61,"displayType": "list"}', 0, 0, 1, 1,'','0',NULL,NULL,NULL, '1', 'park_tourist', '0');    
