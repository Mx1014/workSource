...
ALTER TABLE `eh_rentalv2_default_rules`  ADD COLUMN `rental_start_time_flag` tinyint(4) DEFAULT NULL COMMENT '至少提前预约时间标志: 1-限制, 0-不限制';
ALTER TABLE `eh_rentalv2_default_rules`  ADD COLUMN `rental_end_time_flag` tinyint(4) DEFAULT NULL COMMENT '最多提前预约时间标志: 1-限制, 0-不限制';
