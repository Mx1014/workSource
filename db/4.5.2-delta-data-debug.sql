...
insert into `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`) values((@launch_pad_item_id := @launch_pad_item_id + 1),'999990','0','0','0','/home','GovAgencies','企业采供','企业采供','cs://1/image/aW1hZ2UvTVRwalkySTNaVGhoWTJVeVpUZzFOREJtWm1ZMk5XSm1ORFJrTURnd05ESTNPUQ','2','1','14','','11','0','1','1','','0',NULL,NULL,NULL,'1','pm_admin','1',NULL,NULL,'0');
insert into `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`) values((@launch_pad_item_id := @launch_pad_item_id + 1),'999990','0','0','0','/home','GovAgencies','企业送水','企业送水','cs://1/image/aW1hZ2UvTVRvMFpqUTVZMkppWlRKaE9EZzFOamcwT0dSa1pHVmxPR0UyTURreE1HSmxZUQ','1','1','14','','12','0','1','1','','0',NULL,NULL,NULL,'1','pm_admin','1',NULL,NULL,'0');
insert into `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`) values((@launch_pad_item_id := @launch_pad_item_id + 1),'999990','0','0','0','/home','GovAgencies','企业人才','企业人才','cs://1/image/aW1hZ2UvTVRvMVpqaGtNamszT1RVM05UVXhaVEF5T0dNNU9EQXpOV1JrWkRJM05ERXhOUQ','1','1','14','','13','0','1','1','','0',NULL,NULL,NULL,'1','pm_admin','1',NULL,NULL,'0');
insert into `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`) values((@launch_pad_item_id := @launch_pad_item_id + 1),'999990','0','0','0','/home','GovAgencies','企业代理','企业代理','cs://1/image/aW1hZ2UvTVRvNU5HUXdNV0l3TW1OaVlUbGhOVGt4TURObE1qSTJPR0V6WkdOak9EZzBZdw','2','1','14','','14','0','1','1','','0',NULL,NULL,NULL,'1','pm_admin','1',NULL,NULL,'0');
insert into `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`) values((@launch_pad_item_id := @launch_pad_item_id + 1),'999990','0','0','0','/home','GovAgencies','企业IT服务','企业IT服务','cs://1/image/aW1hZ2UvTVRveU0yUmpaamcwTldaaU1HUTBPR1k1T0dFME4yVXlaR1V6WVRRNVptWmpaZw','1','1','14','','15','0','1','1','','0',NULL,NULL,NULL,'1','pm_admin','1',NULL,NULL,'0');
insert into `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`) values((@launch_pad_item_id := @launch_pad_item_id + 1),'999990','0','0','0','/home','GovAgencies','项目定制','项目定制','cs://1/image/aW1hZ2UvTVRvMVpEQmxaV1JtTkRjMFltVTJNVEU0WTJObE1qTTFZamMzWVdNME1EQXpZUQ','1','1','14','','16','0','1','1','','0',NULL,NULL,NULL,'1','pm_admin','1',NULL,NULL,'0');
