...
ALTER TABLE `eh_conf_orders` ADD COLUMN `extend_flag` TINYINT NOT NULL DEFAULT 0 COMMENT 'buy new accounts or extend accounts 0: new accounts, 1: extend account';
