...
-- 更新左邻标准版的layout 和 index
DELETE  from eh_launch_pad_layouts WHERE namespace_id = 2;

DELETE  from eh_launch_pad_indexs WHERE namespace_id = 2;

SET @layoutId = (SELECT IFNULL(MAX(id),0) + INTERVAL(500000000, IFNULL(MAX(id),0)) * 500000000 from eh_launch_pad_layouts);
SET @layoutIdW = @layoutId + 1;
SET @layoutIdC = @layoutId + 2;


-- 注：layout里面oppush的appId需要手动配置进去
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`, `bg_image_uri`, `preview_portal_version_id`, `type`, `bg_color`) VALUES (@layoutIdW, '2', 'ServiceMarketLayout', '{"versionCode":"201806200100","layoutName":"ServiceMarketLayout","displayName":"工作台","groups":[{"groupName":"公告","widget":"Bulletins","instanceConfig":{"itemGroup":"EhPortalItemGroups31057","rowCount":1},"defaultOrder":1,"separatorFlag":1,"separatorHeight":24},{"groupName":"应用管理","title":"应用管理","widget":"Card","instanceConfig":{"itemGroup":"EhPortalItemGroups31058","paddingTop":16,"paddingLeft":16,"paddingBottom":16,"paddingRight":16,"lineSpacing":20,"columnSpacing":20,"backgroundColor":"#ffffff","appType":1},"style":"Default","defaultOrder":2,"separatorFlag":1,"separatorHeight":32,"columnCount":1},{"groupName":"OA应用","title":"OA应用","widget":"Card","instanceConfig":{"itemGroup":"EhPortalItemGroups31058","paddingTop":16,"paddingLeft":16,"paddingBottom":16,"paddingRight":16,"lineSpacing":20,"columnSpacing":20,"backgroundColor":"#ffffff","appType":0},"style":"Default","defaultOrder":4 ,"separatorFlag":1,"separatorHeight":32,"columnCount":1}]}', '201806200100', '0', '2', NULL, 'default', '0', '0', '0', NULL, NULL, '4', NULL);
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`, `bg_image_uri`, `preview_portal_version_id`, `type`, `bg_color`) VALUES (@layoutIdC, '2', 'ServiceMarketLayout', '{"versionCode":"201806200100","layoutName":"ServiceMarketLayout","displayName":"服务广场","groups":[{"groupName":"banner图片1","widget":"Banners","instanceConfig":{"itemGroup":"EhPortalItemGroups31056","widthRatio":16,"heightRatio":9,"shadowFlag":1,"paddingFlag":1},"defaultOrder":1,"separatorFlag":0,"separatorHeight":0},{"groupName":"应用","widget":"Navigator","instanceConfig":{"itemGroup":"EhPortalItemGroups31058","paddingTop":0,"paddingLeft":16,"paddingBottom":0,"paddingRight":16,"lineSpacing":0,"columnSpacing":0,"cssStyleFlag":1,"backgroundColor":"#ffffff"},"style":"Default","defaultOrder":2,"separatorFlag":1,"separatorHeight":24,"columnCount":4},{"groupName":"公告","widget":"Bulletins","instanceConfig":{"itemGroup":"EhPortalItemGroups31057","rowCount":1,"style":2},"defaultOrder":3,"separatorFlag":1,"separatorHeight":24},{"groupName":"商品精选","widget":"OPPush","title":"商品精选","instanceConfig":{"itemGroup":"OPPushBiz","moduleId":92100,"appId":10000,"newsSize":5,"appConfig":{}},"style":"HorizontalScrollSquareView","defaultOrder":4,"separatorFlag":1,"separatorHeight":24},{"groupName":"最新活动","widget":"OPPush","title":"最新活动","instanceConfig":{"itemGroup":"OPPushActivity","entityCount":5,"subjectHeight":0,"descriptionHeight":0,"newsSize":5,"moduleId":10600,"appId":500000104,"actionType":62,"appConfig":{"categoryId":1,"publishPrivilege":1,"livePrivilege":0,"listStyle":2,"scope":3,"style":4}},"style":"HorizontalScrollWideView","defaultOrder":5,"separatorFlag":1,"separatorHeight":24},{"groupName":"最新帖子","widget":"OPPush","title":"最新帖子","instanceConfig":{"moduleId":10100,"appId":500000105,"newsSize":5, "appConfig":{}},"style":"TextImageWithTagListView","defaultOrder":7,"separatorFlag":1,"separatorHeight":24}]}', '201806200100', '0', '2', NULL, 'pm_admin', '0', '0', '0', NULL, NULL, '5', NULL);

-- 添加标准版主页签
SET @indexId = (SELECT IFNULL(MAX(id),0) + INTERVAL(500000000, IFNULL(MAX(id),0)) * 500000000 from eh_launch_pad_indexs);
INSERT INTO `eh_launch_pad_indexs` (`id`, `namespace_id`, `type`, `name`, `config_json`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`, `default_order`) VALUES ((@indexId := @indexId + 1), '2', '1', '工作台', CONCAT('{\"layoutId\":',@layoutIdW,', \"layoutType\":4}'), 'cs://1/image/aW1hZ2UvTVRvMll6Y3hNemMwWXpWaVl6WTVOVFpoTlRneFlUUTVaalU0WlRSaFpUQXlOUQ', 'cs://1/image/aW1hZ2UvTVRveU9USmpNamRtTWprNU1qRmpObUl5T1RNd05USXhNRE5tTnpGa05tSmhNZw', '2', '2018-04-20 10:12:37', '2018-04-20 10:12:40', '1', '1', '1', '0');
INSERT INTO `eh_launch_pad_indexs` (`id`, `namespace_id`, `type`, `name`, `config_json`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`, `default_order`) VALUES ((@indexId := @indexId + 1), '2', '1', '广场', CONCAT('{\"layoutId\":',@layoutIdC,', \"layoutType\":5}'), 'cs://1/image/aW1hZ2UvTVRwbE1HUm1Nekk0WTJFM1lUYzVZV1psWW1NMU5HUmpZV0V3TldOaU56UmxNZw', 'cs://1/image/aW1hZ2UvTVRwaFpqWmhOek0wWmpBM05URTNaRFprWTJVM01ERTJOMkUwTldNd00ySm1ZUQ', '2', '2018-04-20 10:12:37', '2018-04-20 10:12:40', '1', '1', '1', '2');
INSERT INTO `eh_launch_pad_indexs` (`id`, `namespace_id`, `type`, `name`, `config_json`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`, `default_order`) VALUES ((@indexId := @indexId + 1), '2', '3', '消息', '{}', 'cs://1/image/aW1hZ2UvTVRvNFltTmhNREU0TXpFd01UZGtZV1k0TTJGbVlXWTNPR1k0T1RZd1ltRTFNZw', 'cs://1/image/aW1hZ2UvTVRwbU5tSTNNV1EzTWpOa016WmtaRE15TTJOaVpHSTFZbUprWVRSak1qaGhaZw', '2', '2018-04-20 10:12:37', '2018-04-20 10:12:40', '1', '1', '1', '3');
INSERT INTO `eh_launch_pad_indexs` (`id`, `namespace_id`, `type`, `name`, `config_json`, `icon_uri`, `selected_icon_uri`, `status`, `create_time`, `update_time`, `operator_uid`, `creator_uid`, `description`, `default_order`) VALUES ((@indexId := @indexId + 1), '2', '4', '我的', '{}', 'cs://1/image/aW1hZ2UvTVRvMU1HUmxZMkUxWXpnMU5HRTBZelkzT1dNM01EUXlOekpsWkRVeFpEY3pZZw', 'cs://1/image/aW1hZ2UvTVRvd016Wm1NekZoTnpSbU16WTFZV1E1WTJVeFkyUTJNamxtTURabVkyTmpPQQ', '2', '2018-04-20 10:12:37', '2018-04-20 10:12:40', '1', '1', '1', '4');
...
-- janson 物品搬迁
UPDATE `eh_service_modules` SET `instance_config`='{"url":"${home.url}/goods-move/build/index.html?ns=2&hideNavigationBar=1&ehnavigatorstyle=0#/home#sign_suffix"}' WHERE `module_id`='49200';
