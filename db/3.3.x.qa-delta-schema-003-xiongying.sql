...
CREATE TABLE `eh_quality_inspection_tasks` (
	...
	`result` TINYINT NOT NULL DEFAULT 0 COMMENT '0: none, 1: inspect ok, 2: inspect close, 3: rectified ok, 4: rectify closed, 5: delay',
...
CREATE TABLE `eh_quality_inspection_task_records` (
	...
	`process_result` TINYINT NOT NULL DEFAULT 0 COMMENT '0: none, 1: inspect ok, 2: inspect close, 3: rectified ok, 4: rectify closed, 5: delay, 11: rectified ok(waiting approval), 12: rectify closed(waiting approval)', 
