...
CREATE TABLE `eh_repeat_settings`(
    ...
    `time_ranges` VARCHAR(2048) COMMENT 'multiple time ranges in a day, json format, {"ranges":[{"startTime":"08:00:00","endTime":"09:30:00"},{"startTime":"18:30:00","endTime":"19:30:00"}]}',
...
CREATE TABLE `eh_quality_inspection_tasks` (
	...
	`task_type` TINYINT NOT NULL DEFAULT 0 COMMENT '0: none, 1: verify task, 1: rectify task',
	...
	`executive_status` TINYINT NOT NULL DEFAULT 0 COMMENT '0: none, 1: waiting for executing, 2: executed, 3: delayed',
	`executive_result` TINYINT NOT NULL DEFAULT 0 COMMENT '0: none, 1: forward, 2: done 3: closed',
