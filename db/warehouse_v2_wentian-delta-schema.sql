CREATE TABLE `eh_supplier`(
  ...
  `bank_of_deposit` VARCHAR(128) DEFAULT NULL COMMENT '开户行',
  `account_number` VARCHAR(64) DEFAULT NULL COMMENT '银行账号',
...
-- 采购物品
CREATE TABLE `eh_purchase_request_materials`(
  `id` BIGINT NOT NULL,
...
-- 出入库单 模型
CREATE TABLE `eh_warehouse_or_delivery_sheet`(
  `id` BIGINT NOT NULL,
