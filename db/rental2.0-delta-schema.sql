...
CREATE TABLE `eh_rental_default_rules` (
  ...
  `site_type` BIGINT COMMENT 'rule for what function',
  ...
  `launch_pad_item_id` BIGINT COMMENT '广场图标id',
...
CREATE TABLE `eh_rental_site_owners` (
  ...
  `owner_type` VARCHAR(255) COMMENT 'owner type : community ; organization',
  `owner_id` BIGINT COMMENT 'community id or organization id',
  `rental_site_id` BIGINT COMMENT 'rental_site id',
...
CREATE TABLE `eh_rental_bills` (
  ...
  `site_total_money` DECIMAL(10,2) COMMENT '',
  `reserve_money` DECIMAL(10,2) COMMENT '',
  `reserve_time` DATETIME COMMENT 'reserve time',
  `pay_start_time` DATETIME COMMENT '',
  `pay_end_time` DATETIME COMMENT '',
  `pay_time` DATETIME COMMENT '',
  `cancel_time` DATETIME COMMENT '',
  `paid_money` DECIMAL(10,2) COMMENT '',
  ...
  `operator_uid` BIGINT COMMENT '',
  `operate_time` DATETIME COMMENT '',
  `site_name` VARCHAR(255) COMMENT '名称',
  `use_time` VARCHAR(255) COMMENT '使用时间',
...
CREATE TABLE `eh_rental_sites_bills` (
  `id` BIGINT NOT NULL COMMENT 'id',
  `rental_bill_id` BIGINT COMMENT '',
  `rental_site_rule_id` BIGINT COMMENT '',
  `rental_count` DOUBLE COMMENT '',
  `total_money` DECIMAL(10,2) COMMENT '',
  `creator_uid` BIGINT COMMENT '',
  `create_time` DATETIME COMMENT '',
  `operator_uid` BIGINT COMMENT '',
  `operate_time` DATETIME COMMENT '',
...
CREATE TABLE `eh_rental_sites_bill_numbers` (
  `id` BIGINT NOT NULL COMMENT 'id',
  `rental_site_bill_id` BIGINT COMMENT 'fk',
  `rental_site_rule_id` BIGINT COMMENT '场所单元格id',
  `site_number` INT COMMENT '场所编号',
  `rental_count` DOUBLE COMMENT '0.5为半个1为全个',
...
CREATE TABLE `eh_rental_items_bills` (
  `id` BIGINT NOT NULL COMMENT 'id',
  `rental_bill_id` BIGINT COMMENT '',
  `rental_site_item_id` BIGINT COMMENT '',
  `rental_count` INTEGER COMMENT '',
  `total_money` DECIMAL(10,2) COMMENT '',
  `creator_uid` BIGINT COMMENT '',
  `create_time` DATETIME COMMENT '',
  `operator_uid` BIGINT COMMENT '',
...
CREATE TABLE `eh_rental_bill_paybill_maps` (
  `id` BIGINT NOT NULL COMMENT 'id',
  `rental_bill_id` BIGINT COMMENT '',
  `online_pay_bill_id` BIGINT COMMENT '',
  `creator_uid` BIGINT COMMENT '',
  `create_time` DATETIME COMMENT '',
  `operator_uid` BIGINT COMMENT '',
  `operate_time` DATETIME COMMENT '',
