...
-- DROP TABLE IF EXISTS `eh_print_settings`;
CREATE TABLE `eh_print_settings` (
...
-- DROP TABLE IF EXISTS `eh_print_printers`;
CREATE TABLE `eh_print_printers` (
  `id` BIGINT NOT NULL COMMENT 'id of the record',
  `namespace_id` INTEGER NOT NULL DEFAULT 0 COMMENT 'namespace id',
  `owner_type` VARCHAR(64) NOT NULL COMMENT 'community',
  `owner_id` BIGINT NOT NULL DEFAULT 0,
...
-- DROP TABLE IF EXISTS `eh_print_orders`;
CREATE TABLE `eh_print_orders` (
  `id` BIGINT NOT NULL COMMENT 'id of the record',
  `namespace_id` INTEGER NOT NULL DEFAULT 0 COMMENT 'namespace id',
  `owner_type` VARCHAR(64) NOT NULL COMMENT 'community',
  `owner_id` BIGINT NOT NULL DEFAULT 0,
  `job_type` VARCHAR(128) COMMENT '',
...
-- DROP TABLE IF EXISTS `eh_print_records`;
CREATE TABLE `eh_print_records` (
  `id` BIGINT NOT NULL COMMENT 'id of the record',
  `namespace_id` INTEGER NOT NULL DEFAULT 0 COMMENT 'namespace id',
  `owner_type` VARCHAR(64) NOT NULL COMMENT 'community',
  `owner_id` BIGINT NOT NULL DEFAULT 0,
  ...
  `job_in_time` VARCHAR(128) COMMENT 'siyin returned, job start time',
  `job_out_time` VARCHAR(128) COMMENT 'siyin returned, job end time',
  `document_name` VARCHAR(128) COMMENT 'siyin returned, print document name',
  `printer_name` VARCHAR(128) COMMENT 'siyin returned, printer name',
  ...
  `status` VARCHAR(128) COMMENT '0:INACTIVE,2:ACTIVE',
  `creator_uid` BIGINT COMMENT 'creator/initiator id',
  `create_time` DATETIME,
  `operator_uid` BIGINT,
  `operate_time` DATETIME,
...
-- DROP TABLE IF EXISTS `eh_print_emails`;
CREATE TABLE `eh_print_emails` (
  `id` BIGINT NOT NULL COMMENT 'id of the record',
  `namespace_id` INTEGER NOT NULL DEFAULT 0 COMMENT 'namespace id',
  `owner_type` VARCHAR(64) NOT NULL COMMENT 'community',
  `owner_id` BIGINT NOT NULL DEFAULT 0,
