CREATE TABLE `eh_community_map_shops` (
  ...
  `shop_name` varchar(128) NOT NULL DEFAULT NULL,
  `shop_type` varchar(128) NOT NULL DEFAULT NULL,
  `business_hours` varchar(512) NOT NULL DEFAULT NULL,
  `contact_name` varchar(128) NOT NULL DEFAULT NULL,
  `contact_phone` varchar(128) NOT NULL DEFAULT NULL,
  `building_id` bigint(20) NOT NULL DEFAULT NULL,
  `address_id` bigint(20) NOT NULL DEFAULT NULL,
  `description` text,
  `shop_Avatar` varchar(1024) NOT NULL DEFAULT NULL,
