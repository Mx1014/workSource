...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`)
    VALUES ((@pad_items_id := @pad_items_id + 1), 999964, '0', '0', '0', '/home', 'Bizs', 'INCUBATOR', '入园申请', 'cs://1/image/aW1hZ2UvTVRvMk1EVmhNbVZoWW1Oa05URXpOamczWTJKbE9URTFObVUxT0dRMFpURmlPUQ', '1', '1', '68', '', 10, '0', '1', '1', '', '0', NULL, NULL, NULL, '0', 'pm_admin');
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`)
    VALUES ((@pad_items_id := @pad_items_id + 1), 999964, '0', '0', '0', '/home', 'Bizs', 'INCUBATOR', '入园申请', 'cs://1/image/aW1hZ2UvTVRvMk1EVmhNbVZoWW1Oa05URXpOamczWTJKbE9URTFObVUxT0dRMFpURmlPUQ', '1', '1', '68', '', 10, '0', '1', '1', '', '0', NULL, NULL, NULL, '0', 'park_tourist');
