...
CREATE TABLE `eh_point_rules` (
  ...
  `status` TINYINT NOT NULL DEFAULT 1 COMMENT '0: inactive, 1: enabled, 2: disabled',
...
CREATE TABLE `eh_point_goods` (
  ...
  `status` TINYINT NOT NULL DEFAULT 2 COMMENT '0: inactive, 1: enabled, 2: disabled',
  `top_status` TINYINT NOT NULL DEFAULT 2 COMMENT '0: inactive, 1: enabled, 2: disabled',
  `top_time` DATETIME(3),
  `create_time` DATETIME(3),
  `creator_uid` BIGINT,
  `update_time` DATETIME(3),
