...
INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`) VALUES(@id := @id + 1,'sms.default.yzx','12','zh_CN','付费预约成功 独占资源','32770','999991');
INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`) VALUES(@id := @id + 1,'sms.default.yzx','13','zh_CN','付费预约成功 非独占资源，不需要选择资源编号','32771','999991');
INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`) VALUES(@id := @id + 1,'sms.default.yzx','14','zh_CN','付费预约成功 非独占资源，需要选择资源编号','32772','999991');
...
-- merge from energy-delta-data-release.sql
--
-- 基础的三种参数
--
...
INSERT INTO `eh_locale_strings` (`id`, `scope`, `code`, `locale`, `text`)
VALUES ((@eh_locale_strings_id := @eh_locale_strings_id + 1), 'energy', '10007', 'zh_CN', '读数超过最大量程');
INSERT INTO `eh_locale_strings` (`id`, `scope`, `code`, `locale`, `text`)
