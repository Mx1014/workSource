...
ALTER TABLE eh_flow_condition_expressions ADD COLUMN `variable_extra1` VARCHAR(256);
ALTER TABLE eh_flow_condition_expressions ADD COLUMN `variable_extra2` VARCHAR(256);