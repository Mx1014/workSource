...
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`) 
    VALUES ('13', '999999', 'lifeLayout', '{\"versionCode\":\"2016082302\",\"versionName\":\"3.0.0\",\"displayName\":\"便捷生活\",\"layoutName\":\"lifeLayout\",\"groups\":[{\"groupName\":\"\",\"widget\":\"Navigator\",\"instanceConfig\":{\"itemGroup\":\"Lifes\"},\"style\":\"Default\",\"defaultOrder\":2,\"separatorFlag\":1,\"separatorHeight\":21,\"columnCount\":4}]}', '2016082302', '2015111401', '2', '2016-08-23 19:46:47', 'park_tourist');
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`) 
    VALUES ('14', '999999', 'lifeLayout', '{\"versionCode\":\"2016082302\",\"versionName\":\"3.0.0\",\"displayName\":\"便捷生活\",\"layoutName\":\"lifeLayout\",\"groups\":[{\"groupName\":\"\",\"widget\":\"Navigator\",\"instanceConfig\":{\"itemGroup\":\"Lifes\"},\"style\":\"Default\",\"defaultOrder\":2,\"separatorFlag\":1,\"separatorHeight\":21,\"columnCount\":4}]}', '2016082302', '2015111401', '2', '2016-08-23 19:46:47', 'pm_admin');
...
-- 变更模板，以便能够支持多个item（原来使用物业action模板） by lqs 20160823
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag,target_type, target_id, scene_type) 
	VALUES (109971, 999999, 0, '0', 0, '/home/life', 'Lifes', '齐采网', '齐采网', 'shop/3010/1471502227046-2040368847.jpg', 1, 1, 14, '', 1, 0, 1, 1, '', 0, NULL, 'biz', 105, 'park_tourist');
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag,target_type, target_id, scene_type) 
	VALUES (109972, 999999, 0, '0', 0, '/home/life', 'Lifes', '齐采网', '齐采网', 'shop/3010/1471502227046-2040368847.jpg', 1, 1, 14, '', 1, 0, 1, 1, '', 0, NULL, 'biz', 105, 'pm_admin');
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag,target_type, target_id, scene_type) 
	VALUES (109973, 999999, 0, '0', 0, '/home', 'Lifes', '楼下Leisure ade', '楼下Leisure ade', 'shop/3007/14715010230651035403229.jpg', 1, 1, 14, '', 1, 0, 1, 1, '', 0, NULL, 'biz', 106, 'park_tourist');
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag,target_type, target_id, scene_type) 
	VALUES (109974, 999999, 0, '0', 0, '/home/life', 'Lifes', '楼下Leisure ade', '楼下Leisure ade', 'shop/3007/14715010230651035403229.jpg', 1, 1, 14, '', 1, 0, 1, 1, '', 0, NULL, 'biz', 106, 'pm_admin');	
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag,target_type, target_id, scene_type) 
	VALUES (109975, 999999, 0, '0', 0, '/home/life', 'Lifes', '迅美小店', '迅美小店', 'shop/3006/1468402755278-1096991180.jpg', 1, 1, 14, '', 1, 0, 1, 1, '', 0, NULL, 'biz', 107, 'park_tourist');		
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag,target_type, target_id, scene_type) 
	VALUES (109976, 999999, 0, '0', 0, '/home/life', 'Lifes', '迅美小店', '迅美小店', 'shop/3006/1468402755278-1096991180.jpg', 1, 1, 14, '', 1, 0, 1, 1, '', 0, NULL, 'biz', 107, 'pm_admin');
...
-- 深业layout去掉GovAgencies 去掉工作站 业委会 派出所 加更多和通讯录
update eh_launch_pad_layouts set layout_json='{"versionCode":"2016031201","versionName":"3.3.0","layoutName":"ServiceMarketLayout","displayName":"服务市场","groups":[{"groupName":"","widget":"Banners","instanceConfig":{"itemGroup":"Default"},"style":"Default","defaultOrder":1,"separatorFlag":0,"separatorHeight":0},{"groupName":"","widget":"Coupons","instanceConfig":{"itemGroup":"Coupons"},"style":"Default","defaultOrder":3,"separatorFlag":1,"separatorHeight":21},{"groupName":"","widget":"Bulletins","instanceConfig":{"itemGroup":"Default"},"style":"Default","defaultOrder":1,"separatorFlag":1,"separatorHeight":21},{"groupName":"商家服务","widget":"Navigator","instanceConfig":{"itemGroup":"Bizs"},"style":"Default","defaultOrder":5,"separatorFlag":0,"separatorHeight":0}]}' where id = 34; 
update eh_launch_pad_layouts set layout_json='{"versionCode":"2015120406","versionName":"3.0.0","layoutName":"ServiceMarketLayout","displayName":"服务市场","groups":[{"groupName":"","widget":"Banners","instanceConfig":{"itemGroup":"Default"},"style":"Default","defaultOrder":1,"separatorFlag":0,"separatorHeight":0},{"groupName":"","widget":"Coupons","instanceConfig":{"itemGroup":"Coupons"},"style":"Default","defaultOrder":3,"separatorFlag":1,"separatorHeight":21},{"groupName":"","widget":"Bulletins","instanceConfig":{"itemGroup":"Default"},"style":"Default","defaultOrder":1,"separatorFlag":1,"separatorHeight":21},{"groupName":"商家服务","widget":"Navigator","instanceConfig":{"itemGroup":"Bizs"},"style":"Default","defaultOrder":5,"separatorFlag":0,"separatorHeight":0}]}' where id = 36;

update eh_launch_pad_items set item_group = 'Bizs' where item_group = 'GovAgencies' and namespace_id = 999992;
delete from eh_launch_pad_items where id in(10021,10022,10023);
