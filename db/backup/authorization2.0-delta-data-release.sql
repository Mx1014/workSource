...
-- 张江表单和张江namespace关联
INSERT INTO `eh_authorization_third_party_forms` (`id`, `namespace_id`, `owner_type`, `owner_id`, `source_type`, `source_id`, `authorization_url`, `app_key`, `secret_key`, `title`, `detail`, `creator_uid`, `create_time`, `operator_uid`, `update_time`) VALUES (1, @namespace_id, 'EhNamespaces', @namespace_id, 'personal_auth', 0, 'http://139.129.220.146:3578/openapi/user/authenticate', 'ee4c8905-9aa4-4d45-973c-ede4cbb3cf21', '2CQ7dgiGCIfdKyHfHzO772IltqC50e9w7fswbn6JezdEAZU+x4+VHsBE/RKQ5BCkz/irj0Kzg6te6Y9JLgAvbQ==', '个人认证', '认证我的居住地址', 0, NOW(), NULL, NOW());
INSERT INTO `eh_authorization_third_party_forms` (`id`, `namespace_id`, `owner_type`, `owner_id`, `source_type`, `source_id`, `authorization_url`, `app_key`, `secret_key`, `title`, `detail`, `creator_uid`, `create_time`, `operator_uid`, `update_time`) VALUES (2, @namespace_id, 'EhNamespaces', @namespace_id, 'organization_auth', 0, 'http://139.129.220.146:3578/openapi/user/authenticate', 'ee4c8905-9aa4-4d45-973c-ede4cbb3cf21', '2CQ7dgiGCIfdKyHfHzO772IltqC50e9w7fswbn6JezdEAZU+x4+VHsBE/RKQ5BCkz/irj0Kzg6te6Y9JLgAvbQ==', '企业认证', '认证企业承租地址', 0, NOW(), NULL, NOW());
