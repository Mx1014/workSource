...
INSERT INTO `eh_version_urls` (`id`, `realm_id`, `target_version`, `download_url`, `info_url`, `namespace_id`) VALUES ((@version_urls_id := @version_urls_id + 1), '49', '2.4.0', 'https://biz.zuolin.com/nar/biz/web/app/dist/biz-2-4-0-tag.zip', 'https://biz.zuolin.com/nar/biz/web/app/dist/biz-2-4-0-tag.zip', '0');
-- update : business.url
