...
INSERT INTO `eh_users` (`id`,  `uuid`,  `account_name`,  `nick_name`, `avatar`, `status`, `points`, `level`, `gender`, `locale`, `salt`, `password_hash`, `create_time`, `namespace_id`)
	VALUES (246812, UUID(), '274583', '汤孝国', 'cs://1/image/aW1hZ2UvTVRvMlkySmhNbVZqTm1SaU1UQXdPREkxWkRjME5HVmxNVFU1TXpBNE5UUTBZdw', 1, 45, '1', '1',  'zh_CN',  '3023538e14053565b98fdfb2050c7709', '3f2d9e5202de37dab7deea632f915a6adc206583b3f228ad7e101e5cb9c4b199', UTC_TIMESTAMP(), 999981);
INSERT INTO `eh_users` (`id`,  `uuid`,  `account_name`,  `nick_name`, `avatar`, `status`, `points`, `level`, `gender`, `locale`, `salt`, `password_hash`, `create_time`, `namespace_id`)
	VALUES (245813, UUID(), '274584', '侯健', 'cs://1/image/aW1hZ2UvTVRvMlkySmhNbVZqTm1SaU1UQXdPREkxWkRjME5HVmxNVFU1TXpBNE5UUTBZdw', 1, 45, '1', '1',  'zh_CN',  '3023538e14053565b98fdfb2050c7709', '3f2d9e5202de37dab7deea632f915a6adc206583b3f228ad7e101e5cb9c4b199', UTC_TIMESTAMP(), 999981);
INSERT INTO `eh_users` (`id`,  `uuid`,  `account_name`,  `nick_name`, `avatar`, `status`, `points`, `level`, `gender`, `locale`, `salt`, `password_hash`, `create_time`, `namespace_id`)
	VALUES (245814, UUID(), '274585', '宋嘉扬', 'cs://1/image/aW1hZ2UvTVRvMlkySmhNbVZqTm1SaU1UQXdPREkxWkRjME5HVmxNVFU1TXpBNE5UUTBZdw', 1, 45, '1', '1',  'zh_CN',  '3023538e14053565b98fdfb2050c7709', '3f2d9e5202de37dab7deea632f915a6adc206583b3f228ad7e101e5cb9c4b199', UTC_TIMESTAMP(), 999981);

SET @eh_user_identifiers = (SELECT max(id) FROM `eh_user_identifiers`);   
INSERT INTO `eh_user_identifiers` (`id`,  `owner_uid`,  `identifier_type`,  `identifier_token`,  `verification_code`,  `claim_status`, `create_time`, `namespace_id`)
	VALUES ((@eh_user_identifiers := @eh_user_identifiers + 1) , 246812  ,  '0',  '13590293619',  '221616',  3, UTC_TIMESTAMP(), 999981);
INSERT INTO `eh_user_identifiers` (`id`,  `owner_uid`,  `identifier_type`,  `identifier_token`,  `verification_code`,  `claim_status`, `create_time`, `namespace_id`)
	VALUES ((@eh_user_identifiers := @eh_user_identifiers + 1) , 245813  ,  '0',  '15921208217',  '221616',  3, UTC_TIMESTAMP(), 999981);
INSERT INTO `eh_user_identifiers` (`id`,  `owner_uid`,  `identifier_type`,  `identifier_token`,  `verification_code`,  `claim_status`, `create_time`, `namespace_id`)
	VALUES ((@eh_user_identifiers := @eh_user_identifiers + 1) , 245814  ,  '0',  '18665331243',  '221616',  3, UTC_TIMESTAMP(), 999981);
...
INSERT INTO `eh_organization_members`(id, organization_id, target_type, target_id, member_group, contact_name, contact_type, contact_token, status, `namespace_id`)
	VALUES(2122109, 1009943, 'USER', 246812, 'manager', '曹秀然', 0, '13590293619', 3, 999981);	
INSERT INTO `eh_organization_members`(id, organization_id, target_type, target_id, member_group, contact_name, contact_type, contact_token, status, `namespace_id`)
	VALUES(2122110, 1009943, 'USER', 245813, 'manager', '侯健', 0, '15921208217', 3, 999981);	
INSERT INTO `eh_organization_members`(id, organization_id, target_type, target_id, member_group, contact_name, contact_type, contact_token, status, `namespace_id`)
	VALUES(2122111, 1009943, 'USER', 245814, 'manager', '宋嘉扬', 0, '18665331243', 3, 999981);	
INSERT INTO `eh_acl_role_assignments`(id, owner_type, owner_id, target_type, target_id, role_id, creator_uid, create_time)
	VALUES(14597, 'EhOrganizations', 1009943, 'EhUsers', 246812  , 1001, 1, UTC_TIMESTAMP());
INSERT INTO `eh_acl_role_assignments`(id, owner_type, owner_id, target_type, target_id, role_id, creator_uid, create_time)
	VALUES(14598, 'EhOrganizations', 1009943, 'EhUsers', 245813  , 1001, 1, UTC_TIMESTAMP());
INSERT INTO `eh_acl_role_assignments`(id, owner_type, owner_id, target_type, target_id, role_id, creator_uid, create_time)
	VALUES(14599, 'EhOrganizations', 1009943, 'EhUsers', 245814  , 1001, 1, UTC_TIMESTAMP());
...
INSERT INTO `eh_buildings` (`id`, `community_id`, `name`, `alias_name`, `manager_uid`, `contact`, `address`, `area_size`, `longitude`, `latitude`, `geohash`, `description`, `poster_uri`, `status`, `operator_uid`, `operate_time`, `creator_uid`, `create_time`, `delete_time`, `integral_tag1`, `integral_tag2`, `integral_tag3`, `integral_tag4`, `integral_tag5`, `string_tag1`, `string_tag2`, `string_tag3`, `string_tag4`, `string_tag5`, `namespace_id`)
	VALUES(182701, 240111044331056041, '上海市御河硅谷产学研国际促进中心', '上海市御河硅谷产学研国际促进中心', 0, '', '上海市浦东新区北蔡镇五星路707弄', 70653.3, 121.588373, 31.181834, 'wtw3qu3zq7nj', NULL, NULL, 2, 1, UTC_TIMESTAMP(), 1, UTC_TIMESTAMP(), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 999981);


INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137556,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A1-02','御河硅谷产学研国际促进中心','A1-02','2','0',UTC_TIMESTAMP(), 999981, 585.9);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137557,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A2-03','御河硅谷产学研国际促进中心','A2-03','2','0',UTC_TIMESTAMP(), 999981, 1288.7);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137558,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A3-04','御河硅谷产学研国际促进中心','A3-04','2','0',UTC_TIMESTAMP(), 999981, 585.9);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137559,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A4-05','御河硅谷产学研国际促进中心','A4-05','2','0',UTC_TIMESTAMP(), 999981, 1279.6);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137560,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A5-06','御河硅谷产学研国际促进中心','A5-06','2','0',UTC_TIMESTAMP(), 999981, 1136.3);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137561,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A6-07','御河硅谷产学研国际促进中心','A6-07','2','0',UTC_TIMESTAMP(), 999981, 1061.8);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137562,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A7-08','御河硅谷产学研国际促进中心','A7-08','2','0',UTC_TIMESTAMP(), 999981, 1136.3);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137563,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A8-09','御河硅谷产学研国际促进中心','A8-09','2','0',UTC_TIMESTAMP(), 999981, 757.3);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137564,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A9-10','御河硅谷产学研国际促进中心','A9-10','2','0',UTC_TIMESTAMP(), 999981, 1587.7);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137565,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-A10-1','御河硅谷产学研国际促进中心','A10-1','2','0',UTC_TIMESTAMP(), 999981, 3232.4);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137566,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C1-12','御河硅谷产学研国际促进中心','C1-12','2','0',UTC_TIMESTAMP(), 999981, 1271.5);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137567,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C2-13','御河硅谷产学研国际促进中心','C2-13','2','0',UTC_TIMESTAMP(), 999981, 1271.5);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137568,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C3-14','御河硅谷产学研国际促进中心','C3-14','2','0',UTC_TIMESTAMP(), 999981, 888.1);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137569,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C4-15','御河硅谷产学研国际促进中心','C4-15','2','0',UTC_TIMESTAMP(), 999981, 574.5);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137570,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C5-16','御河硅谷产学研国际促进中心','C5-16','2','0',UTC_TIMESTAMP(), 999981, 1210.7);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137571,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C6-17','御河硅谷产学研国际促进中心','C6-17','2','0',UTC_TIMESTAMP(), 999981, 1882.8);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137572,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C7-18','御河硅谷产学研国际促进中心','C7-18','2','0',UTC_TIMESTAMP(), 999981, 888.1);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137573,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C8-19','御河硅谷产学研国际促进中心','C8-19','2','0',UTC_TIMESTAMP(), 999981, 567.5);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137574,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C9-20','御河硅谷产学研国际促进中心','C9-20','2','0',UTC_TIMESTAMP(), 999981, 574.5);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137575,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C10-21','御河硅谷产学研国际促进中心','C10-21','2','0',UTC_TIMESTAMP(), 999981, 585.9);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137576,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C11-22','御河硅谷产学研国际促进中心','C11-22','2','0',UTC_TIMESTAMP(), 999981, 578.9);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137577,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C12-23','御河硅谷产学研国际促进中心','C12-23','2','0',UTC_TIMESTAMP(), 999981, 578.9);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137578,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C13-24','御河硅谷产学研国际促进中心','C13-24','2','0',UTC_TIMESTAMP(), 999981, 566.3);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137579,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C14-25','御河硅谷产学研国际促进中心','C14-25','2','0',UTC_TIMESTAMP(), 999981, 1879.1);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137580,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C15-26','御河硅谷产学研国际促进中心','C15-26','2','0',UTC_TIMESTAMP(), 999981, 567.5);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137581,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C16-27','御河硅谷产学研国际促进中心','C16-27','2','0',UTC_TIMESTAMP(), 999981, 567.5);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137582,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C17-28','御河硅谷产学研国际促进中心','C17-28','2','0',UTC_TIMESTAMP(), 999981, 1184.2);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137583,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-C18-29','御河硅谷产学研国际促进中心','C18-29','2','0',UTC_TIMESTAMP(), 999981, 1590.8);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137584,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-D1-30','御河硅谷产学研国际促进中心','D1-30','2','0',UTC_TIMESTAMP(), 999981, 10055.8);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137585,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-E5-31','御河硅谷产学研国际促进中心','E5-31','2','0',UTC_TIMESTAMP(), 999981, 2931.4);
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `apartment_floor`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) VALUES(239825274387137586,UUID(),240111044331056041, 15513, '上海市',  15514, '浦东新区', '' ,'御河硅谷产学研国际促进中心-E6-32','御河硅谷产学研国际促进中心','E6-32','2','0',UTC_TIMESTAMP(), 999981, 794.9);
...
INSERT INTO `eh_web_menu_scopes`(`id`, `menu_id`,`menu_name`, `owner_type`, `owner_id`, `apply_policy`) VALUES((@menu_scope_id := @menu_scope_id + 1),40850,'', 'EhNamespaces', 999981,2);
