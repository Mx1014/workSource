...
update eh_launch_pad_items set default_order = 80 where namespace_id = 1 and item_label = '左邻会议室';
update eh_launch_pad_items set display_flag = 0 where namespace_id = 1 and item_label = '公共会议室';
update eh_launch_pad_items set display_flag = 0 where namespace_id = 1 and item_label = '会议室预订';
	
	
update eh_launch_pad_items set action_data = '{"url": "https://biz.zuolin.com/zl-ec/rest/service/front/logon?hideNavigationBar=1&sourceUrl=https%3a%2f%2fbiz.zuolin.com%2fnar%2fbiz%2fweb%2fapp%2fuser%2findex.html%23%2fmicroshop%2fhome%3fisfromindex%3d0%26_k%3dzlbiz#sign_suffix"}' where namespace_id = 1 and item_label = '新品推荐';	
