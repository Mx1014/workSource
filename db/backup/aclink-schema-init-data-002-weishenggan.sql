...
INSERT INTO `eh_locale_templates`(`scope`, `code`,`locale`, `description`, `text`) VALUES( 'aclink.notification', 1, 'zh_CN', '【授权人】已授权给你【门禁名称】钥匙，快去使用吧~', '${userName}已授权给你${doorName}钥匙，快去使用吧~');
