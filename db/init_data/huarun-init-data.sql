...
update eh_request_templates SET fields_json = '{"fields": [{"fieldName": "contact","fieldDisplayName": "姓名","fieldType": "string","fieldContentType": "text","fieldDesc": "请输入您的姓名","requiredFlag": "1"},{"fieldName": "remarks","fieldDisplayName": "性别","fieldType": "string","fieldContentType": "text","fieldDesc": "请输入您的性别","requiredFlag": "1"},{"fieldName": "reserveOrganization","fieldDisplayName": "公司名称","fieldType": "string","fieldContentType": "text","fieldDesc": "请输入您所在公司","requiredFlag": "1"},{"fieldName": "mobile","fieldDisplayName": "联系电话","fieldType": "string","fieldContentType": "text","fieldDesc": "请输入您的联系电话","requiredFlag": "1"},{"fieldName": "reserveType","fieldDisplayName": "备注","fieldType": "string","fieldContentType": "text","fieldDesc": "选填，若还有其他要求，可在此填写","requiredFlag": "0"}]}'
WHERE template_type = 'ReserveChinesePhysiotherapy' AND name='中医理疗';