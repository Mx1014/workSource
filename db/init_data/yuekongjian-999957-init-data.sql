...
delete from eh_launch_pad_items where id in(138222,138223);
delete from eh_launch_pad_items where id in(138190,138191);
delete from eh_launch_pad_items where id in(138192,138193);
...
delete from eh_launch_pad_items where id in(138226,138227);
delete from eh_launch_pad_items where id in(138230,138231);
update eh_launch_pad_items set item_location = '/home/yuespace', item_group = 'NavigatorGroup1', default_order = '10' where item_name = '门禁' and namespace_id = 999957;
...
delete from eh_launch_pad_items where id in(138198,138199);
