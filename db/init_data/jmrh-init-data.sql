...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`)
	 VALUES(115456, 999972, 0, 0, 0, '/home', 'GovAgencies', '服务广场', '服务广场', 'cs://1/image/aW1hZ2UvTVRveVlqQTBNVFEzTkdJNE5tSmhOakE1WlRNMllqWXlPV1UyTnprM05XRXhZZw', 1, 1, 33, '{"type":11,"parentId":11,"displayType": "grid"}', 4, 0, 1, 1, '', 0, NULL, NULL, NULL, 0, 'pm_admin');
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`)
	 VALUES(115457, 999972, 0, 0, 0, '/home', 'GovAgencies', '创客空间', '创客空间', 'cs://1/image/aW1hZ2UvTVRvMFpqTXlPREppWkdJMFpqSXdZemhsT1dFM1pUZzNNVEpoTXpobE1ERXhOQQ', 1, 1, 32, '{"type":1,"forumId":177000,"categoryId":1010,"parentId":110001,"tag":"创客"}', 6, 0, 1, 1, '', 0, NULL, NULL, NULL, 0, 'pm_admin');
...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`) 
	VALUES (115470, 999972, 0, 0, 0, '/home', 'Bizs', 'wifi上网', 'wifi上网', 'cs://1/image/aW1hZ2UvTVRvME5HVTNZVEZsTXpNeU16VXhNbVF3Wm1GbU9UUTBPV0ZoTUdRNFpUSmpaQQ', 1, 1, 13, '{"url":"http://zuolin.com/mobile/static/coming_soon/index.html"}', 34, 0, 1, 1, '', 0, NULL, NULL, NULL, 1, 'pm_admin', 0, NULL, NULL, 0, NULL);
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`) 
...
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`)
	 VALUES(115474, 999972, 0, 0, 0, '/home', 'GovAgencies', '园区入驻', '园区入驻', 'cs://1/image/aW1hZ2UvTVRvME5EY3pZMlEyTVRobE1HRTNPVEpoTldNM1ptSTBaV1JtTVdaaE1EWmhZZw', 1, 1, 28, '', 42, 0, 1, 1, '', 0, NULL, NULL, NULL, 0, 'park_tourist');
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`)
	 VALUES(115475, 999972, 0, 0, 0, '/home', 'GovAgencies', '服务广场', '服务广场', 'cs://1/image/aW1hZ2UvTVRveVlqQTBNVFEzTkdJNE5tSmhOakE1WlRNMllqWXlPV1UyTnprM05XRXhZZw', 1, 1, 33, '{"type":11,"parentId":11,"displayType": "grid"}', 44, 0, 1, 1, '', 0, NULL, NULL, NULL, 0, 'park_tourist');
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`)
	 VALUES(115476, 999972, 0, 0, 0, '/home', 'GovAgencies', '创客空间', '创客空间', 'cs://1/image/aW1hZ2UvTVRvMFpqTXlPREppWkdJMFpqSXdZemhsT1dFM1pUZzNNVEpoTXpobE1ERXhOQQ', 1, 1, 32, '{"type":1,"forumId":177000,"categoryId":1010,"parentId":110001,"tag":"创客"}', 46, 0, 1, 1, '', 0, NULL, NULL, NULL, 0, 'park_tourist');
