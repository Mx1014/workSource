...
-- 内部管理-表单管理 by xiongying20170810
SET @menu_scope_id = (SELECT MAX(id) FROM `eh_web_menu_scopes`);
INSERT INTO `eh_web_menu_scopes`(`id`, `menu_id`,`menu_name`, `owner_type`, `owner_id`, `apply_policy`) VALUES((@menu_scope_id := @menu_scope_id + 1),50900,'', 'EhNamespaces', 999974,2);

-- 新城智慧管家任务管理 by sw,20170816
SET @launch_pad_items_id = (SELECT MAX(id) FROM `eh_launch_pad_items`);
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`) VALUES
	((@launch_pad_items_id := @launch_pad_items_id+1), 999974, 0, 0, 0, '/home', 'Bizs', 'FLOW_TASKS', '任务管理', 'cs://1/image/aW1hZ2UvTVRwbE1EY3laalUzTXpCaFltTTVaR0V6T1dabU1tWXpabVJsTmpRNFpXTm1aZw', 1, 1, 56, '', 1, 0, 1, 0, '', 0, NULL, NULL, NULL, 0, 'pm_admin', 1, NULL, NULL, 0, NULL);
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`) VALUES
	((@launch_pad_items_id := @launch_pad_items_id+1), 999974, 0, 0, 0, '/home', 'Bizs', 'FLOW_TASKS', '任务管理', 'cs://1/image/aW1hZ2UvTVRwbE1EY3laalUzTXpCaFltTTVaR0V6T1dabU1tWXpabVJsTmpRNFpXTm1aZw', 1, 1, 56, '', 1, 0, 1, 0, '', 0, NULL, NULL, NULL, 0, 'park_tourist', 1, NULL, NULL, 0, NULL);
...
-- 修改布局文件
DELETE from eh_launch_pad_layouts WHERE namespace_id = 999974;
SET @layout_id = (SELECT MAX(id) FROM `eh_launch_pad_layouts`); 
INSERT INTO `eh_launch_pad_layouts` (	`id`,`namespace_id`,`name`,`layout_json`,`version_code`,`min_version_code`,`status`,`create_time`,`scene_type`,`scope_code`,`scope_id`,`apply_policy`)VALUES(		(@layout_id := @layout_id + 1),	'999974',	'ServiceMarketLayout',
'{"versionCode":"2017101803","layoutName":"ServiceMarketLayout","displayName":"服务市场","groups":[{"groupName":"","widget":"Banners","instanceConfig":{"itemGroup":"Default"},"style":"Default","defaultOrder":1},{"groupName":"","widget":"Navigator","instanceConfig":{"itemGroup":"GovAgencies","cssStyleFlag":1,"paddingLeft":10,"paddingTop":10,"paddingRight":10,"paddingBottom":10,"lineSpacing":10,"columnSpacing":10,"backgroundColor":"FFFFFF"},"style":"Gallery","defaultOrder":2,"separatorFlag":1,"separatorHeight":16,"columnCount":4},{"groupName":"","title":"园区服务","widget":"Navigator","instanceConfig":{"itemGroup":"Bizs","paddingTop":1,"paddingLeft":1,"paddingBottom":1,"paddingRight":1,"lineSpacing":1,"columnSpacing":1,"backgroundColor":"#ffffff"},"style":"Default","defaultOrder":3,"separatorFlag":1,"separatorHeight":16,"columnCount":4},{"groupName":"","title":"园区动态","widget":"Bulletins","instanceConfig":{"itemGroup":"Default","rowCount":1},"defaultOrder":4,"separatorFlag":1},{"groupName":"","widget":"News","instanceConfig":{"itemGroup":"Default","categoryId":0,"timeWidgetStyle":"date"},"style":"Default","defaultOrder":5}]}'
,'2017101803',	'0',	'2',	NOW(),	'pm_admin',	'0',	'0',	'0'	);
INSERT INTO `eh_launch_pad_layouts` (	`id`,`namespace_id`,`name`,`layout_json`,`version_code`,`min_version_code`,`status`,`create_time`,`scene_type`,`scope_code`,`scope_id`,`apply_policy`)VALUES(		(@layout_id := @layout_id + 1),	'999974',	'ServiceMarketLayout',
'{"versionCode":"2017101803","layoutName":"ServiceMarketLayout","displayName":"服务市场","groups":[{"groupName":"","widget":"Banners","instanceConfig":{"itemGroup":"Default"},"style":"Default","defaultOrder":1},{"groupName":"","widget":"Navigator","instanceConfig":{"itemGroup":"GovAgencies","cssStyleFlag":1,"paddingLeft":10,"paddingTop":10,"paddingRight":10,"paddingBottom":10,"lineSpacing":10,"columnSpacing":10,"backgroundColor":"FFFFFF"},"style":"Gallery","defaultOrder":2,"separatorFlag":1,"separatorHeight":16,"columnCount":4},{"groupName":"","title":"园区服务","widget":"Navigator","instanceConfig":{"itemGroup":"Bizs","paddingTop":1,"paddingLeft":1,"paddingBottom":1,"paddingRight":1,"lineSpacing":1,"columnSpacing":1,"backgroundColor":"#ffffff"},"style":"Default","defaultOrder":3,"separatorFlag":1,"separatorHeight":16,"columnCount":4},{"groupName":"","title":"园区动态","widget":"Bulletins","instanceConfig":{"itemGroup":"Default","rowCount":1},"defaultOrder":4,"separatorFlag":1},{"groupName":"","widget":"News","instanceConfig":{"itemGroup":"Default","categoryId":0,"timeWidgetStyle":"date"},"style":"Default","defaultOrder":5}]}'
,'2017101803',	'0',	'2',	NOW(),	'park_tourist',	'0',	'0',	'0'	);


-- 一键上网
UPDATE `eh_launch_pad_items` SET icon_uri = 'cs://1/image/aW1hZ2UvTVRwaE16WTRaRFV3TmpoaU1qUm1PRFEyTm1Rd01qRXlZVFU0TURBNE0ySTROdw',item_group = 'GovAgencies', default_order = 1 WHERE item_label = '一键上网' AND `namespace_id` = 999974;
-- 智能门禁
UPDATE `eh_launch_pad_items` SET icon_uri = 'cs://1/image/aW1hZ2UvTVRvd056STFaVGcxTlRJd00ySmpZalZpTlRobVkyTmxNR1V3WWpJMk56TmlPQQ',item_group = 'GovAgencies', default_order = 2 WHERE item_label = '智能门禁' AND `namespace_id` = 999974;
-- 简餐供应
SET @item_id = (SELECT MAX(id) FROM `eh_launch_pad_items`); 
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`, `categry_name`) VALUES 
	((@item_id := @item_id + 1), '999974', '0', '0', '0', '/home', 'GovAgencies', '简餐供应', '简餐供应', 'cs://1/image/aW1hZ2UvTVRvMk9UUTBNakEzWWpCaU9UazVNRE0xWW1NM01qa3dPVEJpWTJRNFlUQTVaZw', '1', '1', '13', '{\"url\":\"https://biz.zuolin.com/zl-ec/rest/service/front/logon?hideNavigationBar=1&mallId=1999973&sourceUrl=https%3a%2f%2fbiz.zuolin.com%2fnar%2fbiz%2fweb%2fapp%2fuser%2findex.html%23%2fstore%2fdetails%2f15065907855281584412%3F_k%3Dzlbiz#sign_suffix\"}', '100', '0', '1', '1', '', '0', NULL, NULL, NULL, '1', 'pm_admin', '1', NULL, NULL, '0', 'cs://1/image/aW1hZ2UvTVRwak5tTmtNREpqT0dJM01XSmhabVJoT1dJNFpEYzFOelUyTURJNE1EY3hZZw', NULL);
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`, `categry_name`) VALUES 
	((@item_id := @item_id + 1), '999974', '0', '0', '0', '/home', 'GovAgencies', '简餐供应', '简餐供应', 'cs://1/image/aW1hZ2UvTVRvMk9UUTBNakEzWWpCaU9UazVNRE0xWW1NM01qa3dPVEJpWTJRNFlUQTVaZw', '1', '1', '13', '{\"url\":\"https://biz.zuolin.com/zl-ec/rest/service/front/logon?hideNavigationBar=1&mallId=1999973&sourceUrl=https%3a%2f%2fbiz.zuolin.com%2fnar%2fbiz%2fweb%2fapp%2fuser%2findex.html%23%2fstore%2fdetails%2f15065907855281584412%3F_k%3Dzlbiz#sign_suffix\"}', '100', '0', '1', '1', '', '0', NULL, NULL, NULL, '1', 'park_tourist', '1', NULL, NULL, '0', 'cs://1/image/aW1hZ2UvTVRwak5tTmtNREpqT0dJM01XSmhabVJoT1dJNFpEYzFOelUyTURJNE1EY3hZZw', NULL);

INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`, `categry_name`) VALUES 
	((@item_id := @item_id + 1), '999974', '0', '0', '0', '/home', 'GovAgencies', '健身房', '健身房', 'cs://1/image/aW1hZ2UvTVRvM1kySmxaalUxT0Roa1pqaGpNR1V4WkdaaFlURmpPV1V4TnpVeE9UVXpNQQ', '1', '1', '49', '{\"resourceTypeId\":12078,\"pageType\":0,\"payMode\":1}', '200', '0', '1', '1', '', '0', NULL, NULL, NULL, '1', 'pm_admin', '1', NULL, NULL, '0', NULL, NULL);
INSERT INTO `eh_launch_pad_items` (`id`, `namespace_id`, `app_id`, `scope_code`, `scope_id`, `item_location`, `item_group`, `item_name`, `item_label`, `icon_uri`, `item_width`, `item_height`, `action_type`, `action_data`, `default_order`, `apply_policy`, `min_version`, `display_flag`, `display_layout`, `bgcolor`, `tag`, `target_type`, `target_id`, `delete_flag`, `scene_type`, `scale_type`, `service_categry_id`, `selected_icon_uri`, `more_order`, `alias_icon_uri`, `categry_name`) VALUES 
	((@item_id := @item_id + 1), '999974', '0', '0', '0', '/home', 'GovAgencies', '健身房', '健身房', 'cs://1/image/aW1hZ2UvTVRvM1kySmxaalUxT0Roa1pqaGpNR1V4WkdaaFlURmpPV1V4TnpVeE9UVXpNQQ', '1', '1', '49', '{\"resourceTypeId\":12078,\"pageType\":0,\"payMode\":1}', '200', '0', '1', '1', '', '0', NULL, NULL, NULL, '1', 'park_tourist', '1', NULL, NULL, '0', NULL, NULL);
