...
INSERT INTO `eh_launch_pad_layouts` (`id`, `namespace_id`, `name`, `layout_json`, `version_code`, `min_version_code`, `status`, `create_time`, `scene_type`, `scope_code`, `scope_id`, `apply_policy`)
    VALUES (606, 999970, 'RentalLayout', '{"versionCode":"2017080401","versionName":"4.7.0","layoutName":"RentalLayout","displayName":"资源预订","groups":[{"groupName":"","widget":"Tab","instanceConfig":{"itemGroup":"TabGroup2"},"style":"1","defaultOrder":1,"separatorFlag":0,"separatorHeight":0}]}', '2017080401', '2017080401', '2',  NOW(), 'pm_admin', '0', '0', '0');
