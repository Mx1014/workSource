...
CREATE TABLE `eh_terminal_day_statistics` (
  ...
  `start_change_rate` DECIMAL NOT NULL COMMENT 'today compared to yesterdays rate of change.',
  `new_change_rate` DECIMAL NOT NULL COMMENT 'today compared to yesterdays rate of change.',
  `active_change_rate` DECIMAL NOT NULL COMMENT 'today compared to yesterdays rate of change.',
  `cumulative_change_rate` DECIMAL NOT NULL COMMENT 'today compared to yesterdays rate of change.',
