...
-- 搜索电商商家API add by yanjun 20170427 search-2.0
...
-- 当item对应的layout是方形时给它一个默认的icon，现在用于搜索时的icon展现。以下的图片路径需要根据上线时实际的图片路径作修改。add by yanjun 20170427 search-2.0
...
-- 增加一个排序字段，用于客户端显示顺序，顺序为活动、话题、投票、快讯、应用和商店 add by yanjun 20170427 search-2.0
