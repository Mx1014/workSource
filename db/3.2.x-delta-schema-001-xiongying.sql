...
ALTER TABLE `eh_conf_conferences` ADD COLUMN `meeting_no` bigint(20) NOT NULL DEFAULT '0' COMMENT 'the meeting no from 3rd conference provider';
ALTER TABLE `eh_conf_conferences` CHANGE `conf_id` `conference_id` bigint(20) NOT NULL DEFAULT '0';