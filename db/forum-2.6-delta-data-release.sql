...
INSERT INTO `eh_hot_tags` (`id`, `namespace_id`, `service_type`, `name`, `status`, `default_order`, `create_time`, `create_uid`, `delete_time`, `delete_uid`, `category_id`, `module_type`) VALUES ((@id := @id + 1), '999983', 'topic', '旅游', '1', '1', NOW(), '1', NOW(), NULL, '2', '2');
INSERT INTO `eh_hot_tags` (`id`, `namespace_id`, `service_type`, `name`, `status`, `default_order`, `create_time`, `create_uid`, `delete_time`, `delete_uid`, `category_id`, `module_type`) VALUES ((@id := @id + 1), '999983', 'topic', '团建', '1', '2', NOW(), '1', NOW(), NULL, '2', '2');
