...
INSERT INTO `eh_parking_lots` (`id`, `owner_type`, `owner_id`, `name`, `vendor_name`, `vendor_lot_token`, `status`, `creator_uid`, `create_time`, `namespace_id`, `recharge_json`, `config_json`) VALUES (@kexin_xiaomao_park_lot_id, 'community', @kexin_zzh_community_id, '正中时代广场停车场', 'KEXIN_XIAOMAO', NULL, 2, 1, '2018-04-27 15:53:12', @kexin_namespace_id, NULL, '{"tempfeeFlag": 0, "rateFlag": 1, "lockCarFlag": 0, "searchCarFlag": 0, "currentInfoType": 0,"identityCardFlag":0}');
