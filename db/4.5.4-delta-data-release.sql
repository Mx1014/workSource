...
INSERT INTO `eh_express_companies` (`id`, `namespace_id`, `owner_type`, `owner_id`, `parent_id`, `name`, `status`, `creator_uid`, `create_time`, `update_time`, `operator_uid`, `logo`) VALUES (1, 0, '', 0, 0, 'ems', 2, 0, '2017-04-17 15:48:33', '2017-04-17 15:48:35', 0, 'cs://1/image/aW1hZ2UvTVRwak9XSTJOVFJqWXpjMVkyTmtNVGt4WW1NNU1qaGlNR0k1WlRNelpXRTJNdw');
-- 自寄服务地址（测试使用）
