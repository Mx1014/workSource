...
INSERT INTO `eh_payment_users` (`id`, `owner_type`, `owner_id`, `payment_user_type`, `payment_user_id`, `create_time`) VALUES ('2', 'EhUsers', '147249', '2', '19030101', '2017-09-08 14:58:52');
INSERT INTO `eh_payment_users` (`id`, `owner_type`, `owner_id`, `payment_user_type`, `payment_user_id`, `create_time`) VALUES ('5', 'EhUsers', '249517', '1', '19030119', '2017-09-08 21:23:54');
INSERT INTO `eh_payment_users` (`id`, `owner_type`, `owner_id`, `payment_user_type`, `payment_user_id`, `create_time`) VALUES ('6', 'EhUsers', '249518', '1', '19030129', '2017-09-10 23:47:21');


-- select * from tbl_shop_info where shop_name like '%jw%';
INSERT INTO `eh_payment_service_configs` (`id`, `name`, `order_type`, `namespace_id`, `owner_type`, `owner_id`, `resource_type`, `resource_id`, `payment_split_rule_id`, `payment_user_type`, `payment_user_id`, `create_time`, `update_time`) VALUES ('1', '左邻APP-测试限时折扣-from-jw店铺服务', 'activitySignupOrder', '1000000', 'EhOrganizations', '147248', '1', '1001', '1', '1', '19030100', '2017-09-08 15:01:30', NULL);
