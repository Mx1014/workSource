...
INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`)
	VALUES ('183', 'pmtask.notification', '5', 'zh_CN', '您于<{day}>日<{hour}>时发起的服务已由<{operatorName}><{operatorPhone}>完成，快去评价打分吧~', '0');
INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`)
	VALUES ('183', 'pmtask.notification', '6', 'zh_CN', '业主<{creatorName}><{creatorPhone}>发起的服务单已由<{operatorName}><{operatorPhone}>完成', '0');
INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`)
	VALUES ('183', 'pmtask.notification', '10', 'zh_CN', '<{operatorName}><{operatorPhone}}>已将一个<{categoryName}>单派发给你，请尽快处理', '0');
INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`)
	VALUES ('183', 'pmtask.notification', '11', 'zh_CN', '<林龙><13163366563>已发起一个<物业报修>单，请尽快处理', '0');
