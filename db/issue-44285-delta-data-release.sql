...
SET @value = ()
INSERT INTO `eh_configurations`(`id`, `name`, `value`, `description`, `namespace_id`, `display_name`, `is_readonly`) VALUES (@id+1,'invoice.home.url', 'https://core.szbay.com', 'the home url', 0, NULL, 1);
