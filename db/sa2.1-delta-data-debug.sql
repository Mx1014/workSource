...
INSERT INTO `eh_launch_pad_layouts`(id, namespace_id, name, layout_json, version_code, min_version_code, status, create_time, scene_type) 
	VALUES ((@layout_id := @layout_id + 1), 999985, 'SecondServiceMarketLayout', '{"versionCode":"2017022202","versionName":"4.1.3","layoutName":"SecondServiceMarketLayout","displayName":"资产管理","groups":[{"groupName":"","widget":"Navigator","instanceConfig":{"itemGroup":"GovAgencies"},"style":"Default","defaultOrder":1,"separatorFlag":1,"separatorHeight":21,"columnCount":4},{"groupName":"","widget":"OPPush","instanceConfig":{"itemGroup":"Gallery", "entityCount": 20, "newsSize":  5},"style":"LargeImageListView","defaultOrder":2,"separatorFlag":0,"separatorHeight":0}]}', '2016102701', '0', '2', UTC_TIMESTAMP(), 'pm_admin');	
INSERT INTO `eh_launch_pad_layouts`(id, namespace_id, name, layout_json, version_code, min_version_code, status, create_time, scene_type) 
	VALUES ((@layout_id := @layout_id + 1), 999985, 'SecondServiceMarketLayout', '{"versionCode":"2017022202","versionName":"4.1.3","layoutName":"SecondServiceMarketLayout","displayName":"资产管理","groups":[{"groupName":"","widget":"Navigator","instanceConfig":{"itemGroup":"GovAgencies"},"style":"Default","defaultOrder":1,"separatorFlag":1,"separatorHeight":21,"columnCount":4},{"groupName":"","widget":"OPPush","instanceConfig":{"itemGroup":"Gallery", "entityCount": 20, "newsSize":  5},"style":"LargeImageListView","defaultOrder":2,"separatorFlag":0,"separatorHeight":0}]}', '2016102701', '0', '2', UTC_TIMESTAMP(), 'park_tourist');	
