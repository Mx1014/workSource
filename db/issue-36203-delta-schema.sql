...
CREATE TABLE `eh_personal_center_settings` (
  ...
  `funciton_name` VARCHAR(32) COMMENT '功能名称',
  `region` TINYINT NOT NULL DEFAULT 0 COMMENT '个人中心展示区域',
  `group` TINYINT COMMENT '展示区域分组',
  `order` INTEGER NOT NULL DEFAULT 0 COMMENT '展示顺序',
  `showalbe` TINYINT COMMENT '是否展示',
  `editalbe` TINYINT COMMENT '是否可编辑',
