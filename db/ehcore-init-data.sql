...
-- eh_launch_pad_items
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag) VALUES (1, 0, 0, 0, 0, '/home', 'GovAgencies', 'PM', '物业', 'cs://1/image/aW1hZ2UvTVRvNU5qbGtNbU0wTmpJeVpUQTNNV1JsWkdObE4yWmpaVEE1WTJJNU5XVmtPUQ', 1, 1, 2, '{"itemLocation":"/home/Pm","layoutName":"PmLayout","title":"物业","entityTag":"PM"}', 0, 0, 1, 1, '', 0,NULL);
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag) VALUES (2, 0, 0, 0, 0, '/home', 'GovAgencies', 'GARC', '业委会', 'cs://1/image/aW1hZ2UvTVRvNVpqTmlNVFF6TkRrelpqSm1aalF6WTJVd05EaGpOamxsWmpZMlpqTXdOUQ', 1, 1, 2, '{"itemLocation":"/home/Garc","layoutName":"GarcLayout","title":"业委会","entityTag":"GARC"}', 0, 0, 1, 1, '', 0,NULL);
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag) VALUES (3, 0, 0, 0, 0, '/home', 'GovAgencies', 'GANC', '工作站', 'cs://1/image/aW1hZ2UvTVRvNU9ETmhOamd6TkdJME5tSm1aR1E0TTJSbU9EVTNNbVV3WW1Rd056WmlZZw', 1, 1, 2, '{"itemLocation":"/home/Ganc","layoutName":"GancLayout","title":"工作站","entityTag":"GANC"}', 0, 0, 1, 1, '', 0,NULL);
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag) VALUES (4, 0, 0, 0, 0, '/home', 'GovAgencies', 'GAPS', '派出所', 'cs://1/image/aW1hZ2UvTVRwa1l6RmxZV0prT0RKak1EZzRNRFppTm1ZMU9UazBOVEZrTmpVM05EVTNaUQ', 1, 1, 2, '{"itemLocation":"/home/Gaps","layoutName":"GapsLayout","title":"派出所","entityTag":"GAPS"}', 0, 0, 1, 1, '', 0,NULL);
...
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag) VALUES (25, 0, 0, 0, 0, '/home', 'Coupons', '优惠券', '优惠券', 'cs://1/image/aW1hZ2UvTVRwaE1EQmhZVFV3TkRNM09HSTBZalZpWkdNeFpHTm1OVGRrWlRnM01ETm1Odw', 3, 1, 14, '{"url":"http://biz.zuolin.com/zl-ec?hideNavigationBar=1&sourceUrl=http%3A%2F%2Fbiz.zuolin.com%2Fweb%2Fapp%2Fuser%2Findex.html%23%2Fstore%2Fdetails%2Fpromotions%2F"}', 1, 0, 1, 1, '', 0,NULL);
INSERT INTO `eh_launch_pad_items`(id,namespace_id,app_id,scope_code,scope_id,item_location,item_group,item_name,item_label,icon_uri,item_width,item_height,action_type,action_data,default_order,apply_policy,min_version,display_flag,display_layout,bgcolor,tag) VALUES (26, 0, 0, 0, 0, '/home', 'Coupons', '市场动态', '市场动态', 'cs://1/image/aW1hZ2UvTVRvMk0yRTRabVZpWXpsak1UZzVOMkkzWlRVNE5UazNPVGM0WkRVME1XVTVaZw', 5, 1, 14, '{"url":"http://biz.zuolin.com/zl-ec?sourceUrl=http%3a%2f%2fbiz.zuolin.com%2fweb%2fapp%2flib%2fhtml%2fcoming_soon%2findex.html"}', 2, 0, 1, 1, '', 0,NULL);
