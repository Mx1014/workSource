...
VALUES('51100','审批管理','50000',NULL,'react:/approval-management/approval-list/51000','0','2','/50000/51000','park','591','51100'); 
-- 给科兴加
SET @id = (SELECT MAX(id) FROM eh_web_menu_scopes);
INSERT INTO `eh_web_menu_scopes` (`id`, `menu_id`, `menu_name`, `owner_type`, `owner_id`, `apply_policy`) VALUES((@id:=@id+1),'51100','','EhNamespaces','999983','2'); 

-- 加module
INSERT INTO `eh_service_modules` (`id`, `name`, `parent_id`, `path`, `type`, `level`, `status`, `default_order`, `create_time`) 
VALUES('51100','审批管理','50000','/50000/51000','0','2','2','0','2017-05-19 11:50:20');
...
VALUES ((@web_menu_privilege_id := @web_menu_privilege_id + 1), 10137, 51100, '审批管理', 1, 1, '审批管理  全部权限', 202);  
...
VALUES ((@eh_service_module_privileges_id := @eh_service_module_privileges_id + 1), '51100', '1', '10137', NULL, '0', UTC_TIMESTAMP());
SET @eh_service_module_scopes_id = (SELECT MAX(id) FROM `eh_service_module_scopes`);
INSERT INTO `eh_service_module_scopes` (`id`, `namespace_id`, `module_id`, `module_name`, `owner_type`, `owner_id`, `default_order`, `apply_policy`)
VALUES ((@eh_service_module_scopes_id := @eh_service_module_scopes_id + 1), 999983, 51100, '审批管理', 'EhNamespaces', 999983, NULL, 2);
