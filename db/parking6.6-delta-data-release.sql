...
SELECT * from eh_service_modules WHERE id in (40810,40820,40830,40840);
SELECT * from eh_acl_privileges WHERE id in (4080040810,4080040820,4080040830,4080040840);
SELECT * from eh_service_module_privileges WHERE module_id in (40810,40820,40830,40840);


INSERT INTO `eh_service_modules` (`id`, `name`, `parent_id`, `path`, `type`, `level`, `status`, `default_order`, `create_time`, `instance_config`, `action_type`, `update_time`, `operator_uid`, `creator_uid`, `description`, `multiple_flag`, `module_control_type`) VALUES ('40810', '申请管理', '40800', '/40000/40800/40810', '1', '3', '2', '0', now(), NULL, NULL, now(), '0', '1', '1', NULL, '');
INSERT INTO `eh_service_modules` (`id`, `name`, `parent_id`, `path`, `type`, `level`, `status`, `default_order`, `create_time`, `instance_config`, `action_type`, `update_time`, `operator_uid`, `creator_uid`, `description`, `multiple_flag`, `module_control_type`) VALUES ('40820', '订单记录', '40800', '/40000/40800/40820', '1', '3', '2', '0', now(), NULL, NULL, now(), '0', '1', '1', NULL, '');
