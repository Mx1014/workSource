...
-- 韪㈠嚭鎻愮ず by janson 20161017
UPDATE `eh_locale_strings` SET `text`='浣犵殑璐﹀彿宸插湪鍙︿竴鍙拌澶囩櫥褰曪紝浣犺杩笅绾匡紝鑻ラ潪鏈汉鎿嶄綔锛岃绔嬪嵆淇敼瀵嗙爜銆? WHERE `scope`='user' AND `code`='100018' AND `locale`='zh_CN';
