...
ALTER TABLE `eh_groups` ADD COLUMN `community_id` BIGINT NOT NULL DEFAULT 0 COMMENT 'the id of community where the creator located when the group is created';
