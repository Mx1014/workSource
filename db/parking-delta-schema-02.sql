...
ADD COLUMN `initiate_price` DECIMAL(10,2) NULL,
ADD COLUMN `org_member_initiate_price` DECIMAL(10,2) NULL,
ADD COLUMN `approving_user_initiate_price` DECIMAL(10,2) NULL;
