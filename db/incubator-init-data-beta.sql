INSERT INTO `eh_acls` (`id`, `owner_type`, `owner_id`, `grant_type`, `privilege_id`, `role_id`, `order_seq`, `creator_uid`, `create_time`, `namespace_id`, `role_type`, `scope`) 
	VALUES (23759,'EhOrganizations',1039090,1,10,414688,0,1,UTC_TIMESTAMP(),999964,'EhUsers','admin');

INSERT INTO `eh_acl_role_assignments` (id, owner_type, owner_id, target_type, target_id, role_id, creator_uid, create_time) 
	VALUES (114860,'EhOrganizations',1039090,'EhUsers',414688,1001,1,UTC_TIMESTAMP());
...
INSERT INTO `eh_activity_categories` (`id`, `owner_type`, `owner_id`, `entry_id`, `parent_id`, `name`, `path`, `default_order`, `status`, `creator_uid`, `create_time`, `delete_uid`, `delete_time`, `namespace_id`, `default_flag`, `enabled`, `icon_uri`, `selected_icon_uri`, `show_name`, `all_flag`) 
	VALUES (1001100,'',0,0,-1,'论坛','/0',0,2,1,NOW(),0,NULL,999964,0,1,NULL,NULL,NULL,0);
INSERT INTO `eh_activity_categories` (`id`, `owner_type`, `owner_id`, `entry_id`, `parent_id`, `name`, `path`, `default_order`, `status`, `creator_uid`, `create_time`, `delete_uid`, `delete_time`, `namespace_id`, `default_flag`, `enabled`, `icon_uri`, `selected_icon_uri`, `show_name`, `all_flag`) 
	VALUES (1001101,'',0,1,-1,'活动管理','/1',0,2,1,NOW(),0,NULL,999964,0,1,NULL,NULL,NULL,0);
INSERT INTO `eh_activity_categories` (`id`, `owner_type`, `owner_id`, `entry_id`, `parent_id`, `name`, `path`, `default_order`, `status`, `creator_uid`, `create_time`, `delete_uid`, `delete_time`, `namespace_id`, `default_flag`, `enabled`, `icon_uri`, `selected_icon_uri`, `show_name`, `all_flag`) 
	VALUES (1001102,'',0,1001102,1,'活动管理-默认子分类','/1/1001102',0,2,1,NOW(),0,NULL,999964,0,1,NULL,NULL,NULL,1);
INSERT INTO `eh_activity_categories` (`id`, `owner_type`, `owner_id`, `entry_id`, `parent_id`, `name`, `path`, `default_order`, `status`, `creator_uid`, `create_time`, `delete_uid`, `delete_time`, `namespace_id`, `default_flag`, `enabled`, `icon_uri`, `selected_icon_uri`, `show_name`, `all_flag`) 
	VALUES (1001103,'',0,2,-1,'活动管理二','/2',0,2,1,NOW(),0,NULL,999964,0,1,NULL,NULL,NULL,0);
INSERT INTO `eh_activity_categories` (`id`, `owner_type`, `owner_id`, `entry_id`, `parent_id`, `name`, `path`, `default_order`, `status`, `creator_uid`, `create_time`, `delete_uid`, `delete_time`, `namespace_id`, `default_flag`, `enabled`, `icon_uri`, `selected_icon_uri`, `show_name`, `all_flag`) 
	VALUES (1001104,'',0,1001104,2,'活动管理二-默认子分类','/2/1001104',0,2,1,NOW(),0,NULL,999964,0,1,NULL,NULL,NULL,1);
INSERT INTO `eh_activity_categories` (`id`, `owner_type`, `owner_id`, `entry_id`, `parent_id`, `name`, `path`, `default_order`, `status`, `creator_uid`, `create_time`, `delete_uid`, `delete_time`, `namespace_id`, `default_flag`, `enabled`, `icon_uri`, `selected_icon_uri`, `show_name`, `all_flag`) 
	VALUES (1001105,'',0,3,-1,'活动管理三','/3',0,2,1,NOW(),0,NULL,999964,0,1,NULL,NULL,NULL,0);
INSERT INTO `eh_activity_categories` (`id`, `owner_type`, `owner_id`, `entry_id`, `parent_id`, `name`, `path`, `default_order`, `status`, `creator_uid`, `create_time`, `delete_uid`, `delete_time`, `namespace_id`, `default_flag`, `enabled`, `icon_uri`, `selected_icon_uri`, `show_name`, `all_flag`) 
	VALUES (1001106,'',0,1001106,3,'活动管理三-默认子分类','/3/1001106',0,2,1,NOW(),0,NULL,999964,0,1,NULL,NULL,NULL,1);
...
INSERT INTO `eh_addresses` (`id`, `uuid`, `community_id`, `city_id`, `city_name`, `area_id`, `area_name`, `address`, `building_name`, `apartment_name`, `status`, `operator_uid`, `create_time`, `namespace_id`, `area_size`) 
	VALUES (239825274387458996,UUID(),240111044332059971,18310,'成都市',18311,'武侯区','创业场-1','创业场','1','2','0',UTC_TIMESTAMP(),999964,35000.0);
...
INSERT INTO `eh_buildings` (`id`, `community_id`, `name`, `alias_name`, `manager_uid`, `contact`, `address`, `area_size`, `longitude`, `latitude`, `geohash`, `description`, `poster_uri`, `status`, `operator_uid`, `operate_time`, `creator_uid`, `create_time`, `namespace_id`, default_order) 
	VALUES (1970704,240111044332059971,'创业场','创业场',0,18981182106,'四川省成都市天府大道南段天府软件园D区',35000.0,'104.081476','30.545423','wm6jb2tgfpt9','',NULL,2,0,NULL,1,NOW(),999964,1);
...
INSERT INTO `eh_communities` (`id`, `uuid`, `city_id`, `city_name`, `area_id`, `area_name`, `name`, `alias_name`, `address`, `description`, `apt_count`, `creator_uid`, `status`, `create_time`, `community_type`, `default_forum_id`, `feedback_forum_id`, `update_time`, `namespace_id`) 
	VALUES (240111044332059971,UUID(),18310,'成都市',18311,'武侯区','创业场','创业场','四川省成都市天府软件园D区','创业场现有孵化场地3.5万平方米，累计孵化项目1000余个，现孵化团队250家。目前，已建成“创业苗圃-孵化器-加速器-产业园”的多层级孵化模式，提供包括孵化工位、联合创业空间、独立空间等多形式众创空间，形成覆盖资金、人才、圈子、市场、创业辅导等方面的全方位“5C”培育计划。 截止目前，创业场已成功孵化Tap4fun、Camera360、TestBird、咕咚、狮之吼（LionMobi）、极米、物流QQ(货车帮)、医联(Medlinker)、麦子学院、鲁大师等众多国内外领先的企业和手机应用，以及银河帝国、王者帝国、斯巴达战争、三剑豪、帝国塔防3、花千骨、忍者萌剑传、战地风暴等月流水过千万的手机游戏产品。',0,1,2,UTC_TIMESTAMP(),1,192550,192551,UTC_TIMESTAMP(),999964);

INSERT INTO `eh_community_geopoints` (`id`, `community_id`, `description`, `longitude`, `latitude`, `geohash`) 
	VALUES (240111044331092742,240111044332059971,'',104.081476,30.545423,'wm6jb2tgfpt9');

INSERT INTO `eh_configurations` ( `id`, `name`, `value`, `description`, `namespace_id`, `display_name` ) 
	VALUES (1826,'app.agreements.url','https://beta.zuolin.com/mobile/static/app_agreements/agreements.html?ns=999964','the relative path for chuangyechang app agreements',999964,NULL);
INSERT INTO `eh_configurations` ( `id`, `name`, `value`, `description`, `namespace_id`, `display_name` ) 
	VALUES (1827,'business.url','https://biz-beta.zuolin.com/zl-ec/rest/service/front/logon?hideNavigationBar=1&sourceUrl=https%3A%2F%2Fbiz-beta.zuolin.com%2Fnar%2Fbiz%2Fweb%2Fapp%2Fuser%2Findex.html%23%2Fmicroshop%2Fhome%3F_k%3Dzlbiz#sign_suffix','biz access url for changfazhan',999964,NULL);
INSERT INTO `eh_configurations` ( `id`, `name`, `value`, `description`, `namespace_id`, `display_name` ) 
	VALUES (1828,'pmtask.handler-999964','flow','0',999964,'物业报修工作流');

INSERT INTO `eh_forums` (`id`, `uuid`, `namespace_id`, `app_id`, `owner_type`, `owner_id`, `name`, `description`, `post_count`, `modify_seq`, `update_time`, `create_time`) 
	VALUES (192549,UUID(),999964,2,'EhGroups',1057270,'成都天府软件园有限公司论坛',NULL,'0','0',UTC_TIMESTAMP(),UTC_TIMESTAMP());
INSERT INTO `eh_forums` (`id`, `uuid`, `namespace_id`, `app_id`, `owner_type`, `owner_id`, `name`, `description`, `post_count`, `modify_seq`, `update_time`, `create_time`) 
	VALUES (192550,UUID(),999964,2,'',0,'创业场社区论坛',NULL,'0','0',UTC_TIMESTAMP(),UTC_TIMESTAMP());
INSERT INTO `eh_forums` (`id`, `uuid`, `namespace_id`, `app_id`, `owner_type`, `owner_id`, `name`, `description`, `post_count`, `modify_seq`, `update_time`, `create_time`) 
	VALUES (192551,UUID(),999964,2,'',0,'创业场意见反馈论坛',NULL,'0','0',UTC_TIMESTAMP(),UTC_TIMESTAMP());

INSERT INTO `eh_groups` (`id`, `uuid`, `name`, `display_name`, `status`, `visible_region_type`, `visible_region_id`,`discriminator`, `private_flag`, `join_policy`, `update_time`, `create_time`, `integral_tag4`, `creator_uid`, `namespace_id`) 
	VALUES (1057270,UUID(),'成都天府软件园有限公司','成都天府软件园有限公司',1,1,1039090,'enterprise',1,1,UTC_TIMESTAMP(),UTC_TIMESTAMP(),192549,1,999964);

INSERT INTO `eh_locale_templates` (`id`, `scope`, `code`, `locale`, `description`, `text`, `namespace_id`) 
	VALUES (788,'sms.default.sign',0,'zh_CN','创业场','【创业场】',999964);

INSERT INTO `eh_namespaces` (`id`, `name`) 
	VALUES (999964,'创业场');

INSERT INTO `eh_namespace_details` (`id`, `namespace_id`, `resource_type`, `create_time`) 
	VALUES (1389,999964,'community_commercial',UTC_TIMESTAMP());

INSERT INTO `eh_namespace_resources` (`id`, `namespace_id`, `resource_type`, `resource_id`, `create_time`) 
	VALUES (20083,999964,'COMMUNITY',240111044332059971,UTC_TIMESTAMP());
...
INSERT INTO `eh_organizations` (`id`, `parent_id`, `organization_type`, `name`, `description`, `path`, `level`, `status`, `group_type`, `namespace_id`, `group_id`) 
	VALUES (1039090,0,'PM','成都天府软件园有限公司','创业场现有孵化场地3.5万平方米，累计孵化项目1000余个，现孵化团队250家。目前，已建成“创业苗圃-孵化器-加速器-产业园”的多层级孵化模式，提供包括孵化工位、联合创业空间、独立空间等多形式众创空间，形成覆盖资金、人才、圈子、市场、创业辅导等方面的全方位“5C”培育计划。 截止目前，创业场已成功孵化Tap4fun、Camera360、TestBird、咕咚、狮之吼（LionMobi）、极米、物流QQ(货车帮)、医联(Medlinker)、麦子学院、鲁大师等众多国内外领先的企业和手机应用，以及银河帝国、王者帝国、斯巴达战争、三剑豪、帝国塔防3、花千骨、忍者萌剑传、战地风暴等月流水过千万的手机游戏产品。','/1039090',1,2,'ENTERPRISE',999964,1057270);

INSERT INTO `eh_organization_address_mappings` (`id`, `organization_id`, `community_id`, `address_id`, `organization_address`, `living_status`) 
	VALUES (82328,1039090,240111044332059971,239825274387458996,'创业场-1',2);

INSERT INTO `eh_organization_community_requests` (id, community_id, member_type, member_id, member_status, creator_uid, create_time) 
	VALUES (1153723,240111044332059971,'organization',1039090,3,0,UTC_TIMESTAMP());
...
INSERT INTO `eh_organization_members` (id, organization_id, target_type, target_id, member_group, contact_name, contact_type, contact_token, status, `namespace_id`) 
	VALUES (999992126991,1039090,'USER',414688,'manager','李杨',0,'18981182106',3,999964);
...
INSERT INTO `eh_organization_member_details` (`id`, `organization_id`, `target_type`, `target_id`, `contact_name`, `contact_type`, `contact_token`, `check_in_time`, `namespace_id`) 
	VALUES (24572,1039090,'USER',414688,'李杨',0,'18981182106',UTC_TIMESTAMP(),999964);
...
INSERT INTO `eh_users` (`id`,  `uuid`,  `account_name`,  `nick_name`, `avatar`, `status`, `points`, `level`, `gender`, `locale`, `salt`, `password_hash`, `create_time`, `namespace_id`) 
	VALUES (414688,UUID(),'19171933104','李杨',NULL,1,45,'1','1','zh_CN','6edb25b3f8332dfa5628db1fc9ea7181','50fe56e5d68ad886f11827d486b386462d043a3b46700790b58d86ae91d1e5ca',UTC_TIMESTAMP(),999964);

INSERT INTO `eh_user_identifiers` (`id`,  `owner_uid`,  `identifier_type`,  `identifier_token`,  `verification_code`,  `claim_status`, `create_time`, `namespace_id`) 
	VALUES (386692,414688,0,'18981182106',NULL,3,UTC_TIMESTAMP(),999964);
...
INSERT INTO `eh_user_organizations` (`id`, `user_id`, `organization_id`, `group_path`, `group_type`, `status`, `namespace_id`, `create_time`, `visible_flag`, `update_time`) 
	VALUES (25049,414688,1039090,'/1039090','ENTERPRISE',3,999964,UTC_TIMESTAMP(),0,UTC_TIMESTAMP());

INSERT INTO `eh_version_realm` (  `id`, `realm`, `description`, `create_time`, `namespace_id` ) 
	VALUES (381,'Android_ChuangYeChang',NULL,UTC_TIMESTAMP(),999964);
INSERT INTO `eh_version_realm` (  `id`, `realm`, `description`, `create_time`, `namespace_id` ) 
	VALUES (382,'iOS_ChuangYeChang',NULL,UTC_TIMESTAMP(),999964);
...
INSERT INTO `eh_version_upgrade_rules` (`id`, `realm_id`, `matching_lower_bound`, `matching_upper_bound`, `order`, `target_version`, `force_upgrade`, `create_time`) 
	VALUES (675,381,'-0.1','1048576','0','1.0.0','0',UTC_TIMESTAMP());
INSERT INTO `eh_version_upgrade_rules` (`id`, `realm_id`, `matching_lower_bound`, `matching_upper_bound`, `order`, `target_version`, `force_upgrade`, `create_time`) 
