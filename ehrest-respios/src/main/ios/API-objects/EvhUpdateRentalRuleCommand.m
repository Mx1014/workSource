//
// EvhUpdateRentalRuleCommand.m
//
#import "EvhUpdateRentalRuleCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUpdateRentalRuleCommand
//

@implementation EvhUpdateRentalRuleCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateRentalRuleCommand* obj = [EvhUpdateRentalRuleCommand new];
