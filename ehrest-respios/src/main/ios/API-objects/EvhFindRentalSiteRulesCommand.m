//
// EvhFindRentalSiteRulesCommand.m
//
#import "EvhFindRentalSiteRulesCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhFindRentalSiteRulesCommand
//

@implementation EvhFindRentalSiteRulesCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFindRentalSiteRulesCommand* obj = [EvhFindRentalSiteRulesCommand new];
