//
// EvhListRecipientCommand.m
//
#import "EvhListRecipientCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListRecipientCommand
//

@implementation EvhListRecipientCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListRecipientCommand* obj = [EvhListRecipientCommand new];
