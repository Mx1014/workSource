//
// EvhRentalv2DeleteRentalSiteRulesCommand.m
//
#import "EvhRentalv2DeleteRentalSiteRulesCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2DeleteRentalSiteRulesCommand
//

@implementation EvhRentalv2DeleteRentalSiteRulesCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2DeleteRentalSiteRulesCommand* obj = [EvhRentalv2DeleteRentalSiteRulesCommand new];
