//
// EvhRentalv2UpdateRentalSiteCommand.m
//
#import "EvhRentalv2UpdateRentalSiteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2UpdateRentalSiteCommand
//

@implementation EvhRentalv2UpdateRentalSiteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2UpdateRentalSiteCommand* obj = [EvhRentalv2UpdateRentalSiteCommand new];
