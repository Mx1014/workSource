//
// EvhUserExitOrganizationCommand.m
//
#import "EvhUserExitOrganizationCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUserExitOrganizationCommand
//

@implementation EvhUserExitOrganizationCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUserExitOrganizationCommand* obj = [EvhUserExitOrganizationCommand new];
