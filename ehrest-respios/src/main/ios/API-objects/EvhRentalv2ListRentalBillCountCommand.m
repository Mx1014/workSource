//
// EvhRentalv2ListRentalBillCountCommand.m
//
#import "EvhRentalv2ListRentalBillCountCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2ListRentalBillCountCommand
//

@implementation EvhRentalv2ListRentalBillCountCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2ListRentalBillCountCommand* obj = [EvhRentalv2ListRentalBillCountCommand new];
