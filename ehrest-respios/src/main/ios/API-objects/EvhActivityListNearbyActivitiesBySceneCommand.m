//
// EvhActivityListNearbyActivitiesBySceneCommand.m
//
#import "EvhActivityListNearbyActivitiesBySceneCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhActivityListNearbyActivitiesBySceneCommand
//

@implementation EvhActivityListNearbyActivitiesBySceneCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhActivityListNearbyActivitiesBySceneCommand* obj = [EvhActivityListNearbyActivitiesBySceneCommand new];
