//
// EvhCreateLaunchPadLayoutCommand.m
//
#import "EvhCreateLaunchPadLayoutCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCreateLaunchPadLayoutCommand
//

@implementation EvhCreateLaunchPadLayoutCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCreateLaunchPadLayoutCommand* obj = [EvhCreateLaunchPadLayoutCommand new];
