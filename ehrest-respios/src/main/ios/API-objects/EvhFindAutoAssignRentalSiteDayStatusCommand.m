//
// EvhFindAutoAssignRentalSiteDayStatusCommand.m
//
#import "EvhFindAutoAssignRentalSiteDayStatusCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhFindAutoAssignRentalSiteDayStatusCommand
//

@implementation EvhFindAutoAssignRentalSiteDayStatusCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFindAutoAssignRentalSiteDayStatusCommand* obj = [EvhFindAutoAssignRentalSiteDayStatusCommand new];
