//
// EvhAddressListUnassignedApartmentsByBuildingNameRestResponse.m
//
#import "EvhAddressListUnassignedApartmentsByBuildingNameRestResponse.h"
...
@implementation EvhAddressListUnassignedApartmentsByBuildingNameRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAddressListUnassignedApartmentsByBuildingNameRestResponse* obj = [EvhAddressListUnassignedApartmentsByBuildingNameRestResponse new];
