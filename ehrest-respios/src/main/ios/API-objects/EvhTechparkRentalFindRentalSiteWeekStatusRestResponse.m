...
@implementation EvhTechparkRentalFindRentalSiteWeekStatusRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhTechparkRentalFindRentalSiteWeekStatusRestResponse* obj = [EvhTechparkRentalFindRentalSiteWeekStatusRestResponse new];
