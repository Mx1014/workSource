...
@implementation EvhAdminTechparkParkSearchApplyCardListRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminTechparkParkSearchApplyCardListRestResponse* obj = [EvhAdminTechparkParkSearchApplyCardListRestResponse new];
