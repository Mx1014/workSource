//
// EvhCancelUserFavoriteCommand.m
// generated at 2016-04-18 14:48:51 
//
#import "EvhCancelUserFavoriteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCancelUserFavoriteCommand
//

@implementation EvhCancelUserFavoriteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCancelUserFavoriteCommand* obj = [EvhCancelUserFavoriteCommand new];
