...
@implementation EvhListBillTxByAddressIdCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListBillTxByAddressIdCommandResponse* obj = [EvhListBillTxByAddressIdCommandResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.requests) {
        ...
        for(EvhFamilyBillingTransactionDTO* item in self.requests) {
