//
// EvhListTopicAssignedScopeCommand.m
//
#import "EvhListTopicAssignedScopeCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListTopicAssignedScopeCommand
//

@implementation EvhListTopicAssignedScopeCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListTopicAssignedScopeCommand* obj = [EvhListTopicAssignedScopeCommand new];
