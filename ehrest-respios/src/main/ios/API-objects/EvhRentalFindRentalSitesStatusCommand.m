//
// EvhRentalFindRentalSitesStatusCommand.m
//
#import "EvhRentalFindRentalSitesStatusCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalFindRentalSitesStatusCommand
//

@implementation EvhRentalFindRentalSitesStatusCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalFindRentalSitesStatusCommand* obj = [EvhRentalFindRentalSitesStatusCommand new];
