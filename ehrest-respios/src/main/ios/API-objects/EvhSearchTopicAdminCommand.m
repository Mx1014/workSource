//
// EvhSearchTopicAdminCommand.m
// generated at 2016-03-31 20:15:23 
//
#import "EvhSearchTopicAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhSearchTopicAdminCommand
//

@implementation EvhSearchTopicAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhSearchTopicAdminCommand* obj = [EvhSearchTopicAdminCommand new];
