//
// EvhGetRentalTypeRuleCommand.m
//
#import "EvhGetRentalTypeRuleCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetRentalTypeRuleCommand
//

@implementation EvhGetRentalTypeRuleCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetRentalTypeRuleCommand* obj = [EvhGetRentalTypeRuleCommand new];
