//
// EvhApproveCommunityAdminCommand.m
//
#import "EvhApproveCommunityAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhApproveCommunityAdminCommand
//

@implementation EvhApproveCommunityAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhApproveCommunityAdminCommand* obj = [EvhApproveCommunityAdminCommand new];
