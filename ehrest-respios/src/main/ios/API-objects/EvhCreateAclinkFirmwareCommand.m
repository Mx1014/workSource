//
// EvhCreateAclinkFirmwareCommand.m
//
#import "EvhCreateAclinkFirmwareCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCreateAclinkFirmwareCommand
//

@implementation EvhCreateAclinkFirmwareCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCreateAclinkFirmwareCommand* obj = [EvhCreateAclinkFirmwareCommand new];
