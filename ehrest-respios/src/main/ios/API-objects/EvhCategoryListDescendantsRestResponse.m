//
// EvhCategoryListDescendantsRestResponse.m
//
#import "EvhCategoryListDescendantsRestResponse.h"
...
@implementation EvhCategoryListDescendantsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCategoryListDescendantsRestResponse* obj = [EvhCategoryListDescendantsRestResponse new];
