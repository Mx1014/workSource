//
// EvhOrgListEnterprisesRestResponse.m
//
#import "EvhOrgListEnterprisesRestResponse.h"
...
@implementation EvhOrgListEnterprisesRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOrgListEnterprisesRestResponse* obj = [EvhOrgListEnterprisesRestResponse new];
