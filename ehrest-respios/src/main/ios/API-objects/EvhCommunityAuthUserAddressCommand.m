//
// EvhCommunityAuthUserAddressCommand.m
//
#import "EvhCommunityAuthUserAddressCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCommunityAuthUserAddressCommand
//

@implementation EvhCommunityAuthUserAddressCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCommunityAuthUserAddressCommand* obj = [EvhCommunityAuthUserAddressCommand new];
