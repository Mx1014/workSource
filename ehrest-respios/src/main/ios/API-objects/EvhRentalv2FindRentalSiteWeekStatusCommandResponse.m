//
// EvhRentalv2FindRentalSiteWeekStatusCommandResponse.m
//
...
@implementation EvhRentalv2FindRentalSiteWeekStatusCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2FindRentalSiteWeekStatusCommandResponse* obj = [EvhRentalv2FindRentalSiteWeekStatusCommandResponse new];
