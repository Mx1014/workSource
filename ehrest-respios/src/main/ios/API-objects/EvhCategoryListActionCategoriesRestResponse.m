//
// EvhCategoryListActionCategoriesRestResponse.m
//
#import "EvhCategoryListActionCategoriesRestResponse.h"
...
@implementation EvhCategoryListActionCategoriesRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCategoryListActionCategoriesRestResponse* obj = [EvhCategoryListActionCategoriesRestResponse new];
