...
@implementation EvhContactCreateContactByPhoneCommandRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhContactCreateContactByPhoneCommandRestResponse* obj = [EvhContactCreateContactByPhoneCommandRestResponse new];
