...
@implementation EvhPmFindNewestBillByAddressIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhPmFindNewestBillByAddressIdRestResponse* obj = [EvhPmFindNewestBillByAddressIdRestResponse new];
