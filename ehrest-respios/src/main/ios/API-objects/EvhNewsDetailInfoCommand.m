//
// EvhNewsDetailInfoCommand.m
//
#import "EvhNewsDetailInfoCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhNewsDetailInfoCommand
//

@implementation EvhNewsDetailInfoCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhNewsDetailInfoCommand* obj = [EvhNewsDetailInfoCommand new];
