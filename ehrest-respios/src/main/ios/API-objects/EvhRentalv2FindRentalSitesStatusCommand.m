//
// EvhRentalv2FindRentalSitesStatusCommand.m
//
#import "EvhRentalv2FindRentalSitesStatusCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2FindRentalSitesStatusCommand
//

@implementation EvhRentalv2FindRentalSitesStatusCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2FindRentalSitesStatusCommand* obj = [EvhRentalv2FindRentalSitesStatusCommand new];
