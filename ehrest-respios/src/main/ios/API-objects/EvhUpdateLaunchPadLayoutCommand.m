//
// EvhUpdateLaunchPadLayoutCommand.m
//
#import "EvhUpdateLaunchPadLayoutCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUpdateLaunchPadLayoutCommand
//

@implementation EvhUpdateLaunchPadLayoutCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateLaunchPadLayoutCommand* obj = [EvhUpdateLaunchPadLayoutCommand new];
