//
// EvhDeleteLaunchPadLayoutCommand.m
//
#import "EvhDeleteLaunchPadLayoutCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhDeleteLaunchPadLayoutCommand
//

@implementation EvhDeleteLaunchPadLayoutCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhDeleteLaunchPadLayoutCommand* obj = [EvhDeleteLaunchPadLayoutCommand new];
