...
@implementation EvhUiUserSetCurrentCommunityForSceneRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUiUserSetCurrentCommunityForSceneRestResponse* obj = [EvhUiUserSetCurrentCommunityForSceneRestResponse new];
