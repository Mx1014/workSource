//
// EvhAddUserFavoriteCommand.m
// generated at 2016-03-31 13:49:12 
//
#import "EvhAddUserFavoriteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhAddUserFavoriteCommand
//

@implementation EvhAddUserFavoriteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAddUserFavoriteCommand* obj = [EvhAddUserFavoriteCommand new];
