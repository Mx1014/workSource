//
// EvhUiBannerGetBannersBySceneRestResponse.m
//
#import "EvhUiBannerGetBannersBySceneRestResponse.h"
...
@implementation EvhUiBannerGetBannersBySceneRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUiBannerGetBannersBySceneRestResponse* obj = [EvhUiBannerGetBannersBySceneRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhBannerDTO* item in self.response) {
