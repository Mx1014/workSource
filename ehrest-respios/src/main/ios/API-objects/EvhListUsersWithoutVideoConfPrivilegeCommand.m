//
// EvhListUsersWithoutVideoConfPrivilegeCommand.m
//
#import "EvhListUsersWithoutVideoConfPrivilegeCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListUsersWithoutVideoConfPrivilegeCommand
//

@implementation EvhListUsersWithoutVideoConfPrivilegeCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListUsersWithoutVideoConfPrivilegeCommand* obj = [EvhListUsersWithoutVideoConfPrivilegeCommand new];
