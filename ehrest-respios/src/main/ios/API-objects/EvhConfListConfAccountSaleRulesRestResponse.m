...
@implementation EvhConfListConfAccountSaleRulesRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhConfListConfAccountSaleRulesRestResponse* obj = [EvhConfListConfAccountSaleRulesRestResponse new];
