//
// EvhDeleteCommentCommand.m
//
#import "EvhDeleteCommentCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhDeleteCommentCommand
//

@implementation EvhDeleteCommentCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhDeleteCommentCommand* obj = [EvhDeleteCommentCommand new];
