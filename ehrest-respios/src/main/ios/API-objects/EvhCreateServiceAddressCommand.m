//
// EvhCreateServiceAddressCommand.m
// generated at 2016-03-31 20:15:32 
//
#import "EvhCreateServiceAddressCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCreateServiceAddressCommand
//

@implementation EvhCreateServiceAddressCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCreateServiceAddressCommand* obj = [EvhCreateServiceAddressCommand new];
