//
// EvhRentalIncompleteBillCommand.m
//
#import "EvhRentalIncompleteBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalIncompleteBillCommand
//

@implementation EvhRentalIncompleteBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalIncompleteBillCommand* obj = [EvhRentalIncompleteBillCommand new];
