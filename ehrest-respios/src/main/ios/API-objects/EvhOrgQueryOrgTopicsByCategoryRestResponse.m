...
@implementation EvhOrgQueryOrgTopicsByCategoryRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOrgQueryOrgTopicsByCategoryRestResponse* obj = [EvhOrgQueryOrgTopicsByCategoryRestResponse new];
