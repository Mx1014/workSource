//
// EvhCategoryListAllCategoriesRestResponse.m
//
#import "EvhCategoryListAllCategoriesRestResponse.h"
...
@implementation EvhCategoryListAllCategoriesRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCategoryListAllCategoriesRestResponse* obj = [EvhCategoryListAllCategoriesRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhCategoryDTO* item in self.response) {
