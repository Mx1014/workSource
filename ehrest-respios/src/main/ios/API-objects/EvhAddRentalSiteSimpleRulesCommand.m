...
///////////////////////////////////////////////////////////////////////////////
// EvhAddRentalSiteSimpleRulesCommand
//

@implementation EvhAddRentalSiteSimpleRulesCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAddRentalSiteSimpleRulesCommand* obj = [EvhAddRentalSiteSimpleRulesCommand new];
...
-(id) init 
{
    self = [super init];
    if(self) {
        _timeInterval = [NSMutableArray new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.timeInterval) {
        ...
        for(EvhTimeInterval* item in self.timeInterval) {
            NSMutableDictionary* dic = [NSMutableDictionary new];
            [item toJson:dic];
            [jsonArray addObject:dic];
        }
        [jsonObject setObject: jsonArray forKey: @"timeInterval"];
    }
    if(self.counts)
...
-(id<EvhJsonSerializable>) fromJson: (id) jsonObject 
{
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
        ...
        {
            NSArray* jsonArray = [jsonObject objectForKey: @"timeInterval"];
            for(id itemJson in jsonArray) {
                EvhTimeInterval* item = [EvhTimeInterval new];
                
                [item fromJson: itemJson];
                [self.timeInterval addObject: item];
            }
        }
