//
// EvhCreateOrganizationMemberCommand.m
//
#import "EvhCreateOrganizationMemberCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCreateOrganizationMemberCommand
//

@implementation EvhCreateOrganizationMemberCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCreateOrganizationMemberCommand* obj = [EvhCreateOrganizationMemberCommand new];
