...
@implementation EvhFindRentalSiteMonthStatusCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFindRentalSiteMonthStatusCommandResponse* obj = [EvhFindRentalSiteMonthStatusCommandResponse new];
