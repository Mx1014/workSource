//
// EvhListAddressByKeywordCommand.m
//
#import "EvhListAddressByKeywordCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListAddressByKeywordCommand
//

@implementation EvhListAddressByKeywordCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListAddressByKeywordCommand* obj = [EvhListAddressByKeywordCommand new];
