//
// EvhAdminCommunityGetNearbyCommunitiesByIdRestResponse.m
//
#import "EvhAdminCommunityGetNearbyCommunitiesByIdRestResponse.h"
...
@implementation EvhAdminCommunityGetNearbyCommunitiesByIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminCommunityGetNearbyCommunitiesByIdRestResponse* obj = [EvhAdminCommunityGetNearbyCommunitiesByIdRestResponse new];
