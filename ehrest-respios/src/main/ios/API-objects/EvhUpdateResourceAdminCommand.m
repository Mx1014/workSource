//
// EvhUpdateResourceAdminCommand.m
//
#import "EvhUpdateResourceAdminCommand.h"
...
@implementation EvhUpdateResourceAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateResourceAdminCommand* obj = [EvhUpdateResourceAdminCommand new];
