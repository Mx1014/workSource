//
// EvhListBusinessByKeywordCommand.m
//
#import "EvhListBusinessByKeywordCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListBusinessByKeywordCommand
//

@implementation EvhListBusinessByKeywordCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListBusinessByKeywordCommand* obj = [EvhListBusinessByKeywordCommand new];
