//
// EvhSetVideoConfAccountPreferentialRuleCommand.m
//
#import "EvhSetVideoConfAccountPreferentialRuleCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhSetVideoConfAccountPreferentialRuleCommand
//

@implementation EvhSetVideoConfAccountPreferentialRuleCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhSetVideoConfAccountPreferentialRuleCommand* obj = [EvhSetVideoConfAccountPreferentialRuleCommand new];
