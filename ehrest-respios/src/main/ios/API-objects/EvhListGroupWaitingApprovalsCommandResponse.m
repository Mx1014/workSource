//
// EvhListGroupWaitingApprovalsCommandResponse.m
//
...
@implementation EvhListGroupWaitingApprovalsCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListGroupWaitingApprovalsCommandResponse* obj = [EvhListGroupWaitingApprovalsCommandResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.requests) {
        ...
        for(EvhGroupMemberDTO* item in self.requests) {
