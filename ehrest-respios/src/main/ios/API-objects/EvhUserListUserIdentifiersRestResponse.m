...
@implementation EvhUserListUserIdentifiersRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUserListUserIdentifiersRestResponse* obj = [EvhUserListUserIdentifiersRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhUserIdentifierDTO* item in self.response) {
