//
// EvhGetUserEnterpriseContactCommand.m
//
#import "EvhGetUserEnterpriseContactCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetUserEnterpriseContactCommand
//

@implementation EvhGetUserEnterpriseContactCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetUserEnterpriseContactCommand* obj = [EvhGetUserEnterpriseContactCommand new];
