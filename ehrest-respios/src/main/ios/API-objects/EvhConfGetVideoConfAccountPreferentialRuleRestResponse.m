...
@implementation EvhConfGetVideoConfAccountPreferentialRuleRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhConfGetVideoConfAccountPreferentialRuleRestResponse* obj = [EvhConfGetVideoConfAccountPreferentialRuleRestResponse new];
