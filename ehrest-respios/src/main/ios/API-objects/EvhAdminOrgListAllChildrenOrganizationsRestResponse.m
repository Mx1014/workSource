//
// EvhAdminOrgListAllChildrenOrganizationsRestResponse.m
//
#import "EvhAdminOrgListAllChildrenOrganizationsRestResponse.h"
...
@implementation EvhAdminOrgListAllChildrenOrganizationsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminOrgListAllChildrenOrganizationsRestResponse* obj = [EvhAdminOrgListAllChildrenOrganizationsRestResponse new];
