...
@implementation EvhOpenapiListUserByIdentifierRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOpenapiListUserByIdentifierRestResponse* obj = [EvhOpenapiListUserByIdentifierRestResponse new];
