//
// EvhCreateContactByPhoneCommand.m
//
#import "EvhCreateContactByPhoneCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCreateContactByPhoneCommand
//

@implementation EvhCreateContactByPhoneCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCreateContactByPhoneCommand* obj = [EvhCreateContactByPhoneCommand new];
