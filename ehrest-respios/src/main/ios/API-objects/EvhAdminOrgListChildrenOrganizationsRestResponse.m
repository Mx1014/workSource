...
@implementation EvhAdminOrgListChildrenOrganizationsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminOrgListChildrenOrganizationsRestResponse* obj = [EvhAdminOrgListChildrenOrganizationsRestResponse new];
