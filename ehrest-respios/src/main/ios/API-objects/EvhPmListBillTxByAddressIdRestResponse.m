...
@implementation EvhPmListBillTxByAddressIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhPmListBillTxByAddressIdRestResponse* obj = [EvhPmListBillTxByAddressIdRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhFamilyBillingTransactionDTO* item in self.response) {
