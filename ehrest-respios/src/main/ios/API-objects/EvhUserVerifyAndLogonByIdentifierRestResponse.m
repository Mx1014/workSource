...
@implementation EvhUserVerifyAndLogonByIdentifierRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUserVerifyAndLogonByIdentifierRestResponse* obj = [EvhUserVerifyAndLogonByIdentifierRestResponse new];
