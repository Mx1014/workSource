//
// EvhQueryPropTopicByCategoryCommand.m
// generated at 2016-03-31 20:15:24 
//
#import "EvhQueryPropTopicByCategoryCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhQueryPropTopicByCategoryCommand
//

@implementation EvhQueryPropTopicByCategoryCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhQueryPropTopicByCategoryCommand* obj = [EvhQueryPropTopicByCategoryCommand new];
