...
@implementation EvhQualityGetGroupMembersRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhQualityGetGroupMembersRestResponse* obj = [EvhQualityGetGroupMembersRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhGroupUserDTO* item in self.response) {
