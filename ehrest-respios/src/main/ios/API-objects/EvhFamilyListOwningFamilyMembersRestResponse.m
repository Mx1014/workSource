//
// EvhFamilyListOwningFamilyMembersRestResponse.m
//
#import "EvhFamilyListOwningFamilyMembersRestResponse.h"
...
@implementation EvhFamilyListOwningFamilyMembersRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFamilyListOwningFamilyMembersRestResponse* obj = [EvhFamilyListOwningFamilyMembersRestResponse new];
