//
// EvhGetNewsContentCommand.m
//
#import "EvhGetNewsContentCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetNewsContentCommand
//

@implementation EvhGetNewsContentCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetNewsContentCommand* obj = [EvhGetNewsContentCommand new];
