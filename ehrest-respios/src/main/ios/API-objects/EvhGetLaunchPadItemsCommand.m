//
// EvhGetLaunchPadItemsCommand.m
// generated at 2016-03-31 20:15:26 
//
#import "EvhGetLaunchPadItemsCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetLaunchPadItemsCommand
//

@implementation EvhGetLaunchPadItemsCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetLaunchPadItemsCommand* obj = [EvhGetLaunchPadItemsCommand new];
