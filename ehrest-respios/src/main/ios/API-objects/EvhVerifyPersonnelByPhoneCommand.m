//
// EvhVerifyPersonnelByPhoneCommand.m
//
#import "EvhVerifyPersonnelByPhoneCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhVerifyPersonnelByPhoneCommand
//

@implementation EvhVerifyPersonnelByPhoneCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhVerifyPersonnelByPhoneCommand* obj = [EvhVerifyPersonnelByPhoneCommand new];
