//
// EvhAddPersistServerCommand.m
//
#import "EvhAddPersistServerCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhAddPersistServerCommand
//

@implementation EvhAddPersistServerCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAddPersistServerCommand* obj = [EvhAddPersistServerCommand new];
