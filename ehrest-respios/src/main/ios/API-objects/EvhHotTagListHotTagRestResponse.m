//
// EvhHotTagListHotTagRestResponse.m
//
#import "EvhHotTagListHotTagRestResponse.h"
#import "EvhTagDTO.h"
...
@implementation EvhHotTagListHotTagRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhHotTagListHotTagRestResponse* obj = [EvhHotTagListHotTagRestResponse new];
