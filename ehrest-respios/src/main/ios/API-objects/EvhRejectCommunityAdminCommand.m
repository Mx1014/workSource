//
// EvhRejectCommunityAdminCommand.m
//
#import "EvhRejectCommunityAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRejectCommunityAdminCommand
//

@implementation EvhRejectCommunityAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRejectCommunityAdminCommand* obj = [EvhRejectCommunityAdminCommand new];
