//
// EvhOpenapiGetCommunitiesByNameAndCityIdRestResponse.m
//
#import "EvhOpenapiGetCommunitiesByNameAndCityIdRestResponse.h"
...
@implementation EvhOpenapiGetCommunitiesByNameAndCityIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOpenapiGetCommunitiesByNameAndCityIdRestResponse* obj = [EvhOpenapiGetCommunitiesByNameAndCityIdRestResponse new];
