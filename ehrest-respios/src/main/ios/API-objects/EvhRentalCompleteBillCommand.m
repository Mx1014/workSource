//
// EvhRentalCompleteBillCommand.m
//
#import "EvhRentalCompleteBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalCompleteBillCommand
//

@implementation EvhRentalCompleteBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalCompleteBillCommand* obj = [EvhRentalCompleteBillCommand new];
