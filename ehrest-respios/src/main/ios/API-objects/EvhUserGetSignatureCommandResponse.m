//
// EvhUserGetSignatureCommandResponse.m
//
...
@implementation EvhUserGetSignatureCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUserGetSignatureCommandResponse* obj = [EvhUserGetSignatureCommandResponse new];
