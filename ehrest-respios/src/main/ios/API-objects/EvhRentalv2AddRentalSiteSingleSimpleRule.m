//
// EvhRentalv2AddRentalSiteSingleSimpleRule.m
//
#import "EvhRentalv2AddRentalSiteSingleSimpleRule.h"
...
@implementation EvhRentalv2AddRentalSiteSingleSimpleRule

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2AddRentalSiteSingleSimpleRule* obj = [EvhRentalv2AddRentalSiteSingleSimpleRule new];
