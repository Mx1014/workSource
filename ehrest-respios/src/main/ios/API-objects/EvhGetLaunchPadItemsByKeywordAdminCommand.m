//
// EvhGetLaunchPadItemsByKeywordAdminCommand.m
//
#import "EvhGetLaunchPadItemsByKeywordAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetLaunchPadItemsByKeywordAdminCommand
//

@implementation EvhGetLaunchPadItemsByKeywordAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetLaunchPadItemsByKeywordAdminCommand* obj = [EvhGetLaunchPadItemsByKeywordAdminCommand new];
