//
// EvhRentalDeleteRentalSiteRulesCommand.m
//
#import "EvhRentalDeleteRentalSiteRulesCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalDeleteRentalSiteRulesCommand
//

@implementation EvhRentalDeleteRentalSiteRulesCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalDeleteRentalSiteRulesCommand* obj = [EvhRentalDeleteRentalSiteRulesCommand new];
