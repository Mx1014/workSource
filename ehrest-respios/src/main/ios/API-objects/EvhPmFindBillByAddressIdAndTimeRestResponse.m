...
@implementation EvhPmFindBillByAddressIdAndTimeRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhPmFindBillByAddressIdAndTimeRestResponse* obj = [EvhPmFindBillByAddressIdAndTimeRestResponse new];
