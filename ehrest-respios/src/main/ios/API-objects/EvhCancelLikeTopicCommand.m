//
// EvhCancelLikeTopicCommand.m
//
#import "EvhCancelLikeTopicCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCancelLikeTopicCommand
//

@implementation EvhCancelLikeTopicCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCancelLikeTopicCommand* obj = [EvhCancelLikeTopicCommand new];
