//
// EvhUpdateInvoiceCommand.m
//
#import "EvhUpdateInvoiceCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUpdateInvoiceCommand
//

@implementation EvhUpdateInvoiceCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateInvoiceCommand* obj = [EvhUpdateInvoiceCommand new];
