...
#define EvhMessageMetaConstant_JUMP_OBJECT @"jumpObj"
#define EvhMessageMetaConstant_META_OBJECT_TYPE @"meta-object-type"
#define EvhMessageMetaConstant_META_OBJECT @"meta-object"
