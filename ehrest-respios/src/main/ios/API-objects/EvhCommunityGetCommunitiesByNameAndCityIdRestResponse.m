...
@implementation EvhCommunityGetCommunitiesByNameAndCityIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCommunityGetCommunitiesByNameAndCityIdRestResponse* obj = [EvhCommunityGetCommunitiesByNameAndCityIdRestResponse new];
