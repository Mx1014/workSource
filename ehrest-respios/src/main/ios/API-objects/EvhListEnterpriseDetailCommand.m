//
// EvhListEnterpriseDetailCommand.m
//
#import "EvhListEnterpriseDetailCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListEnterpriseDetailCommand
//

@implementation EvhListEnterpriseDetailCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListEnterpriseDetailCommand* obj = [EvhListEnterpriseDetailCommand new];
