...
@implementation EvhAdminScheduleListJobInfosRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminScheduleListJobInfosRestResponse* obj = [EvhAdminScheduleListJobInfosRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhScheduleJobInfoDTO* item in self.response) {
...
-(id<EvhJsonSerializable>) fromJson: (id) jsonObject 
{
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
        ...
        for(NSMutableDictionary* dic in jsonArray) {
            EvhScheduleJobInfoDTO* item = [EvhScheduleJobInfoDTO new];
            [item fromJson:dic];
