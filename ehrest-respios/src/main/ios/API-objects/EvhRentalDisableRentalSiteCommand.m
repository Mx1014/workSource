//
// EvhRentalDisableRentalSiteCommand.m
//
#import "EvhRentalDisableRentalSiteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalDisableRentalSiteCommand
//

@implementation EvhRentalDisableRentalSiteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalDisableRentalSiteCommand* obj = [EvhRentalDisableRentalSiteCommand new];
