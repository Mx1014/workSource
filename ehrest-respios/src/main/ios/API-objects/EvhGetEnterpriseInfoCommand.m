//
// EvhGetEnterpriseInfoCommand.m
//
#import "EvhGetEnterpriseInfoCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetEnterpriseInfoCommand
//

@implementation EvhGetEnterpriseInfoCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetEnterpriseInfoCommand* obj = [EvhGetEnterpriseInfoCommand new];
