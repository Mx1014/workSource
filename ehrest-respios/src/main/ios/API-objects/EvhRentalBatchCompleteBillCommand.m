//
// EvhRentalBatchCompleteBillCommand.m
//
#import "EvhRentalBatchCompleteBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalBatchCompleteBillCommand
//

@implementation EvhRentalBatchCompleteBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalBatchCompleteBillCommand* obj = [EvhRentalBatchCompleteBillCommand new];
