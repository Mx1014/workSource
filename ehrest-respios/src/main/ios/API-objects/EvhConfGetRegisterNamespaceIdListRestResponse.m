...
@implementation EvhConfGetRegisterNamespaceIdListRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhConfGetRegisterNamespaceIdListRestResponse* obj = [EvhConfGetRegisterNamespaceIdListRestResponse new];
