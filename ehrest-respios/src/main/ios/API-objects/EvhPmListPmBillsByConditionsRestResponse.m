...
@implementation EvhPmListPmBillsByConditionsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhPmListPmBillsByConditionsRestResponse* obj = [EvhPmListPmBillsByConditionsRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhPmBillsDTO* item in self.response) {
