...
@implementation EvhUserGetUserRelateServiceAddressRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUserGetUserRelateServiceAddressRestResponse* obj = [EvhUserGetUserRelateServiceAddressRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhUserServiceAddressDTO* item in self.response) {
...
-(id<EvhJsonSerializable>) fromJson: (id) jsonObject 
{
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
        ...
        for(NSMutableDictionary* dic in jsonArray) {
            EvhUserServiceAddressDTO* item = [EvhUserServiceAddressDTO new];
            [item fromJson:dic];
