//
// EvhRentalv2CompleteBillCommand.m
//
#import "EvhRentalv2CompleteBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2CompleteBillCommand
//

@implementation EvhRentalv2CompleteBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2CompleteBillCommand* obj = [EvhRentalv2CompleteBillCommand new];
