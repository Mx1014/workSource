//
// EvhListOfficialActivitiesBySceneCommand.m
//
#import "EvhListOfficialActivitiesBySceneCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListOfficialActivitiesBySceneCommand
//

@implementation EvhListOfficialActivitiesBySceneCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListOfficialActivitiesBySceneCommand* obj = [EvhListOfficialActivitiesBySceneCommand new];
