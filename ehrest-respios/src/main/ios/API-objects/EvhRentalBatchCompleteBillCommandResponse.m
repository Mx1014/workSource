//
// EvhRentalBatchCompleteBillCommandResponse.m
//
...
@implementation EvhRentalBatchCompleteBillCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalBatchCompleteBillCommandResponse* obj = [EvhRentalBatchCompleteBillCommandResponse new];
