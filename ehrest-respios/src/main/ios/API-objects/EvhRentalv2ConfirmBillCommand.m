//
// EvhRentalv2ConfirmBillCommand.m
//
#import "EvhRentalv2ConfirmBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2ConfirmBillCommand
//

@implementation EvhRentalv2ConfirmBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2ConfirmBillCommand* obj = [EvhRentalv2ConfirmBillCommand new];
