//
// EvhGroupListPublicGroupsRestResponse.m
//
#import "EvhGroupListPublicGroupsRestResponse.h"
...
@implementation EvhGroupListPublicGroupsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGroupListPublicGroupsRestResponse* obj = [EvhGroupListPublicGroupsRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhGroupDTO* item in self.response) {
