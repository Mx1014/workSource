//
// EvhFamilyListFamilyMembersByCityIdRestResponse.m
//
#import "EvhFamilyListFamilyMembersByCityIdRestResponse.h"
...
@implementation EvhFamilyListFamilyMembersByCityIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFamilyListFamilyMembersByCityIdRestResponse* obj = [EvhFamilyListFamilyMembersByCityIdRestResponse new];
