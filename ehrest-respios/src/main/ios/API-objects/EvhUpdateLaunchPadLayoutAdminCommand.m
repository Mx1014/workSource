//
// EvhUpdateLaunchPadLayoutAdminCommand.m
//
#import "EvhUpdateLaunchPadLayoutAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUpdateLaunchPadLayoutAdminCommand
//

@implementation EvhUpdateLaunchPadLayoutAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateLaunchPadLayoutAdminCommand* obj = [EvhUpdateLaunchPadLayoutAdminCommand new];
