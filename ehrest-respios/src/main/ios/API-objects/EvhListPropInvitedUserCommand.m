//
// EvhListPropInvitedUserCommand.m
// generated at 2016-04-19 12:41:52 
//
#import "EvhListPropInvitedUserCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListPropInvitedUserCommand
//

@implementation EvhListPropInvitedUserCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListPropInvitedUserCommand* obj = [EvhListPropInvitedUserCommand new];
