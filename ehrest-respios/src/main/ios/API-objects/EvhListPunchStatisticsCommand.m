//
// EvhListPunchStatisticsCommand.m
//
#import "EvhListPunchStatisticsCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListPunchStatisticsCommand
//

@implementation EvhListPunchStatisticsCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListPunchStatisticsCommand* obj = [EvhListPunchStatisticsCommand new];
