//
// EvhExtendedConfAccountPeriodCommand.m
// generated at 2016-03-30 10:13:08 
//
#import "EvhExtendedConfAccountPeriodCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhExtendedConfAccountPeriodCommand
//

@implementation EvhExtendedConfAccountPeriodCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhExtendedConfAccountPeriodCommand* obj = [EvhExtendedConfAccountPeriodCommand new];
