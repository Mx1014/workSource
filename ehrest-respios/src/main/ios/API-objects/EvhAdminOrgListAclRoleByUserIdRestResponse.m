//
// EvhAdminOrgListAclRoleByUserIdRestResponse.m
//
#import "EvhAdminOrgListAclRoleByUserIdRestResponse.h"
...
@implementation EvhAdminOrgListAclRoleByUserIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminOrgListAclRoleByUserIdRestResponse* obj = [EvhAdminOrgListAclRoleByUserIdRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhOrganizationDetailDTO* item in self.response) {
