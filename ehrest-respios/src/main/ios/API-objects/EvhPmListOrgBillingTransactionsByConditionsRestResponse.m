//
// EvhPmListOrgBillingTransactionsByConditionsRestResponse.m
//
#import "EvhPmListOrgBillingTransactionsByConditionsRestResponse.h"
...
@implementation EvhPmListOrgBillingTransactionsByConditionsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhPmListOrgBillingTransactionsByConditionsRestResponse* obj = [EvhPmListOrgBillingTransactionsByConditionsRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhOrganizationBillingTransactionDTO* item in self.response) {
