//
// EvhAddNewsCommentBySceneResponse.m
//
#import "EvhAddNewsCommentBySceneResponse.h"
#import "EvhNewsAttachmentDTO.h"

///////////////////////////////////////////////////////////////////////////////
// EvhAddNewsCommentBySceneResponse
//

@implementation EvhAddNewsCommentBySceneResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAddNewsCommentBySceneResponse* obj = [EvhAddNewsCommentBySceneResponse new];
