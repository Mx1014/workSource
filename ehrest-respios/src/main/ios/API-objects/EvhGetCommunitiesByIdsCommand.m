//
// EvhGetCommunitiesByIdsCommand.m
//
#import "EvhGetCommunitiesByIdsCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetCommunitiesByIdsCommand
//

@implementation EvhGetCommunitiesByIdsCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetCommunitiesByIdsCommand* obj = [EvhGetCommunitiesByIdsCommand new];
