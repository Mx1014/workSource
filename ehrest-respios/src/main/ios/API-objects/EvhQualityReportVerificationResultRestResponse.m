...
@implementation EvhQualityReportVerificationResultRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhQualityReportVerificationResultRestResponse* obj = [EvhQualityReportVerificationResultRestResponse new];
