//
// EvhListLaunchPadLayoutCommand.m
//
#import "EvhListLaunchPadLayoutCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListLaunchPadLayoutCommand
//

@implementation EvhListLaunchPadLayoutCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListLaunchPadLayoutCommand* obj = [EvhListLaunchPadLayoutCommand new];
