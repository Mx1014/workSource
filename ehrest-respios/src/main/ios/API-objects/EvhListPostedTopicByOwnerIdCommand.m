//
// EvhListPostedTopicByOwnerIdCommand.m
//
#import "EvhListPostedTopicByOwnerIdCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListPostedTopicByOwnerIdCommand
//

@implementation EvhListPostedTopicByOwnerIdCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListPostedTopicByOwnerIdCommand* obj = [EvhListPostedTopicByOwnerIdCommand new];
