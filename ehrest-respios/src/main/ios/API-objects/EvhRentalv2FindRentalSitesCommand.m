//
// EvhRentalv2FindRentalSitesCommand.m
//
#import "EvhRentalv2FindRentalSitesCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2FindRentalSitesCommand
//

@implementation EvhRentalv2FindRentalSitesCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2FindRentalSitesCommand* obj = [EvhRentalv2FindRentalSitesCommand new];
