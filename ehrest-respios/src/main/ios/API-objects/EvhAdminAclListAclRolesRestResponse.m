//
// EvhAdminAclListAclRolesRestResponse.m
//
#import "EvhAdminAclListAclRolesRestResponse.h"
#import "EvhRoleDTO.h"
...
@implementation EvhAdminAclListAclRolesRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminAclListAclRolesRestResponse* obj = [EvhAdminAclListAclRolesRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhRoleDTO* item in self.response) {
