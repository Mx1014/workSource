//
// EvhFamilyListFamilyMembersByCommunityIdRestResponse.m
//
#import "EvhFamilyListFamilyMembersByCommunityIdRestResponse.h"
...
@implementation EvhFamilyListFamilyMembersByCommunityIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFamilyListFamilyMembersByCommunityIdRestResponse* obj = [EvhFamilyListFamilyMembersByCommunityIdRestResponse new];
