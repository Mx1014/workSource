//
// EvhFindAutoAssignRentalSiteWeekStatusResponse.m
//
...
///////////////////////////////////////////////////////////////////////////////
// EvhFindAutoAssignRentalSiteWeekStatusResponse
//

@implementation EvhFindAutoAssignRentalSiteWeekStatusResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFindAutoAssignRentalSiteWeekStatusResponse* obj = [EvhFindAutoAssignRentalSiteWeekStatusResponse new];
