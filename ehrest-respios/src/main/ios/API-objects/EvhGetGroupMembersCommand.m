//
// EvhGetGroupMembersCommand.m
//
#import "EvhGetGroupMembersCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetGroupMembersCommand
//

@implementation EvhGetGroupMembersCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetGroupMembersCommand* obj = [EvhGetGroupMembersCommand new];
