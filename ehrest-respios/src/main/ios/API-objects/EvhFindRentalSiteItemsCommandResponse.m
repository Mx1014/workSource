//
// EvhFindRentalSiteItemsCommandResponse.m
//
...
@implementation EvhFindRentalSiteItemsCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFindRentalSiteItemsCommandResponse* obj = [EvhFindRentalSiteItemsCommandResponse new];
