//
// EvhUpdateLaunchPadItemAdminCommand.m
//
#import "EvhUpdateLaunchPadItemAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUpdateLaunchPadItemAdminCommand
//

@implementation EvhUpdateLaunchPadItemAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateLaunchPadItemAdminCommand* obj = [EvhUpdateLaunchPadItemAdminCommand new];
