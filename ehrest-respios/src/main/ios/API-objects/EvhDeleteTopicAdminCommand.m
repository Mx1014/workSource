//
// EvhDeleteTopicAdminCommand.m
//
#import "EvhDeleteTopicAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhDeleteTopicAdminCommand
//

@implementation EvhDeleteTopicAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhDeleteTopicAdminCommand* obj = [EvhDeleteTopicAdminCommand new];
