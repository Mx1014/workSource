//
// EvhRentalEnableRentalSiteCommand.m
//
#import "EvhRentalEnableRentalSiteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalEnableRentalSiteCommand
//

@implementation EvhRentalEnableRentalSiteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalEnableRentalSiteCommand* obj = [EvhRentalEnableRentalSiteCommand new];
