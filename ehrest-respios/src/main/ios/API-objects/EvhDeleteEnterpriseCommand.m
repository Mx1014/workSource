//
// EvhDeleteEnterpriseCommand.m
//
#import "EvhDeleteEnterpriseCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhDeleteEnterpriseCommand
//

@implementation EvhDeleteEnterpriseCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhDeleteEnterpriseCommand* obj = [EvhDeleteEnterpriseCommand new];
