//
// EvhOrgListUserRelatedOrganizationsRestResponse.m
//
#import "EvhOrgListUserRelatedOrganizationsRestResponse.h"
...
@implementation EvhOrgListUserRelatedOrganizationsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOrgListUserRelatedOrganizationsRestResponse* obj = [EvhOrgListUserRelatedOrganizationsRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhOrganizationSimpleDTO* item in self.response) {
