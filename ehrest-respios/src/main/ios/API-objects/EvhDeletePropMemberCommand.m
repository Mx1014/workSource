//
// EvhDeletePropMemberCommand.m
//
#import "EvhDeletePropMemberCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhDeletePropMemberCommand
//

@implementation EvhDeletePropMemberCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhDeletePropMemberCommand* obj = [EvhDeletePropMemberCommand new];
