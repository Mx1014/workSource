//
// EvhEnterpriseApproveCommand.m
//
#import "EvhEnterpriseApproveCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhEnterpriseApproveCommand
//

@implementation EvhEnterpriseApproveCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhEnterpriseApproveCommand* obj = [EvhEnterpriseApproveCommand new];
