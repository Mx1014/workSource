//
// EvhSearchCardRechargeOrderCommand.m
//
#import "EvhSearchCardRechargeOrderCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhSearchCardRechargeOrderCommand
//

@implementation EvhSearchCardRechargeOrderCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhSearchCardRechargeOrderCommand* obj = [EvhSearchCardRechargeOrderCommand new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.rechargeType)
        [jsonObject setObject: self.rechargeType forKey: @"rechargeType"];
...
-(id<EvhJsonSerializable>) fromJson: (id) jsonObject 
{
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
        ...
        self.rechargeType = [jsonObject objectForKey: @"rechargeType"];
        if(self.rechargeType && [self.rechargeType isEqual:[NSNull null]])
