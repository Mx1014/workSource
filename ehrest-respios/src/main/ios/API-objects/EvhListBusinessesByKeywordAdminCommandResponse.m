//
// EvhListBusinessesByKeywordAdminCommandResponse.m
//
...
@implementation EvhListBusinessesByKeywordAdminCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListBusinessesByKeywordAdminCommandResponse* obj = [EvhListBusinessesByKeywordAdminCommandResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    if(self.requests) {
        ...
        for(EvhBusinessAdminDTO* item in self.requests) {
    ...
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
        {
            ...
            for(id itemJson in jsonArray) {
                EvhBusinessAdminDTO* item = [EvhBusinessAdminDTO new];
