//
// EvhRentalv2DeleteRentalBillCommand.m
//
#import "EvhRentalv2DeleteRentalBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2DeleteRentalBillCommand
//

@implementation EvhRentalv2DeleteRentalBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2DeleteRentalBillCommand* obj = [EvhRentalv2DeleteRentalBillCommand new];
