//
// EvhUpdateRentalSiteCommand.m
//
#import "EvhUpdateRentalSiteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUpdateRentalSiteCommand
//

@implementation EvhUpdateRentalSiteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateRentalSiteCommand* obj = [EvhUpdateRentalSiteCommand new];
