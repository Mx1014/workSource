//
// EvhIssueParkingCardsCommand.m
//
#import "EvhIssueParkingCardsCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhIssueParkingCardsCommand
//

@implementation EvhIssueParkingCardsCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhIssueParkingCardsCommand* obj = [EvhIssueParkingCardsCommand new];
