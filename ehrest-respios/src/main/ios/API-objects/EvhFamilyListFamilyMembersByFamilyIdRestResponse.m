...
@implementation EvhFamilyListFamilyMembersByFamilyIdRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFamilyListFamilyMembersByFamilyIdRestResponse* obj = [EvhFamilyListFamilyMembersByFamilyIdRestResponse new];
