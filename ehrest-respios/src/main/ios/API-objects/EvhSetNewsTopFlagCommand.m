//
// EvhSetNewsTopFlagCommand.m
//
#import "EvhSetNewsTopFlagCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhSetNewsTopFlagCommand
//

@implementation EvhSetNewsTopFlagCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhSetNewsTopFlagCommand* obj = [EvhSetNewsTopFlagCommand new];
