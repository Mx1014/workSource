...
@implementation EvhListContactsRequestByEnterpriseIdCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListContactsRequestByEnterpriseIdCommand* obj = [EvhListContactsRequestByEnterpriseIdCommand new];
