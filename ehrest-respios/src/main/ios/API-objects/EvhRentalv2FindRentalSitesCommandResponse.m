//
// EvhRentalv2FindRentalSitesCommandResponse.m
//
...
@implementation EvhRentalv2FindRentalSitesCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2FindRentalSitesCommandResponse* obj = [EvhRentalv2FindRentalSitesCommandResponse new];
