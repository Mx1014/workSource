//
// EvhListParkingRechargeOrdersCommand.m
//
#import "EvhListParkingRechargeOrdersCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListParkingRechargeOrdersCommand
//

@implementation EvhListParkingRechargeOrdersCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListParkingRechargeOrdersCommand* obj = [EvhListParkingRechargeOrdersCommand new];
