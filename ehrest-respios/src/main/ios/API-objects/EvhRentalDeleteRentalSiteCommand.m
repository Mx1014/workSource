//
// EvhRentalDeleteRentalSiteCommand.m
//
#import "EvhRentalDeleteRentalSiteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalDeleteRentalSiteCommand
//

@implementation EvhRentalDeleteRentalSiteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalDeleteRentalSiteCommand* obj = [EvhRentalDeleteRentalSiteCommand new];
