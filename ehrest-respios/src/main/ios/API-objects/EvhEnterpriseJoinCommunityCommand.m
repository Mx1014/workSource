//
// EvhEnterpriseJoinCommunityCommand.m
//
#import "EvhEnterpriseJoinCommunityCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhEnterpriseJoinCommunityCommand
//

@implementation EvhEnterpriseJoinCommunityCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhEnterpriseJoinCommunityCommand* obj = [EvhEnterpriseJoinCommunityCommand new];
