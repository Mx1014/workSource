//
// EvhRefundCallbackCommand.m
//
#import "EvhRefundCallbackCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRefundCallbackCommand
//

@implementation EvhRefundCallbackCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRefundCallbackCommand* obj = [EvhRefundCallbackCommand new];
