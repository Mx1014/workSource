//
// EvhListContactsRequestByEnterpriseIdCommandResponse.m
//
...
@implementation EvhListContactsRequestByEnterpriseIdCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListContactsRequestByEnterpriseIdCommandResponse* obj = [EvhListContactsRequestByEnterpriseIdCommandResponse new];
