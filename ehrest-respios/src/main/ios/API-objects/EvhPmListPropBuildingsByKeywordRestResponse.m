...
@implementation EvhPmListPropBuildingsByKeywordRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhPmListPropBuildingsByKeywordRestResponse* obj = [EvhPmListPropBuildingsByKeywordRestResponse new];
