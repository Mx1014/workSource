//
// EvhOpenapiListApartmentsByKeywordRestResponse.m
//
#import "EvhOpenapiListApartmentsByKeywordRestResponse.h"
...
@implementation EvhOpenapiListApartmentsByKeywordRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOpenapiListApartmentsByKeywordRestResponse* obj = [EvhOpenapiListApartmentsByKeywordRestResponse new];
