//
// EvhGetLaunchPadItemsByKeywordCommand.m
//
#import "EvhGetLaunchPadItemsByKeywordCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetLaunchPadItemsByKeywordCommand
//

@implementation EvhGetLaunchPadItemsByKeywordCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetLaunchPadItemsByKeywordCommand* obj = [EvhGetLaunchPadItemsByKeywordCommand new];
