//
// EvhRentalOnlinePayCallbackCommand.m
//
#import "EvhRentalOnlinePayCallbackCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalOnlinePayCallbackCommand
//

@implementation EvhRentalOnlinePayCallbackCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalOnlinePayCallbackCommand* obj = [EvhRentalOnlinePayCallbackCommand new];
