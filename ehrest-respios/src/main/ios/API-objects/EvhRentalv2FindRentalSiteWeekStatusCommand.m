//
// EvhRentalv2FindRentalSiteWeekStatusCommand.m
//
#import "EvhRentalv2FindRentalSiteWeekStatusCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2FindRentalSiteWeekStatusCommand
//

@implementation EvhRentalv2FindRentalSiteWeekStatusCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2FindRentalSiteWeekStatusCommand* obj = [EvhRentalv2FindRentalSiteWeekStatusCommand new];
