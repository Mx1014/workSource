//
// EvhListPunchExceptionApprovalCommand.m
// generated at 2016-04-08 20:09:22 
//
#import "EvhListPunchExceptionApprovalCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListPunchExceptionApprovalCommand
//

@implementation EvhListPunchExceptionApprovalCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListPunchExceptionApprovalCommand* obj = [EvhListPunchExceptionApprovalCommand new];
