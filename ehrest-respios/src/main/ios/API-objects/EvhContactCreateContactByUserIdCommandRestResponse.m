...
@implementation EvhContactCreateContactByUserIdCommandRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhContactCreateContactByUserIdCommandRestResponse* obj = [EvhContactCreateContactByUserIdCommandRestResponse new];
