//
// EvhSearchEnterpriseCommunityCommand.m
//
#import "EvhSearchEnterpriseCommunityCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhSearchEnterpriseCommunityCommand
//

@implementation EvhSearchEnterpriseCommunityCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhSearchEnterpriseCommunityCommand* obj = [EvhSearchEnterpriseCommunityCommand new];
