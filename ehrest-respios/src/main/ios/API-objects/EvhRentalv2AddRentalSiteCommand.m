//
// EvhRentalv2AddRentalSiteCommand.m
//
#import "EvhRentalv2AddRentalSiteCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2AddRentalSiteCommand
//

@implementation EvhRentalv2AddRentalSiteCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2AddRentalSiteCommand* obj = [EvhRentalv2AddRentalSiteCommand new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.siteItems)
        [jsonObject setObject: self.siteItems forKey: @"siteItems"];
}
...
-(id<EvhJsonSerializable>) fromJson: (id) jsonObject 
{
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
        ...
        self.siteItems = [jsonObject objectForKey: @"siteItems"];
        if(self.siteItems && [self.siteItems isEqual:[NSNull null]])
            self.siteItems = nil;
