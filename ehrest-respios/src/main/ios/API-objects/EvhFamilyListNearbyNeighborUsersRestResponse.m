//
// EvhFamilyListNearbyNeighborUsersRestResponse.m
//
#import "EvhFamilyListNearbyNeighborUsersRestResponse.h"
...
@implementation EvhFamilyListNearbyNeighborUsersRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFamilyListNearbyNeighborUsersRestResponse* obj = [EvhFamilyListNearbyNeighborUsersRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhNeighborUserDTO* item in self.response) {
