//
// EvhRentalGetRentalTypeRuleCommandResponse.m
//
...
@implementation EvhRentalGetRentalTypeRuleCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalGetRentalTypeRuleCommandResponse* obj = [EvhRentalGetRentalTypeRuleCommandResponse new];
