//
// EvhAddPersonnelsToGroup.m
//
#import "EvhAddPersonnelsToGroup.h"

///////////////////////////////////////////////////////////////////////////////
// EvhAddPersonnelsToGroup
//

@implementation EvhAddPersonnelsToGroup

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAddPersonnelsToGroup* obj = [EvhAddPersonnelsToGroup new];
