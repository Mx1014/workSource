//
// EvhListUserOpPromotionsRespose.m
//
...
@implementation EvhListUserOpPromotionsRespose

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListUserOpPromotionsRespose* obj = [EvhListUserOpPromotionsRespose new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    if(self.promotions) {
        ...
        for(EvhOpPromotionDTO* item in self.promotions) {
    ...
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
        {
            ...
            for(id itemJson in jsonArray) {
                EvhOpPromotionDTO* item = [EvhOpPromotionDTO new];
