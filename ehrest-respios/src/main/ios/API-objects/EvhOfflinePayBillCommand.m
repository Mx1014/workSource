//
// EvhOfflinePayBillCommand.m
//
#import "EvhOfflinePayBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhOfflinePayBillCommand
//

@implementation EvhOfflinePayBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOfflinePayBillCommand* obj = [EvhOfflinePayBillCommand new];
