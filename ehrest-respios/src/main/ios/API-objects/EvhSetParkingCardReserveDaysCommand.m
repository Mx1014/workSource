//
// EvhSetParkingCardReserveDaysCommand.m
//
#import "EvhSetParkingCardReserveDaysCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhSetParkingCardReserveDaysCommand
//

@implementation EvhSetParkingCardReserveDaysCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhSetParkingCardReserveDaysCommand* obj = [EvhSetParkingCardReserveDaysCommand new];
