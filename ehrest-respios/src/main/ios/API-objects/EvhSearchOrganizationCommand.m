//
// EvhSearchOrganizationCommand.m
//
#import "EvhSearchOrganizationCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhSearchOrganizationCommand
//

@implementation EvhSearchOrganizationCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhSearchOrganizationCommand* obj = [EvhSearchOrganizationCommand new];
