...
@implementation EvhListOrganizationContactCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListOrganizationContactCommandResponse* obj = [EvhListOrganizationContactCommandResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.members) {
        ...
        for(EvhOrganizationContactDTO* item in self.members) {
    ...
    if([jsonObject isKindOfClass:[NSDictionary class]]) {
...

        {
            ...
            for(id itemJson in jsonArray) {
                EvhOrganizationContactDTO* item = [EvhOrganizationContactDTO new];
