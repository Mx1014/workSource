//
// EvhListNewsBySceneCommand.m
//
#import "EvhListNewsBySceneCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListNewsBySceneCommand
//

@implementation EvhListNewsBySceneCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListNewsBySceneCommand* obj = [EvhListNewsBySceneCommand new];
