//
// EvhUpdateOrganizationContactCommand.m
//
#import "EvhUpdateOrganizationContactCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhUpdateOrganizationContactCommand
//

@implementation EvhUpdateOrganizationContactCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUpdateOrganizationContactCommand* obj = [EvhUpdateOrganizationContactCommand new];
