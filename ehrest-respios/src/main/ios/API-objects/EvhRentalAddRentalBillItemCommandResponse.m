//
// EvhRentalAddRentalBillItemCommandResponse.m
//
#import "EvhRentalAddRentalBillItemCommandResponse.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalAddRentalBillItemCommandResponse
//

@implementation EvhRentalAddRentalBillItemCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalAddRentalBillItemCommandResponse* obj = [EvhRentalAddRentalBillItemCommandResponse new];
