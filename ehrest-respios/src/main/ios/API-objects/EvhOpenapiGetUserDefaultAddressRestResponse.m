...
@implementation EvhOpenapiGetUserDefaultAddressRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOpenapiGetUserDefaultAddressRestResponse* obj = [EvhOpenapiGetUserDefaultAddressRestResponse new];
