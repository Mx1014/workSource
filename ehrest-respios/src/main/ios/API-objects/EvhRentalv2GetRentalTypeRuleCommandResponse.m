//
// EvhRentalv2GetRentalTypeRuleCommandResponse.m
//
#import "EvhRentalv2GetRentalTypeRuleCommandResponse.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2GetRentalTypeRuleCommandResponse
//

@implementation EvhRentalv2GetRentalTypeRuleCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2GetRentalTypeRuleCommandResponse* obj = [EvhRentalv2GetRentalTypeRuleCommandResponse new];
