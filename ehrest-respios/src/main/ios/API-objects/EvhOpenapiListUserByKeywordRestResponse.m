...
@implementation EvhOpenapiListUserByKeywordRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhOpenapiListUserByKeywordRestResponse* obj = [EvhOpenapiListUserByKeywordRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhUserInfo* item in self.response) {
