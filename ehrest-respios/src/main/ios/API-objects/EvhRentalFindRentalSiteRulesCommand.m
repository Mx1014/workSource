//
// EvhRentalFindRentalSiteRulesCommand.m
//
#import "EvhRentalFindRentalSiteRulesCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalFindRentalSiteRulesCommand
//

@implementation EvhRentalFindRentalSiteRulesCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalFindRentalSiteRulesCommand* obj = [EvhRentalFindRentalSiteRulesCommand new];
