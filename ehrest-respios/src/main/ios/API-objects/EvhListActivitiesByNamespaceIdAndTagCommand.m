//
// EvhListActivitiesByNamespaceIdAndTagCommand.m
//
#import "EvhListActivitiesByNamespaceIdAndTagCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListActivitiesByNamespaceIdAndTagCommand
//

@implementation EvhListActivitiesByNamespaceIdAndTagCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListActivitiesByNamespaceIdAndTagCommand* obj = [EvhListActivitiesByNamespaceIdAndTagCommand new];
