//
// EvhCommunityGetCommunitiesByIdsRestResponse.m
//
#import "EvhCommunityGetCommunitiesByIdsRestResponse.h"
...
@implementation EvhCommunityGetCommunitiesByIdsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCommunityGetCommunitiesByIdsRestResponse* obj = [EvhCommunityGetCommunitiesByIdsRestResponse new];
