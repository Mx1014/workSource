...
@implementation EvhAdminAclListAclRoleByOrganizationIdsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAdminAclListAclRoleByOrganizationIdsRestResponse* obj = [EvhAdminAclListAclRoleByOrganizationIdsRestResponse new];
