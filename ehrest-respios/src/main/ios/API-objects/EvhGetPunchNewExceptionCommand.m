//
// EvhGetPunchNewExceptionCommand.m
// generated at 2016-04-19 14:25:56 
//
#import "EvhGetPunchNewExceptionCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhGetPunchNewExceptionCommand
//

@implementation EvhGetPunchNewExceptionCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhGetPunchNewExceptionCommand* obj = [EvhGetPunchNewExceptionCommand new];
