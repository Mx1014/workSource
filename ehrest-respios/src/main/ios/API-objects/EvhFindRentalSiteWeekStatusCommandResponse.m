...
@implementation EvhFindRentalSiteWeekStatusCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFindRentalSiteWeekStatusCommandResponse* obj = [EvhFindRentalSiteWeekStatusCommandResponse new];
