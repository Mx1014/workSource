//
// EvhListBusinessesByKeywordAdminCommand.m
//
#import "EvhListBusinessesByKeywordAdminCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListBusinessesByKeywordAdminCommand
//

@implementation EvhListBusinessesByKeywordAdminCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListBusinessesByKeywordAdminCommand* obj = [EvhListBusinessesByKeywordAdminCommand new];
