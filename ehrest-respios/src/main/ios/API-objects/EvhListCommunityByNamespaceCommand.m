//
// EvhListCommunityByNamespaceCommand.m
//
#import "EvhListCommunityByNamespaceCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListCommunityByNamespaceCommand
//

@implementation EvhListCommunityByNamespaceCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListCommunityByNamespaceCommand* obj = [EvhListCommunityByNamespaceCommand new];
