//
// EvhFindRentalSiteMonthStatusCommand.m
//
#import "EvhFindRentalSiteMonthStatusCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhFindRentalSiteMonthStatusCommand
//

@implementation EvhFindRentalSiteMonthStatusCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhFindRentalSiteMonthStatusCommand* obj = [EvhFindRentalSiteMonthStatusCommand new];
