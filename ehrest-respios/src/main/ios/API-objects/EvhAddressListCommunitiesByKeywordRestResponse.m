...
@implementation EvhAddressListCommunitiesByKeywordRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhAddressListCommunitiesByKeywordRestResponse* obj = [EvhAddressListCommunitiesByKeywordRestResponse new];
