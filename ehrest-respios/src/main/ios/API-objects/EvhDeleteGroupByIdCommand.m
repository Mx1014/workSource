//
// EvhDeleteGroupByIdCommand.m
//
#import "EvhDeleteGroupByIdCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhDeleteGroupByIdCommand
//

@implementation EvhDeleteGroupByIdCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhDeleteGroupByIdCommand* obj = [EvhDeleteGroupByIdCommand new];
