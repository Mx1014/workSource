//
// EvhRentalAddRentalBillCommand.m
//
#import "EvhRentalAddRentalBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalAddRentalBillCommand
//

@implementation EvhRentalAddRentalBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalAddRentalBillCommand* obj = [EvhRentalAddRentalBillCommand new];
