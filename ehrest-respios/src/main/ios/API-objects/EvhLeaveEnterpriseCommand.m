//
// EvhLeaveEnterpriseCommand.m
//
#import "EvhLeaveEnterpriseCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhLeaveEnterpriseCommand
//

@implementation EvhLeaveEnterpriseCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhLeaveEnterpriseCommand* obj = [EvhLeaveEnterpriseCommand new];
