//
// EvhListOrderByAccountCommand.m
// generated at 2016-03-30 10:13:08 
//
#import "EvhListOrderByAccountCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListOrderByAccountCommand
//

@implementation EvhListOrderByAccountCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListOrderByAccountCommand* obj = [EvhListOrderByAccountCommand new];
