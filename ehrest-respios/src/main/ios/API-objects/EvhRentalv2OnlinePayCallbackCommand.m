//
// EvhRentalv2OnlinePayCallbackCommand.m
//
#import "EvhRentalv2OnlinePayCallbackCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2OnlinePayCallbackCommand
//

@implementation EvhRentalv2OnlinePayCallbackCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2OnlinePayCallbackCommand* obj = [EvhRentalv2OnlinePayCallbackCommand new];
