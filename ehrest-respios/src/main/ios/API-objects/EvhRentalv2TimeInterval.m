//
// EvhRentalv2TimeInterval.m
//
#import "EvhRentalv2TimeInterval.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2TimeInterval
//

@implementation EvhRentalv2TimeInterval

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2TimeInterval* obj = [EvhRentalv2TimeInterval new];
