//
// EvhRentalListRentalBillCountCommand.m
//
#import "EvhRentalListRentalBillCountCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalListRentalBillCountCommand
//

@implementation EvhRentalListRentalBillCountCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalListRentalBillCountCommand* obj = [EvhRentalListRentalBillCountCommand new];
