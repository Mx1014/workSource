//
// EvhPmListOweFamilysByConditionsRestResponse.m
//
#import "EvhPmListOweFamilysByConditionsRestResponse.h"
...
@implementation EvhPmListOweFamilysByConditionsRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhPmListOweFamilysByConditionsRestResponse* obj = [EvhPmListOweFamilysByConditionsRestResponse new];
...
-(void) toJson: (NSMutableDictionary*) jsonObject 
{
    ...
    if(self.response) {
        ...
        for(EvhOweFamilyDTO* item in self.response) {
