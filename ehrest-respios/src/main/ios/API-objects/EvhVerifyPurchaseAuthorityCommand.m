//
// EvhVerifyPurchaseAuthorityCommand.m
//
#import "EvhVerifyPurchaseAuthorityCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhVerifyPurchaseAuthorityCommand
//

@implementation EvhVerifyPurchaseAuthorityCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhVerifyPurchaseAuthorityCommand* obj = [EvhVerifyPurchaseAuthorityCommand new];
