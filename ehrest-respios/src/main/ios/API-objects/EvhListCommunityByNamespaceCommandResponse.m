...
@implementation EvhListCommunityByNamespaceCommandResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListCommunityByNamespaceCommandResponse* obj = [EvhListCommunityByNamespaceCommandResponse new];
