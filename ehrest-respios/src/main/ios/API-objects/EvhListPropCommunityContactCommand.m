//
// EvhListPropCommunityContactCommand.m
//
#import "EvhListPropCommunityContactCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListPropCommunityContactCommand
//

@implementation EvhListPropCommunityContactCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListPropCommunityContactCommand* obj = [EvhListPropCommunityContactCommand new];
