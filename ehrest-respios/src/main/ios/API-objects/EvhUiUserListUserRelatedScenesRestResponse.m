...
@implementation EvhUiUserListUserRelatedScenesRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhUiUserListUserRelatedScenesRestResponse* obj = [EvhUiUserListUserRelatedScenesRestResponse new];
