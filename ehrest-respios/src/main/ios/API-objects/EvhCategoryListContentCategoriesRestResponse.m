//
// EvhCategoryListContentCategoriesRestResponse.m
//
#import "EvhCategoryListContentCategoriesRestResponse.h"
...
@implementation EvhCategoryListContentCategoriesRestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCategoryListContentCategoriesRestResponse* obj = [EvhCategoryListContentCategoriesRestResponse new];
