//
// EvhCreatePushMessageCommand.m
//
#import "EvhCreatePushMessageCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhCreatePushMessageCommand
//

@implementation EvhCreatePushMessageCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhCreatePushMessageCommand* obj = [EvhCreatePushMessageCommand new];
