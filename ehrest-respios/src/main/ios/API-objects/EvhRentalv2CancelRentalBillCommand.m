//
// EvhRentalv2CancelRentalBillCommand.m
//
#import "EvhRentalv2CancelRentalBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalv2CancelRentalBillCommand
//

@implementation EvhRentalv2CancelRentalBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalv2CancelRentalBillCommand* obj = [EvhRentalv2CancelRentalBillCommand new];
