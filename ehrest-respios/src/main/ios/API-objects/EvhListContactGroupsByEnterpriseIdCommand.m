//
// EvhListContactGroupsByEnterpriseIdCommand.m
//
#import "EvhListContactGroupsByEnterpriseIdCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListContactGroupsByEnterpriseIdCommand
//

@implementation EvhListContactGroupsByEnterpriseIdCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListContactGroupsByEnterpriseIdCommand* obj = [EvhListContactGroupsByEnterpriseIdCommand new];
