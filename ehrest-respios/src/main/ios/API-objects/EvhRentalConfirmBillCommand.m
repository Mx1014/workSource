//
// EvhRentalConfirmBillCommand.m
//
#import "EvhRentalConfirmBillCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhRentalConfirmBillCommand
//

@implementation EvhRentalConfirmBillCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhRentalConfirmBillCommand* obj = [EvhRentalConfirmBillCommand new];
