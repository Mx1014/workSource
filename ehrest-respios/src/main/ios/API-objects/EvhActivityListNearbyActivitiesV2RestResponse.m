...
@implementation EvhActivityListNearbyActivitiesV2RestResponse

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhActivityListNearbyActivitiesV2RestResponse* obj = [EvhActivityListNearbyActivitiesV2RestResponse new];
