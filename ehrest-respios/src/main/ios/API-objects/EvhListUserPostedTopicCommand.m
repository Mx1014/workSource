//
// EvhListUserPostedTopicCommand.m
//
#import "EvhListUserPostedTopicCommand.h"

///////////////////////////////////////////////////////////////////////////////
// EvhListUserPostedTopicCommand
//

@implementation EvhListUserPostedTopicCommand

+(id) withJsonString: (NSString*) jsonString
{
    id jsonObject = [EvhJsonSerializationHelper fromJsonString:jsonString];
    if(jsonObject != nil) {
        EvhListUserPostedTopicCommand* obj = [EvhListUserPostedTopicCommand new];
