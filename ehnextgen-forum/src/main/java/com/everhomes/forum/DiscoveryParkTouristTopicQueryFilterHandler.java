...
@Component(TopicQueryFilterHandler.TOPIC_QUERY_FILTER_PREFIX + "discovery_park_tourist")
public class DiscoveryParkTouristTopicQueryFilterHandler implements TopicQueryFilterHandler {
