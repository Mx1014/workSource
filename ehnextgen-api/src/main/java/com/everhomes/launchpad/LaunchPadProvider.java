...
public interface LaunchPadProvider {
    ...
    List<LaunchPadItem> searchLaunchPadItemsByKeyword(Integer namespaceId, String sceneType, String itemLocation,String itemGroup,String keyword, int offset, int pageSize);
