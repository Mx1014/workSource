...
public class ContractBillResponse {
    private String errorScope;
    private Integer errorCode;
    private String errorDescription;
    private String errorDetails;
    private Integer NextPageOffset;
    private List<ContractBillsDTO> response;
    ...
    public List<ContractBillsDTO> getResponse() {
        return response;
    }

    public void setResponse(List<ContractBillsDTO> response) {
