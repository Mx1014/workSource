...
public class AuthorizationErrorCode {
	...
	public static final String PERSONAL_BACK_CODE_DETAIL_S = "很遗憾，您的认证未成功：|1、请检测信息填写是否正确，如填写有误，请重新提交|2、如填写无误，请到携带相关证件管理处核对信息|您已退租，如有疑问请联系客服|恭喜您，成为我们的一员，您承租的地址信息如下：|未定义的返回码|园区[|]不存在|园区[|]名称存在多个|地址";
	public static final String ORGANIZATION_BACK_CODE_DETAIL_S = "提交信息匹配不成功：|1、请检测信息填写是否正确，如填写有误，请重新提交|2、如填写无误，请到携带相关证件管理处核对信息|您已退租，如有疑问请联系客服|认证成功！您承租地址信息如下：|未定义的返回码|园区[|]不存在|园区[|]名称存在多个|地址";
