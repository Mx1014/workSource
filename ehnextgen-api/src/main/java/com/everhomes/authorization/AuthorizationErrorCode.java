...
public class AuthorizationErrorCode {
	...
	public static final String ORGANIZATION_BACK_CODE_DETAIL_S = "提交信息匹配不成功：|1、请检测信息填写是否正确，如填写有误，请重新提交|2、如填写无误，请到携带相关证件管理处核对信息|您已退租，如有疑问请联系客服|认证成功！您承租地址信息如下：|未定义的返回码|园区[|]不存在|园区[|]名称存在多个|地址|请求认证失败！|系统认证异常，已退出家庭";
