...
public interface CustomerService {
    ...
    void createCustomerPropertyConfig(propertyConfigCommand cmd);

    PropertyConfigurationDTO getCustomerPropertyConfigByName(propertyConfigCommand cmd);

    void updateCustomerPropertyConfig(propertyConfigCommand cmd);
}
