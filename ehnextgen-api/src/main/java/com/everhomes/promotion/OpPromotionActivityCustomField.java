...
public enum OpPromotionActivityCustomField {
    PRICE_START("integral_tag1", "integralTag1", Tables.EH_OP_PROMOTION_ACTIVITIES.INTEGRAL_TAG1),
    PRICE_END("integral_tag1", "integralTag1", Tables.EH_OP_PROMOTION_ACTIVITIES.INTEGRAL_TAG1);
    
    private String fieldName;
    private String propertyName;
    private TableField<?, ?> field;
    
    private OpPromotionActivityCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
