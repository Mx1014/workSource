...
public enum EnterpriseApprovalCustomField {

    APPROVAL_GROUP_ID("integral_tag1","integralTag1", Tables.EH_GENERAL_APPROVALS.INTEGRAL_TAG1);

    private String fieldName;
    private String propertyName;
    private TableField<?, ?> field;

    private EnterpriseApprovalCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
