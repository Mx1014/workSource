...
public enum Rentalv2ConfigAttachmentCustomField {
	ITEM_NAME("string_tag1", "stringTag1", Tables.EH_RENTALV2_CONFIG_ATTACHMENTS.STRING_TAG1),
	USER_NAME("string_tag2", "stringTag2", Tables.EH_RENTALV2_CONFIG_ATTACHMENTS.STRING_TAG2),
	MOBILE("string_tag3", "stringTag3", Tables.EH_RENTALV2_CONFIG_ATTACHMENTS.STRING_TAG3),
    ICON_URI("string_tag4", "stringTag4", Tables.EH_RENTALV2_CONFIG_ATTACHMENTS.STRING_TAG4);
    
    private String fieldName;
    private String propertyName;
    private TableField<?, ?> field;
    
    private Rentalv2ConfigAttachmentCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
