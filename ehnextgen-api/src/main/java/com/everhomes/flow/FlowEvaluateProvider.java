...
public interface FlowEvaluateProvider {
	...
	List<FlowEvaluate> findEvaluatesByFlowMainId(Long flowMainId, Integer flowVersion, Long beginTime , Long endTime);

	List<FlowEvaluate> findEvaluatesByCaseId(Long flowcaseId);
