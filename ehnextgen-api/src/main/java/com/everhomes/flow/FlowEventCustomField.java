...
public enum FlowEventCustomField {
    ...
    BUTTON_FIRED_COUNT("integral_tag2", "integralTag2", Tables.EH_FLOW_EVENT_LOGS.INTEGRAL_TAG2),
    ...
    private FlowEventCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
