...
public interface DynamicExcelStrings {
    ...
    public static String invitedBaseIntro = "填写注意事项：（未按照如下要求填写，会导致数据不能正常导入）\n" +
            ...
            "4、红色字段为必填项,不填将导致导入失败。\n"  +
            "5、请注意: \n" +
            "1): 邮箱域名只填写@后面的部分（不含@符号） \n" +
            "2): 如果导入系统已存在的客户（客户名称相同认为是相同的客户），将按照导入信息更新系统中已存在的客户 \n" +
            "3): 客户联系人导入规则：客户联系人名称(联系电话)，支持添加多个客户联系人，多个客户联系人之间用英文逗号隔开 \n" +
            "4): 渠道联系人导入规则：渠道联系人名称(联系电话)，支持添加多个渠道联系人，多个渠道联系人之间用英文逗号隔开 \n" +
            "5): 招商跟进人导入规则：跟进人名称(联系电话)，支持添加多个招商跟进人，多个招商跟进人之间用英文逗号隔开 \n" +
            "6): 成交几率导入规则：成交几率只支持导入数值型，输入范围为：0-100之间\n" +
            "7): 预计签约时间导入规则：2018-09-20，只支持导入日期型" ;
