...
public enum EnterpriseContactCustomField {
    APPLYGROUP("string_tag1", "stringTag1", Tables.EH_GROUPS.STRING_TAG1),
    SEX("string_tag2", "stringTag2", Tables.EH_GROUPS.STRING_TAG2),
    EMPLOYEENO("string_tag3", "stringTag3", Tables.EH_GROUPS.STRING_TAG3);
    
    private String fieldName;
    private String propertyName;
    private TableField<?, ?> field;
    
    private EnterpriseContactCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
