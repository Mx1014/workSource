...
public enum EnterpriseContactGroupCustomField {
	APPLYGROUP("string_tag1", "stringTag1", Tables.EH_ENTERPRISE_CONTACT_GROUPS.STRING_TAG1);
    
    private String fieldName;
    private String propertyName;
    private TableField<?, ?> field;
    
    private EnterpriseContactGroupCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
