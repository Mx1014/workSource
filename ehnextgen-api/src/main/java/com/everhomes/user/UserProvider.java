...
public interface UserProvider {
	...
	List<User> listUserByKeyword(Byte gender, Long organizationId, String keyword,Byte executiveFlag, Integer namespaceId, CrossShardListingLocator locator, int pageSize);
