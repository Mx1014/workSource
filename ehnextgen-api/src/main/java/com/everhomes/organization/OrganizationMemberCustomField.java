...
public enum OrganizationMemberCustomField {
	APPROVE_TIME ("integral_tag5", "integralTag5", Tables.EH_ORGANIZATION_MEMBERS.INTEGRAL_TAG5)
    ;
    ...
    private OrganizationMemberCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
