...
public enum CommunityCustomField {
    REQUEST_STATUS("integral_tag1", "integralTag1", Tables.EH_COMMUNITIES.INTEGRAL_TAG1);
    
    private String fieldName;
    private String propertyName;
    private TableField<?, ?> field;
    
    private CommunityCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
