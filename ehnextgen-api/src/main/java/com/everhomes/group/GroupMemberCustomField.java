...
public enum GroupMemberCustomField {
    PHONE_PRIVATE_FLAG("integral_tag4", "integralTag4", Tables.EH_GROUP_MEMBERS.INTEGRAL_TAG4),
    MUTE_NOTIFICATION_FLAG("integral_tag5", "integralTag5", Tables.EH_GROUP_MEMBERS.INTEGRAL_TAG5);
    
    private String fieldName;
    private String propertyName;
    private TableField<?, ?> field;
    
    private GroupMemberCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
