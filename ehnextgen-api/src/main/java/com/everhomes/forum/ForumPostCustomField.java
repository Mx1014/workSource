...
public enum ForumPostCustomField {
    /** 对应于以前的service type id */
    ACTION_CATEGORY_ID("integral_tag1", "integralTag1", Tables.EH_FORUM_POSTS.INTEGRAL_TAG1),
    /** ACTION_CATEGORY_ID对应的path */
    ACTION_CATEGORY_PATH("string_tag1", "stringTag1", Tables.EH_FORUM_POSTS.STRING_TAG1),
    /** 创建者名称，对于一些2.8的老数据不同家庭有不同的昵称 */
    CREATOR_NICK_NAME("string_tag2", "stringTag2", Tables.EH_FORUM_POSTS.STRING_TAG2),
    /** 创建者头像，对于一些2.8的老数据不同家庭有不同的头像 */
    CREATOR_AVTAR("string_tag3", "stringTag3", Tables.EH_FORUM_POSTS.STRING_TAG3),
    
    NEXT_FLOOR_NUMBER("integral_tag2", "integralTag2", Tables.EH_FORUM_POSTS.INTEGRAL_TAG2);
    ...
    private ForumPostCustomField(String fieldName, String propertyName, TableField<?, ?> field) {
