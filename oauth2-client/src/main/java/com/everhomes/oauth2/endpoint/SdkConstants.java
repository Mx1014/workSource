...
public interface SdkConstants {
    public static final String API_KEY = "c3bbba16-7955-4725-b8e2-9aeb9a866919";

    // demostration only, it should be kept in a safe place
    public static final String API_SECRET = "Z136mxMc6wTMNSKl4+3shzCRsj3qEZtuCKoxUyRExinN3r0iYTUcKlCOHe+YnO9I4Fx87u1hOmr+c2kbYZBeaQ==";
